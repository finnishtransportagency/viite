      ...
      Project(
        ...
        settings = Defaults.defaultSettings ++ Seq(
          ...
          libraryDependencies ++= Seq(
            ...
            "org.geotools" % "gt-graph"       % GeoToolsVersion, // from "http://livibuild04.vally.local/nexus/repository/maven-public/org/geotools/gt-graph/19.0/gt-graph-19.0.jar",
            "org.geotools" % "gt-main"        % GeoToolsVersion, // from "http://livibuild04.vally.local/nexus/repository/maven-public/org/geotools/gt-main/19.0/gt-main-19.0.jar",
            "org.geotools" % "gt-api"         % GeoToolsVersion, // from "http://livibuild04.vally.local/nexus/repository/maven-public/org/geotools/gt-api/19.0/gt-api-19.0.jar",
            "org.geotools" % "gt-referencing" % GeoToolsVersion, // from "http://livibuild04.vally.local/nexus/repository/maven-public/org/geotools/gt-referencing/19.0/gt-referencing-19.0.jar",
            "org.geotools" % "gt-metadata"    % GeoToolsVersion, // from "http://livibuild04.vally.local/nexus/repository/maven-public/org/geotools/gt-metadata/19.0/gt-metadata-19.0.jar",
            "org.geotools" % "gt-opengis"     % GeoToolsVersion, // from "http://livibuild04.vally.local/nexus/repository/maven-public/org/geotools/gt-opengis/19.0/gt-opengis-19.0.jar",
