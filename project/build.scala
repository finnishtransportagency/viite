  ...
  lazy val geoJar = Project (
    ...
    settings = Defaults.defaultSettings ++ Seq(
      ...
      libraryDependencies ++= Seq(
        ...
        "org.geotools" % "gt-graph" % "19.0" from "file:////codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/gt-graph-19.0.jar",
        "org.geotools" % "gt-main" % "19.0" from "file:///codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/gt-main-19.0.jar",
        "org.geotools" % "gt-api" % "19.0" from "file:///codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/gt-api-19.0.jar",
        "org.geotools" % "gt-referencing" % "19.0" from "file:///codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/gt-referencing-19.0.jar",
        "org.geotools" % "gt-metadata" % "19.0" from "file:///codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/gt-metadata-19.0.jar",
        "org.geotools" % "gt-opengis" % "19.0" from "file:///codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/gt-opengis-19.0.jar",
        "jgridshift" % "jgridshift" % "1.0" from "file:///codebuild/output/src321189951/src/github.com/finnishtransportagency/viite/lib/jgridshift-1.0.jar",
