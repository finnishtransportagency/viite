...
class RoadAddressLinkBuilderSpec extends FunSuite with Matchers {
  ...
  test("Suravage link builder") {
    ...
    val suravageAddress = OracleDatabase.withDynSession { RoadAddressLinkBuilder.buildSuravageRoadAddressLink(VVHRoadlink(newLinkId1, municipalityCode, List(Point(1.0, 0.0), Point(20.0, 1.0)), administrativeClass, trafficDirection, FeatureClass.DrivePath, None, attributes1, ConstructionType.UnderConstruction, LinkGeomSource.SuravageLinkInterface, 30))}
