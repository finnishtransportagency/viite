...
values (62019094,0,2,0,67.768,null,7096025,1516719259000,to_timestamp('17.08.08 17:22:07,285806000','RR.MM.DD HH24:MI:SSXFF'),3)""".execute
      println("second-lrm")
      sqlu"""Insert into LRM_POSITION (ID,LANE_CODE,SIDE_CODE,START_MEASURE,END_MEASURE,MML_ID,LINK_ID,ADJUSTED_TIMESTAMP,MODIFIED_DATE,LINK_SOURCE) values ('62019097',null,2,0,67.768,null,7096025,1516719259000,to_timestamp('17.08.08 17:22:07,285806000','RR.MM.DD HH24:MI:SSXFF'),3)""".execute
