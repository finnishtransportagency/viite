...
class RoadAddressLinkBuilderSpec extends FunSuite with Matchers {
  ...
  val roadAddressService = new RoadAddressService(mockRoadLinkService, mockRoadwayDAO, mockLinearLocationDAO,
    mockRoadNetworkDAO, mockRoadwayPointDAO, mockNodePointDAO, mockJunctionPointDAO, mockRoadwayAddressMapper, mockEventBus) {
  ...
  test("Test ProjectAddressLinkBuilder.build() When building project address links from regular project links and road links Then return the build ProjectAddressLinks.") {
    val unknownProjectLink = ProjectLink(0, 0, 0, Track.Unknown, Discontinuity.Continuous, 0, 0, 0, 0, None, None, None, 0, KMTKID("0", 0), 0.0, 0.0,
    ...
    val projectLinks =
      Map(
        1717380l -> ProjectLink(1270, 0, 0, Track.apply(99), Continuous, 1021, 1028, 1021, 1028, None, None, None, 1717380, KMTKID("1717380", 0), 0.0, 6.0,
    ...
    pal1.kmtkRoadName.get should be("Evitskogintie")
    ...
    pal2.kmtkRoadName.get should be("Evitskogsvägen")
