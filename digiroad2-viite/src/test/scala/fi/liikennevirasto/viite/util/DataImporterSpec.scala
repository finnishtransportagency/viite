...
class DataImporterSpec extends FunSuite with Matchers {
  ...
  val terminatedRoadsToBeConverted = Seq(
    ...
    ConversionAddress(30,  1, 1, 5,    0, 100,  201,  300, Some(d("01.03.1980")), Some(d("29.01.1991")), Some(d("30.01.1990")), None,                         1,  3,        1, 0,     "ajrpilkont", Some(346769.646), Some(6688615.011), Some(346862.556), Some(6688687.082), 3, Unknown),
    ConversionAddress(30,  1, 1, 5,  100, 200,  300,  400, Some(d("01.03.1980")), Some(d("29.01.1991")), Some(d("30.01.1990")), None,                         1,  3,        1, 0,     "ajrpilkont", Some(346769.646), Some(6688615.011), Some(346862.556), Some(6688687.082), 4, Unknown),
    ConversionAddress(30,  2, 1, 5,    0, 100,    0,   99, Some(d("01.03.1980")), Some(d("29.01.1991")), Some(d("30.01.1990")), None,                         1,  3,        1, 0,     "ajrpilkont", Some(346769.646), Some(6688615.011), Some(346862.556), Some(6688687.082), 5, Unknown)
  )
