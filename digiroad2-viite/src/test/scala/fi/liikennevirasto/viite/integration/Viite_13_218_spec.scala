...
//        roadwayDeleteCPS.close()
        ...
        val newLinks = Seq(
          ...
          RoadLink(11910546.toString, List(Point(512278.172,6838789.637,102.53500000000349), Point(512274.223,6838795.509,102.55400000000373)), 7.076, State, 99, TrafficDirection.TowardsDigitizing, UnknownLinkType, Some("31.03.2021 02:00:14"), None, Map("MUNICIPALITYCODE" -> BigInt(491L), "VALIDFROM" -> BigInt(1597795200000L), "MTKID" -> BigInt(1999769121L), "ROADNAME_FI" -> "Jyväskyläntie", "points" -> "List(Map(x -> 512278.172, y -> 6838789.637, z -> 102.53500000000349, m -> 0), Map(x -> 512274.223, y -> 6838795.509, z -> 102.55400000000373, m -> 7.076400000005378))", "ROADPARTNUMBER" -> BigInt(218L), "CONSTRUCTIONTYPE" -> BigInt(0L), "MTKCLASS" -> BigInt(12121L), "CREATED_DATE" -> BigInt(1599089451000L), "LAST_EDITED_DATE" -> BigInt(1617145214000L), "geometryWKT" -> "LINESTRING ZM (512278.172 6838789.637 102.53500000000349 0, 512274.223 6838795.509 102.55400000000373 7.076400000005378)", "ROADNUMBER" -> BigInt(13L)), InUse, FrozenLinkInterface),
