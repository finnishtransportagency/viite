...
class Viite_13_218_spec extends FunSuite with Matchers with BeforeAndAfter {
  ...
  val projectService_db: ProjectService = new ProjectService(roadAddressService_db, mockRoadLinkService, nodesAndJunctionsService_db, roadwayDAO, roadwayPointDAO, linearLocationDAO, projectDAO, projectLinkDAO, nodeDAO, nodePointDAO, junctionPointDAO, projectReservedPartDAO, roadwayChangesDAO, roadwayAddressMapper, eventbus_db, frozenTimeAPIServiceEnabled = true){
...
//        roadwayDeleteCPS.close()
        ...
        val newLinks = Seq(
          ...
          RoadLink(11910544.toString, List(Point(512274.223,6838795.509,102.55400000000373), Point(512271.222,6838800.05,102.55100000000675)), 5.443, State, TrafficDirection.TowardsDigitizing, Some("31.03.2021 02:00:14"), None, InUse, FrozenLinkInterface, 491, ""),
          RoadLink(11910546.toString, List(Point(512278.172,6838789.637,102.53500000000349), Point(512274.223,6838795.509,102.55400000000373)), 7.076, State, TrafficDirection.TowardsDigitizing, Some("31.03.2021 02:00:14"), None, InUse, FrozenLinkInterface, 491, ""),
          RoadLink(11910547.toString, List(Point(512271.067,6838785.463,102.57300000000396), Point(512269.753,6838787.989,103.0), Point(512267.421,6838792.474,102.50800000000163)), 7.902, State, TrafficDirection.AgainstDigitizing, Some("31.03.2021 02:00:14"), None, InUse, FrozenLinkInterface, 491, ""),
          ...
          RoadLink(11910589.toString, List(Point(512477.964,6838476.83,103.28299999999581), Point(512476.259,6838479.304,103.22500000000582)), 3.005, State, TrafficDirection.BothDirections, Some("31.03.2021 02:00:14"), None, InUse, FrozenLinkInterface, 491, "")
        )
