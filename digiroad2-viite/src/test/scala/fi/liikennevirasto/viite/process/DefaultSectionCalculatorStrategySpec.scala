...
class DefaultSectionCalculatorStrategySpec extends FunSuite with Matchers {
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() " +
    ...
    runWithRollback {
      ...
      val projectLinkLeft2 = ProjectLink(nextPlId, 9999L, 1L, Track.apply(2), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, Some("user"), 12346L, 0.0, getEndMValue(geomLeft2), SideCode.Unknown, (NoCP, NoCP), (CalibrationPointType.NoCP, CalibrationPointType.NoCP), geomLeft2, 0L, LinkStatus.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomLeft2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkLeft3 = ProjectLink(nextPlId, 9999L, 1L, Track.apply(2), Discontinuity.Discontinuous, 0L, 24L, 0L, 24L, None, None, Some("user"), 12347L, 0.0, getEndMValue(geomLeft3), SideCode.Unknown, (NoCP, NoCP), (CalibrationPointType.NoCP, CalibrationPointType.NoCP), geomLeft3, 0L, LinkStatus.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomLeft3), roadwayId+1, linearLocationId+1, 0, reversed = false, None, 86400L, roadwayNumber = 12347L)
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() " +
    ...
    runWithRollback {
      ...
      val linearLocations = Seq(
        LinearLocation(743191,1.0,2618358,0.0,98.608,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(4457),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(567803.211,6770711.35,0.0), Point(567855.431,6770794.886,0.0)),NormalLinkInterface,148127472,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574753,2.0,2618963,0.0,31.354,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(5708),Some(RoadAddressCP))),List(Point(568617.281,6771210.193,0.0), Point(568589.668,6771224.197,0.0)),NormalLinkInterface,202230200,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574748,1.0,6929632,0.0,11.754,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(5188),Some(RoadAddressCP)),CalibrationPointReference(Some(5199),Some(JunctionPointCP))),List(Point(568217.253,6771280.15,0.0), Point(568207.996,6771287.394,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(706053,2.0,11140159,0.0,409.401,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(569219.082,6771105.294,0.0), Point(568816.54,6771179.281,0.0)),NormalLinkInterface,49024,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756719,11.0,2621332,0.0,10.767,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564508.096,6769659.41,0.0), Point(564516.756,6769665.794,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574747,2.0,6929630,0.0,9.466,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(5199),Some(JunctionPointCP)),CalibrationPointReference(None,None)),List(Point(568207.996,6771287.394,0.0), Point(568202.955,6771294.85,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(583467,6.0,2620635,0.0,63.029,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565329.505,6770203.41,0.0), Point(565391.096,6770216.569,0.0)),NormalLinkInterface,6651364,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756711,2.0,2621089,0.0,24.875,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564172.93,6769549.712,0.0), Point(564196.676,6769557.122,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574755,1.0,2618948,0.0,21.242,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(5651),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(568565.985,6771209.469,0.0), Point(568586.942,6771210.011,0.0)),NormalLinkInterface,202230207,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(351769,1.0,2621175,30.585,83.861,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(561),Some(RoadAddressCP))),List(Point(564534.23,6769690.454,0.0), Point(564547.823,6769741.506,0.0)),NormalLinkInterface,79184,Some(DateTime.parse("2018-07-05T00:00:00.000+03:00")),None),
        LinearLocation(753914,3.0,6929628,0.0,9.37,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(5213),Some(JunctionPointCP)),CalibrationPointReference(None,None)),List(Point(568214.732,6771292.557,0.0), Point(568209.675,6771300.445,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754558,6.0,2618374,0.0,112.356,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(4375),Some(JunctionPointCP))),List(Point(567713.195,6770541.615,0.0), Point(567758.927,6770644.055,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754650,5.0,2618183,0.0,55.645,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568290.466,6771361.089,0.0), Point(568240.362,6771383.32,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743248,3.0,2621305,0.0,91.83,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564188.057,6769570.037,0.0), Point(564275.655,6769597.59,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743247,6.0,2621326,0.0,67.642,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564343.821,6769619.097,0.0), Point(564408.211,6769639.806,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756714,3.0,2621306,0.0,76.535,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564196.676,6769557.122,0.0), Point(564269.726,6769579.955,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756712,8.0,2621337,0.0,63.921,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564351.01,6769605.741,0.0), Point(564411.946,6769625.046,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743249,5.0,2621309,0.0,4.571,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564339.459,6769617.732,0.0), Point(564343.821,6769619.097,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754555,2.0,2618571,0.0,327.094,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566995.698,6770160.081,0.0), Point(566705.487,6770308.363,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(564163,1.0,10648023,64.061,233.576,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565390.105,6770226.184,0.0), Point(565557.582,6770251.705,0.0)),NormalLinkInterface,148128101,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(564157,3.0,2618589,0.0,28.254,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566620.18,6770362.463,0.0), Point(566595.988,6770376.558,0.0)),NormalLinkInterface,148128092,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(753913,7.0,2618173,0.0,39.387,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568316.466,6771332.381,0.0), Point(568284.507,6771355.401,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754640,1.0,2621196,0.0,10.965,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(Some(561),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(564547.578,6769759.089,0.0), Point(564547.676,6769770.054,0.0)),NormalLinkInterface,202230183,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(742394,3.0,2620680,0.0,239.642,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565583.716,6770242.816,0.0), Point(565820.814,6770277.457,0.0)),NormalLinkInterface,148125309,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743242,8.0,2621323,0.0,92.672,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564419.431,6769643.519,0.0), Point(564506.506,6769674.274,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743244,4.0,2621314,0.0,66.909,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564275.655,6769597.59,0.0), Point(564339.459,6769617.732,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(563293,5.0,6929633,0.0,8.487,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(5179),Some(JunctionPointCP)),CalibrationPointReference(Some(5188),Some(RoadAddressCP))),List(Point(568207.996,6771287.394,0.0), Point(568214.345,6771292.261,0.0)),NormalLinkInterface,148127472,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(744060,2.0,2620700,0.0,27.864,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565557.582,6770251.705,0.0), Point(565585.208,6770255.256,0.0)),NormalLinkInterface,148128101,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754642,4.0,2620909,0.0,19.337,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564561.162,6769966.829,0.0), Point(564563.559,6769986.017,0.0)),NormalLinkInterface,202230183,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743231,1.0,2620896,0.0,17.476,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(Some(812),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(564584.524,6770035.876,0.0), Point(564601.614,6770039.528,0.0)),NormalLinkInterface,148127686,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(753912,4.0,6929627,0.0,49.032,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568209.675,6771300.445,0.0), Point(568200.075,6771347.159,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(564158,5.0,2618597,0.0,63.045,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(3020),Some(RoadAddressCP))),List(Point(566683.044,6770321.233,0.0), Point(566631.183,6770356.686,0.0)),NormalLinkInterface,148128092,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756715,7.0,2621320,0.0,8.601,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564342.786,6769603.221,0.0), Point(564351.01,6769605.741,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(564160,2.0,12675141,0.0,34.254,SideCode.AgainstDigitizing,1652734800000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566595.776,6770376.698,0.0), Point(566567.36,6770395.367,0.0)),ComplementaryLinkInterface,148128092,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574754,2.0,2618964,0.0,30.459,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(5708),Some(RoadAddressCP))),List(Point(568587.184,6771210.003,0.0), Point(568617.148,6771210.075,0.0)),NormalLinkInterface,202230207,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743234,2.0,2620884,0.0,249.621,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564601.614,6770039.528,0.0), Point(564844.399,6770097.101,0.0)),NormalLinkInterface,148127686,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574749,7.0,2618973,0.0,205.311,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568507.394,6771257.095,0.0), Point(568320.8,6771337.798,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743230,3.0,2620784,0.0,155.167,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564844.399,6770097.101,0.0), Point(564995.227,6770133.5,0.0)),NormalLinkInterface,148127686,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(744061,3.0,2620681,0.0,236.094,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565585.208,6770255.256,0.0), Point(565819.046,6770286.572,0.0)),NormalLinkInterface,148128101,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574744,4.0,2618179,0.0,62.471,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568191.341,6771349.171,0.0), Point(568239.904,6771383.21,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574011,8.0,2618974,0.0,207.456,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568498.281,6771235.056,0.0), Point(568316.466,6771332.381,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754560,8.0,2618361,0.0,56.683,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(4457),Some(RoadAddressCP))),List(Point(567771.643,6770664.271,0.0), Point(567803.211,6770711.35,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756718,1.0,2621083,0.0,105.305,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(Some(0),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(564071.924,6769520.061,0.0), Point(564172.93,6769549.712,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(563344,9.0,2621176,0.0,22.565,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564506.506,6769674.274,0.0), Point(564522.441,6769690.074,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(708099,1.0,2618357,0.0,99.048,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(4457),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(567803.211,6770711.35,0.0), Point(567864.089,6770789.104,0.0)),NormalLinkInterface,50308,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574703,5.0,2618596,0.0,59.188,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(3020),Some(RoadAddressCP))),List(Point(566682.903,6770321.273,0.0), Point(566630.204,6770347.582,0.0)),NormalLinkInterface,148124318,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(744063,4.0,2618678,0.0,90.718,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(2190),Some(RoadAddressCP))),List(Point(565819.046,6770286.572,0.0), Point(565908.092,6770303.342,0.0)),NormalLinkInterface,148128101,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(563296,4.0,6929618,0.0,177.61,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(5179),Some(JunctionPointCP))),List(Point(568098.755,6771148.171,0.0), Point(568207.996,6771287.394,0.0)),NormalLinkInterface,148127472,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(528201,3.0,2618153,0.0,166.64,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568107.22,6771142.294,0.0), Point(568209.873,6771272.633,0.0)),NormalLinkInterface,50308,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(763365,1.0,2620897,0.0,18.744,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(Some(812),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(564586.051,6770020.349,0.0), Point(564603.375,6770027.506,0.0)),NormalLinkInterface,6651364,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754638,5.0,2620911,0.0,15.23,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(812),Some(RoadAddressCP))),List(Point(564563.559,6769986.017,0.0), Point(564564.707,6770001.204,0.0)),NormalLinkInterface,202230183,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(563342,1.0,2621176,22.565,75.545,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(561),Some(RoadAddressCP))),List(Point(564522.441,6769690.074,0.0), Point(564537.159,6769739.538,0.0)),NormalLinkInterface,148127709,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574016,9.0,2618955,0.0,12.919,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(5651),Some(RoadAddressCP))),List(Point(568509.719,6771228.123,0.0), Point(568498.681,6771234.836,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743246,1.0,2621084,0.0,104.894,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(Some(0),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(564063.384,6769533.617,0.0), Point(564164.119,6769562.655,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574017,2.0,2618186,0.0,12.661,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(5199),Some(JunctionPointCP)),CalibrationPointReference(Some(5213),Some(JunctionPointCP))),List(Point(568217.253,6771280.15,0.0), Point(568214.732,6771292.557,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(562440,4.0,2618480,0.0,133.577,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(2790),Some(RoadAddressCP))),List(Point(566482.601,6770432.12,0.0), Point(566351.082,6770439.097,0.0)),NormalLinkInterface,148125051,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574701,4.0,2618604,0.0,14.931,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566630.204,6770347.582,0.0), Point(566617.109,6770354.755,0.0)),NormalLinkInterface,148124318,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754644,6.0,2618174,0.0,38.244,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568320.8,6771337.798,0.0), Point(568290.466,6771361.089,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754557,4.0,2618392,0.0,105.993,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(4136),Some(JunctionPointCP)),CalibrationPointReference(None,None)),List(Point(567657.912,6770430.601,0.0), Point(567706.521,6770524.419,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(462093,1.0,2621199,0.0,10.459,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(Some(561),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(564537.828,6769760.388,0.0), Point(564539.283,6769770.745,0.0)),NormalLinkInterface,202230176,Some(DateTime.parse("2018-07-05T00:00:00.000+03:00")),None),
        LinearLocation(562439,1.0,2618671,0.0,309.535,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(2190),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(565908.092,6770303.342,0.0), Point(566205.396,6770388.445,0.0)),NormalLinkInterface,148125051,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754559,5.0,2618315,0.0,18.446,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(567706.521,6770524.419,0.0), Point(567713.195,6770541.615,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(564156,1.0,2618584,0.0,93.474,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(Some(2790),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(566566.945,6770395.596,0.0), Point(566482.601,6770432.12,0.0)),NormalLinkInterface,148128092,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(742395,4.0,2618679,0.0,91.243,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(2190),Some(RoadAddressCP))),List(Point(565820.814,6770277.457,0.0), Point(565908.092,6770303.342,0.0)),NormalLinkInterface,148125309,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756717,9.0,2621328,0.0,13.674,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564411.946,6769625.046,0.0), Point(564424.981,6769629.176,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743232,5.0,2620726,0.0,335.841,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565000.8,6770134.863,0.0), Point(565327.494,6770212.633,0.0)),NormalLinkInterface,148127686,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(562493,1.0,2620635,63.029,233.406,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565391.096,6770216.569,0.0), Point(565559.534,6770239.421,0.0)),NormalLinkInterface,148125309,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754553,7.0,2618378,0.0,23.905,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(Some(4375),Some(JunctionPointCP)),CalibrationPointReference(None,None)),List(Point(567758.927,6770644.055,0.0), Point(567771.643,6770664.271,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743233,4.0,2620798,0.0,5.737,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564995.227,6770133.5,0.0), Point(565000.8,6770134.863,0.0)),NormalLinkInterface,148127686,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756720,6.0,2621311,0.0,50.696,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564294.486,6769587.821,0.0), Point(564342.786,6769603.221,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(563330,6.0,10648023,0.0,64.061,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565327.494,6770212.633,0.0), Point(565390.046,6770226.171,0.0)),NormalLinkInterface,148127686,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(706054,4.0,11275750,0.0,72.467,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(6404),Some(JunctionPointCP))),List(Point(569298.536,6771087.834,0.0), Point(569227.758,6771103.389,0.0)),NormalLinkInterface,49024,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743245,7.0,2621329,0.0,11.818,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564408.211,6769639.806,0.0), Point(564419.431,6769643.519,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574750,3.0,2618159,0.0,57.38,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568202.694,6771295.236,0.0), Point(568191.221,6771348.81,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(763364,5.0,2620729,0.0,335.083,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565004.057,6770123.957,0.0), Point(565329.505,6770203.41,0.0)),NormalLinkInterface,6651364,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574752,1.0,2618945,0.0,23.343,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(Some(5651),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(568589.408,6771224.42,0.0), Point(568572.459,6771239.949,0.0)),NormalLinkInterface,202230200,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(526153,1.0,2618918,0.0,201.305,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(Some(5708),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(568816.238,6771179.327,0.0), Point(568617.607,6771210.055,0.0)),NormalLinkInterface,49024,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574012,6.0,2618182,0.0,48.654,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568284.507,6771355.401,0.0), Point(568239.515,6771372.293,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(763362,3.0,2620785,0.0,155.679,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564846.183,6770086.623,0.0), Point(564997.683,6770122.45,0.0)),NormalLinkInterface,6651364,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(742393,2.0,2620697,0.0,24.014,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(565559.937,6770239.468,0.0), Point(565583.716,6770242.816,0.0)),NormalLinkInterface,148125309,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(562441,2.0,2618703,0.0,135.096,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566205.396,6770388.445,0.0), Point(566332.427,6770434.134,0.0)),NormalLinkInterface,148125051,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(562438,3.0,2618716,0.0,19.208,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566332.517,6770434.167,0.0), Point(566350.881,6770439.044,0.0)),NormalLinkInterface,148125051,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756721,12.0,2621175,0.0,30.585,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564516.756,6769665.794,0.0), Point(564534.23,6769690.454,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574704,1.0,2618583,0.0,91.162,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(Some(2790),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(566561.533,6770386.961,0.0), Point(566482.601,6770432.12,0.0)),NormalLinkInterface,148124318,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743193,2.0,2618335,0.0,367.046,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(567855.431,6770794.886,0.0), Point(568063.083,6771097.483,0.0)),NormalLinkInterface,148127472,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(763363,4.0,2620802,0.0,6.55,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564997.683,6770122.45,0.0), Point(565004.057,6770123.957,0.0)),NormalLinkInterface,6651364,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(706055,3.0,11142353,0.0,8.883,SideCode.AgainstDigitizing,1635808409000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(569227.758,6771103.389,0.0), Point(569219.082,6771105.294,0.0)),NormalLinkInterface,49024,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743194,3.0,2618344,0.0,61.982,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568063.083,6771097.483,0.0), Point(568098.755,6771148.171,0.0)),NormalLinkInterface,148127472,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574010,1.0,2618153,166.64,177.175,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(5199),Some(JunctionPointCP))),List(Point(568209.873,6771272.633,0.0), Point(568217.253,6771280.15,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754556,3.0,2618435,0.0,754.015,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(4136),Some(JunctionPointCP))),List(Point(566995.698,6770160.081,0.0), Point(567657.912,6770430.601,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(574705,3.0,2618600,0.0,28.861,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566617.109,6770354.755,0.0), Point(566591.789,6770368.606,0.0)),NormalLinkInterface,148124318,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756716,4.0,2621315,0.0,11.151,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564269.726,6769579.955,0.0), Point(564280.309,6769583.47,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(708098,2.0,2618337,0.0,428.813,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(567864.089,6770789.104,0.0), Point(568107.22,6771142.294,0.0)),NormalLinkInterface,50308,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754554,1.0,2618610,0.0,25.827,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(Some(3020),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(566705.487,6770308.363,0.0), Point(566683.078,6770321.204,0.0)),NormalLinkInterface,148122120,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(462096,4.0,2620912,0.0,17.014,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(812),Some(RoadAddressCP))),List(Point(564554.132,6769986.065,0.0), Point(564552.128,6770002.918,0.0)),NormalLinkInterface,202230176,Some(DateTime.parse("2018-07-05T00:00:00.000+03:00")),None),
        LinearLocation(574746,8.0,2618942,0.0,13.458,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(5651),Some(RoadAddressCP))),List(Point(568520.493,6771254.735,0.0), Point(568507.698,6771257.029,0.0)),NormalLinkInterface,202230193,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754641,2.0,2621223,0.0,90.539,SideCode.TowardsDigitizing,1634598047000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564547.676,6769770.054,0.0), Point(564553.319,6769860.417,0.0)),NormalLinkInterface,202230183,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(763361,2.0,2620883,0.0,249.906,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564603.375,6770027.506,0.0), Point(564846.183,6770086.623,0.0)),NormalLinkInterface,6651364,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(462095,3.0,2621210,0.0,167.07,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564542.894,6769819.375,0.0), Point(564554.132,6769986.065,0.0)),NormalLinkInterface,202230176,Some(DateTime.parse("2018-07-05T00:00:00.000+03:00")),None),
        LinearLocation(574702,2.0,12675142,0.0,35.227,SideCode.AgainstDigitizing,1652734800000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566591.595,6770368.723,0.0), Point(566561.67,6770386.875,0.0)),ComplementaryLinkInterface,148124318,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(526157,5.0,2618768,0.0,417.78,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(Some(6404),Some(JunctionPointCP)),CalibrationPointReference(Some(6826),Some(RoadAddressCP))),List(Point(569685.205,6770938.98,0.0), Point(569298.536,6771087.834,0.0)),NormalLinkInterface,49024,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756710,5.0,2621318,0.0,14.83,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564280.309,6769583.47,0.0), Point(564294.486,6769587.821,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(753908,5.0,2618178,0.0,48.914,SideCode.TowardsDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(568200.075,6771347.159,0.0), Point(568239.515,6771372.293,0.0)),NormalLinkInterface,202228103,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(564159,4.0,2618605,0.0,12.173,SideCode.AgainstDigitizing,1630018852000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(566631.03,6770356.766,0.0), Point(566620.401,6770362.337,0.0)),NormalLinkInterface,148128092,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(754639,3.0,2620906,0.0,106.701,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564553.319,6769860.417,0.0), Point(564561.162,6769966.829,0.0)),NormalLinkInterface,202230183,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(743250,2.0,2621085,0.0,25.05,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564164.119,6769562.655,0.0), Point(564188.057,6769570.037,0.0)),NormalLinkInterface,148127711,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(756713,10.0,2621322,0.0,88.702,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564424.981,6769629.176,0.0), Point(564508.096,6769659.41,0.0)),NormalLinkInterface,79190,Some(DateTime.parse("2022-06-15T00:00:00.000+03:00")),None),
        LinearLocation(462094,2.0,2621184,0.0,48.764,SideCode.TowardsDigitizing,1533863903000L,(CalibrationPointReference(None,None),CalibrationPointReference(None,None)),List(Point(564539.283,6769770.745,0.0), Point(564542.894,6769819.375,0.0)),NormalLinkInterface,202230176,Some(DateTime.parse("2018-07-05T00:00:00.000+03:00")),None)
      )
  ...
  test("Test findStartingPoints " +
    ...
    runWithRollback {
      ...
      val otherProjectLinks = Seq(
        ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12345L, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, LinkStatus.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12346L, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, LinkStatus.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, LinkStatus.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, 0, reversed = true, None, 86400L),
        ...
        ProjectLink(plId + 4, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12349L, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom5, 0L, LinkStatus.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom5), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 5, 9999L, 1L, Track.Combined, Discontinuity.Discontinuous, 0L, 0L, 0L, 0L, None, None, None, 12350L, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom6, 0L, LinkStatus.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom6), 0L, 0, 0, reversed = true, None, 86400L)
      )
