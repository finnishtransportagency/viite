...
//    val mapping = Seq(
//      LinearLocationMapping(1021200L, 1021217L, 193080L, 0.0, 10.0, 2.214, 5.0, Seq(Point(0.0, 0.0), Point(0.0,10.0)), Seq(Point(0.0, 0.0), Point(0.0,10.0))),
//      LinearLocationMapping(1021200L, 1021200L, 193080L, 10.0, 40.0, 40.0, 0.0, Seq(Point(0.0, 10.0), Point(0.0,40.0)), Seq(Point(0.0, 40.0), Point(0.0,0.0))),
//      LinearLocationMapping(1021200L, 1021217L, 193080L, 40.0, 82.925, 5.0, 17.215, Seq(Point(0.0, 40.0), Point(0.0,143.345)), Seq(Point(0.0, 5.0), Point(0.0,17.215))),
//      LinearLocationMapping(1021217L, 1021217L, 233578L, 0.0, 40.345, 0.0, 2.214/17.215*40.345, Seq(Point(0.0, 40.0), Point(0.0,143.345)), Seq(Point(0.0, 5.0), Point(0.0,17.215)))
//    )
//    val roadAddressTarget = roadAddressSource.flatMap(DefloatMapper.mapRoadAddresses(mapping, roadAddressSource))
//    roadAddressTarget.size should be (4)
