...
//TODO until the defloat process is not implemented the extend from RoadAddressMapper should be removed VIITE-1537 and replaced by BaseRoasAddressMapper
