    ...
    splitProjectLinks.groupBy(_.linearLocationId).flatMap { case (_, seq) =>
      ...
      (templateTerm, kept) match {
        case (Some(t), Some(k)) if GeometryUtils.areAdjacent(t.geometry.head, k.geometry.last) =>
          // t extends k
          Seq(RoadAddressMapping(t.linkId, t.linkId, t.id, t.startMValue, t.endMValue, t.startMValue, t.endMValue,
            t.geometry, t.geometry, None),
            RoadAddressMapping(t.linkId, k.linkId, t.id, 0.0, t.startMValue, k.startMValue, k.endMValue,
        ...
        case (Some(t), Some(k)) if GeometryUtils.areAdjacent(k.geometry.head, t.geometry.last) =>
          ...
          Seq(RoadAddressMapping(t.linkId, t.linkId, t.id, t.startMValue, t.endMValue, t.startMValue, t.endMValue,
            ...
            RoadAddressMapping(t.linkId, k.linkId, t.id, t.endMValue, t.endMValue + (k.endMValue - k.startMValue),
