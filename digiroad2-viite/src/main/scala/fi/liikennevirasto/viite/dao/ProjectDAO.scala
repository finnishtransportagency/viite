...
import org.scalatra.NotImplemented
...
class ProjectDAO {
  ...
  implicit val getProjectLinkRow = new GetResult[ProjectLink] {
    def apply(r: PositionedResult) = {
      ...
      val originalStartAddrM = r.nextLong()
      val originalEndAddrM = r.nextLong()
      ...
      ProjectLink(projectLinkId, roadNumber, roadPartNumber, track, discontinuityType, startAddrM, endAddrM, originalStartAddrM, originalEndAddrM, startDate, endDate,
...
//    }
  ...
  def updateProjectLinksGeometry(projectLinks: Seq[ProjectLink], modifier: String): Unit = {
    throw new NotImplementedError("TODO Is this needed?")
