(function (root) {
  root.ProjectCollection = function (backend, startupParameters) {
    ...
    var deleteButton = function (index, roadNumber, roadPartNumber, selector) {
      ...
      return '<i roadNumber="' + roadNumber + '" roadPartNumber="' + roadPartNumber + '" id="' + index + '" class="delete ml-2 mt-1 btn-delete ' + selector + ' fas fa-trash-alt fa-lg" ' + (disabledInput ? 'disabled' : '') + '></i>';
    };
