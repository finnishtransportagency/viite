...
import { createLinkEditFormBehavior } from './LinkEditFormBehavior.js';
import { createLinkEditFormRenderer } from './LinkEditFormRenderer.js';
...
export function LinkEditForm(canUseDevTools) {
    ...
    const behavior = createLinkEditFormBehavior({
    ...
    const renderer = createLinkEditFormRenderer({
      canUseDevTools,
      RoadAddressChangeType,
      Track,
      AdministrativeClass,
