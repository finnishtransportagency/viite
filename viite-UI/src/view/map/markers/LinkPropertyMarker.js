/**
 * LinkPropertyMarker - Creates styled OpenLayers markers for link properties with directional indicators.
 */
import { GeometryUtils } from '@utils/GeometryUtils.js';
import { ViiteEnumerations } from '@utils/ViiteEnumerations.js';

export function LinkPropertyMarker() {
  const createMarker = function (roadlink, f) { // create marker receives the function that will call addFeature
    ...
    const boxStyleDirectional = function (rl) {
      const markerColor = hex2Rgba(getDirectionMarkerColor(rl));
