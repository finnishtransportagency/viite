(function (root) {
  root.RoadLinkStyler = function () {
    ...
    var overlayStyle = new StyleRuleProvider({zIndex: ViiteEnumerations.RoadZIndex.CalibrationPointLayer.value});
    ...
    var borderStyle = new StyleRuleProvider({zIndex: ViiteEnumerations.RoadZIndex.VectorLayer.value});
