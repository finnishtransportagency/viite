(function (root) {
    root.RoadLinkStyler = function () {
        ...
        var strokeWidthRules = [
            ...
            new StyleRule().where('zoomLevel').is(14).use({stroke: {width: 7 }}),
            new StyleRule().where('zoomLevel').is(15).use({stroke: {width: 7 }}),
        ...
        var strokeAdministrativeClassRules = [
            new StyleRule().where('zoomLevel').is(5).and('administrativeClass').is('Municipality').and('roadClass').isNot(7)
                ...
                .and('roadClass').isNot(99).use({stroke: {width: 2 }}),
        ...
        var strokeRules = [
            ...
            new StyleRule().where('roadClass').is(99).and('roadLinkSource').isNot(3).use({stroke: {color: '#A4A4A2', lineCap: 'butt'}}),
        ...
        var fillRules = [
            ...
            new StyleRule().where('roadClass').is(98).use({stroke: {color: '#FAFAFA', lineCap: 'butt'}}),
            new StyleRule().where('gapTransfering').is(true).use({stroke: {color: '#00FF00', lineCap: 'butt'}}),
            new StyleRule().where('roadClass').is(99).and('roadLinkSource').isNot(3).and('constructionType').isNot(LinkValues.ConstructionType.UnderConstruction.value).use({stroke: {color: '#A4A4A2', lineCap: 'butt'}}),
            ...
            new StyleRule().where('roadClass').is(99).and('anomaly').is(1).and('constructionType').isNot(LinkValues.ConstructionType.UnderConstruction.value).use({stroke: {color: '#1E1E1E', lineCap: 'butt'}}),
