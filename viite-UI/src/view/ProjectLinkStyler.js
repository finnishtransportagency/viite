(function (root) {
  root.ProjectLinkStyler = function () {
    ...
    var fillWidthRules = [
      ...
      new StyleRule().where('zoomLevel').isIn([5, 6]).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 3}}),
      new StyleRule().where('zoomLevel').isIn([7, 8]).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 4}}),
    ...
    var borderRules = [
      new StyleRule().where('zoomLevel').isIn([5, 6]).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 7}}),
      new StyleRule().where('zoomLevel').isIn([7, 8]).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 8}}),
      new StyleRule().where('zoomLevel').is(9).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 9}}),
      new StyleRule().where('zoomLevel').is(10).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 10}}),
      new StyleRule().where('zoomLevel').is(11).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 11}}),
      new StyleRule().where('zoomLevel').is(12).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 12}}),
      new StyleRule().where('zoomLevel').is(13).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 15}}),
      new StyleRule().where('zoomLevel').is(14).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 17}}),
      new StyleRule().where('zoomLevel').is(15).and('roadTypeId').isIn(LinkValues.BlackUnderlineAdministrativeClasses).use({stroke: {width: 19}})
    ];
