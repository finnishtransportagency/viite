(function (root) {
    root.ProjectLinkStyler = function () {
        ...
        var projectLinkRules = [
            new StyleRule().where('constructionType').is(LinkValues.ConstructionType.UnderConstruction.value).use({stroke: {color:'#000', lineCap: 'butt', lineDash: [10, 10]}}),
            ...
            new StyleRule().where('status').is(unknownStatus).and('anomaly').is(1).and('constructionType').isNot(LinkValues.ConstructionType.UnderConstruction.value).use({stroke: {color: '#383836', lineCap: 'round', opacity: 1}}),
