...
./aws-build-image.sh
echo "Logging in to AWS ACR with Docker"
...
./aws-register-task-definition-dev.sh

echo "Updating service"
# Using simply --force-new-deployment, because the service is using always the latest viite container
