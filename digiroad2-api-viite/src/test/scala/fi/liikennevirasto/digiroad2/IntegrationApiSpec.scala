...
class IntegrationApiSpec extends FunSuite with ScalatraSuite with BeforeAndAfter {
  ...
  test("Test getWithBasicUserAuth() When asking for changes in the roadnames correctly including the Since but with 1 update to 1 road Then returns status code 200 and a filled array with the info for the road.") {
    ...
    getWithBasicUserAuth("/roadnames/changes?since=2018-01-01", "kalpa", "kalpa") {
      status should equal(200)
      response.body should equal(
        "[{\"road_number\":2,\"names\":[{\"change_date\":\"" + DateTime.parse("2018-01-01").toString + "\",\"road_name\":\"MYROAD\",\"start_date\":\"" + DateTime.parse("2018-02-02").toString + "\",\"end_date\":null\",\"created_by\":\"MOCK\"}]}]"
      )
    }
  }
  ...
  test("Test getWithBasicUserAuth() When asking for changes in the roadnames correctly including the Since with many updates to return to 1 road Then returns status code 200 and a filled array with the info for the updates.") {
    ...
    getWithBasicUserAuth("/roadnames/changes?since=2018-01-01", "kalpa", "kalpa") {
      ...
      response.body should equal(
        "[{\"road_number\":2,\"names\":[" +
          "{\"change_date\":\"" + DateTime.parse("2018-01-01").toString + "\",\"road_name\":\"MY ROAD\",\"start_date\":\"" + DateTime.parse("2018-02-02").toString + "\",\"end_date\":null\",\"created_by\":\"MOCK\"}," +
          "{\"change_date\":\"" + DateTime.parse("2018-01-01").toString + "\",\"road_name\":\"THEROAD\",\"start_date\":\"" + DateTime.parse("2000-02-02").toString + "\",\"end_date\":\"" + DateTime.parse("2018-02-01").toString + "\",\"created_by\":\"MOCK\"}," +
          "{\"change_date\":\"" + DateTime.parse("1900-01-01").toString + "\",\"road_name\":\"OLDROAD\",\"start_date\":\"" + DateTime.parse("1900-02-02").toString + "\",\"end_date\":\"" + DateTime.parse("2000-02-01").toString + "\",\"created_by\":\"MOCK\"}" +
          "]}]"
      )
    }
  }
  ...
  test("Test getWithBasicUserAuth() When asking for changes in the roadnames correctly including the Since with many updates to return to 2 roads Then returns status code 200 and a filled array with the info for the updates.") {
    ...
    getWithBasicUserAuth("/roadnames/changes?since=2017-12-01", "kalpa", "kalpa") {
      ...
      response.body should equal(
        "[" +
          "{\"road_number\":2,\"names\":[" +
          "{\"change_date\":\"" + DateTime.parse("2017-12-01").toString + "\",\"road_name\":\"MY ROAD\",\"start_date\":\"" + DateTime.parse("2018-02-02").toString + "\",\"end_date\":null\",\"created_by\":\"MOCK\"}," +
          "{\"change_date\":\"" + DateTime.parse("2017-12-01").toString + "\",\"road_name\":\"THEROAD\",\"start_date\":\"" + DateTime.parse("2000-02-02").toString + "\",\"end_date\":\"" + DateTime.parse("2018-02-01").toString + "\",\"created_by\":\"MOCK\"}," +
          "{\"change_date\":\"" + DateTime.parse("1900-01-01").toString + "\",\"road_name\":\"OLDROAD\",\"start_date\":\"" + DateTime.parse("1900-02-02").toString + "\",\"end_date\":\"" + DateTime.parse("2000-02-01").toString + "\",\"created_by\":\"MOCK\"}" +
          "]}," +
          "{\"road_number\":3,\"names\":[" +
          "{\"change_date\":\"" + DateTime.parse("2017-12-01").toString + "\",\"road_name\":\"ANOTHER ROAD\",\"start_date\":\"" + DateTime.parse("2017-12-12").toString + "\",\"end_date\":null\",\"created_by\":\"MOCK\"}" +
          "]}" +
          "]"
      )
    }
