...
--------------------------------------------------------
-- @changes 2021-12-02 SQL variant of the script changed from Oracle to Postgis
--------------------------------------------------------

  CREATE TABLE AJORATA
   (ID               BIGINT,
	TILA             VARCHAR(1)  NOT NULL,
  ...
  CREATE INDEX AJORATA_IND5 ON AJORATA (LAKKAUTUSPVM, CAST(ALKUPVM AS DATE));
  ...
  CREATE TABLE SOLMU
   (ID                    BIGINT,
	...
	NIMI                  VARCHAR(40),
	SELITE                VARCHAR(256),
	SOLMUN_TYYPPI         SMALLINT     NOT NULL,
