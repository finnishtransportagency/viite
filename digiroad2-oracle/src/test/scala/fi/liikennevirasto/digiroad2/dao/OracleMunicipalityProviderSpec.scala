...
class OracleMunicipalityProviderSpec extends FunSuite with Matchers {
  ...
  test("Test OracleMunicipalityProvider.getMunicipalities() When searching for a municipalities with 1 ElyCodes Then return a set of all the municipality Ids for that Ely code.", Tag("db")) {
  ...
  test("Test OracleMunicipalityProvider.getMunicipalities() When searching for a municipalities with 2 ElyCodes return a set of all the municipality Ids for both Ely codes.", Tag("db")) {
