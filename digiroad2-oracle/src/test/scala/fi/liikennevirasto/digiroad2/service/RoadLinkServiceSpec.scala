...
class RoadLinkServiceSpec extends FunSuite with Matchers with BeforeAndAfter {
  ...
  test("Test getRoadLinksAndComplementaryByBounds() When submitting a specific bounding box and a municipality Then return regular roadlinks and complementary roadlinks that are in the bounding box and belong to said municipality.") {
    ...
    val complRoadLink1 = VVHRoadlink(1, KMTKID("1"), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.InUse)
    val complRoadLink2 = VVHRoadlink(2, KMTKID("2"), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.UnderConstruction)
    val complRoadLink3 = VVHRoadlink(3, KMTKID("3"), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.Planned)
    val complRoadLink4 = VVHRoadlink(4, KMTKID("4"), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.InUse)

    val roadLink1 = KMTKRoadLink(5, KMTKID("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa", 1), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.InUse)
    val roadLink2 = KMTKRoadLink(6, KMTKID("bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb", 1), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.UnderConstruction)
    val roadLink3 = KMTKRoadLink(7, KMTKID("cccccccccccccccccccccccccccccccc", 1), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.Planned)
    val roadLink4 = KMTKRoadLink(8, KMTKID("dddddddddddddddddddddddddddddddd", 1), 91, Nil, Municipality, TrafficDirection.TowardsDigitizing, FeatureClass.AllOthers, lifecycleStatus = LifecycleStatus.InUse)
