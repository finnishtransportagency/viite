CREATE TABLE ROADWAY (
  ...
  CONSTRAINT ROADWAY_HISTORY_UK UNIQUE (ROAD_NUMBER, ROAD_PART_NUMBER, START_ADDR_M, END_ADDR_M,
    TRACK, DISCONTINUITY, START_DATE, END_DATE, VALID_FROM, VALID_TO, ELY, ROAD_TYPE, TERMINATED) USING INDEX,
...
CREATE TABLE LINEAR_LOCATION (
  ...
  CONSTRAINT LINEAR_LOCATION_UK UNIQUE (ROADWAY_NUMBER, ORDER_NUMBER, LINK_ID, START_MEASURE, END_MEASURE,
    VALID_TO, CAL_START_ADDR_M, CAL_END_ADDR_M, FLOATING, SIDE, LINK_SOURCE) USING INDEX
);
...
CREATE TABLE ROAD_NETWORK_ERROR (
  ID NUMBER(38,0) NOT NULL, 
  ROADWAY_ID NUMBER(38,0) NOT NULL,
  LINEAR_LOCATION_ID NUMBER(38,0) NOT NULL,
  ...
  CONSTRAINT ADDRESS_ERROR_VERSION_UK UNIQUE (ROADWAY_ID, LINEAR_LOCATION_ID, ERROR_CODE, ROAD_NETWORK_VERSION) USING INDEX,
