...
CREATE TABLE PROJECT_LINK (
  ...
  CONSTRAINT PROJECT_LINK_ROAD_ADDRESS_FK FOREIGN KEY (ROAD_ADDRESS_ID) REFERENCES ROADWAY (ID),
...
CREATE TABLE PUBLISHED_ROAD_ADDRESS (
  ...
  CONSTRAINT PUBROADADDR_ROAD_ADDRESS_FK FOREIGN KEY (ROAD_ADDRESS_ID) REFERENCES ROADWAY (ID)
);
...
CREATE TABLE ROAD_NETWORK_ERROR (
  ...
  CONSTRAINT RAE_RA_FK FOREIGN KEY (ROAD_ADDRESS_ID) REFERENCES ROADWAY (ID),
