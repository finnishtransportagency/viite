...
CREATE TABLE PROJECT_LINK (
  ...
  CONSTRAINT PROJECT_LINK_ROAD_ADDRESS_FK FOREIGN KEY (ROADWAY_ID) REFERENCES ROADWAY (ID),
...
CREATE TABLE PUBLISHED_ROAD_ADDRESS (
  ...
  CONSTRAINT PUBLISHED_ROAD_ADDRESS_PK PRIMARY KEY (NETWORK_ID, ROADWAY_ID),
  CONSTRAINT PUBROADADDR_PUBROADNETWORK_FK FOREIGN KEY (NETWORK_ID) REFERENCES PUBLISHED_ROAD_NETWORK (ID),
  CONSTRAINT PUBROADADDR_ROAD_ADDRESS_FK FOREIGN KEY (ROADWAY_ID) REFERENCES ROADWAY (ID)
);
...
CREATE TABLE ROAD_NETWORK_ERROR (
  ...
  CONSTRAINT RAE_RA_FK FOREIGN KEY (ROADWAY_ID) REFERENCES ROADWAY (ID),
