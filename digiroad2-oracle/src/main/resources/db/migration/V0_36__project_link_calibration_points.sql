...
*/
ALTER TABLE PROJECT_LINK ADD (START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
ALTER TABLE PROJECT_LINK ADD (END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
ALTER TABLE PROJECT_LINK ADD (ORIG_START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
ALTER TABLE PROJECT_LINK ADD (ORIG_END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
...
ALTER TABLE PROJECT_LINK_HISTORY ADD (START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
ALTER TABLE PROJECT_LINK_HISTORY ADD (END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
ALTER TABLE PROJECT_LINK_HISTORY ADD (ORIG_START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
ALTER TABLE PROJECT_LINK_HISTORY ADD (ORIG_END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL);
