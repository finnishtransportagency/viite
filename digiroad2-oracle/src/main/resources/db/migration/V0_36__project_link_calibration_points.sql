...
*/
ALTER TABLE PROJECT_LINK ADD COLUMN START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
ALTER TABLE PROJECT_LINK ADD COLUMN END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
ALTER TABLE PROJECT_LINK ADD COLUMN ORIG_START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
ALTER TABLE PROJECT_LINK ADD COLUMN ORIG_END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
...
ALTER TABLE PROJECT_LINK_HISTORY ADD COLUMN START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
ALTER TABLE PROJECT_LINK_HISTORY ADD COLUMN END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
ALTER TABLE PROJECT_LINK_HISTORY ADD COLUMN ORIG_START_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
ALTER TABLE PROJECT_LINK_HISTORY ADD COLUMN ORIG_END_CALIBRATION_POINT SMALLINT DEFAULT 0 NOT NULL;
