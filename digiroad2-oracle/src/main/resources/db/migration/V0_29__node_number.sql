ALTER TABLE NODE_POINT ADD COLUMN NODE_NUMBER BIGINT;
UPDATE NODE_POINT AS NP SET NP.NODE_NUMBER = (SELECT NODE.NODE_NUMBER FROM NODE NODE WHERE NODE.ID = NP.NODE_ID);
ALTER TABLE NODE_POINT DROP COLUMN NODE_ID;

ALTER TABLE JUNCTION ADD COLUMN NODE_NUMBER BIGINT;
UPDATE JUNCTION AS J SET J.NODE_NUMBER = (SELECT NODE.NODE_NUMBER FROM NODE NODE WHERE NODE.ID = J.NODE_ID);
...
ALTER TABLE NODE_POINT ADD COLUMN "TYPE" SMALLINT DEFAULT 99 NOT NULL;
