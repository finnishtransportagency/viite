...
ALTER TABLE NODE ADD COLUMN VALID_FROM TIMESTAMP DEFAULT current_timestamp NOT NULL;
ALTER TABLE JUNCTION DROP COLUMN VALID_FROM;
ALTER TABLE JUNCTION ADD COLUMN VALID_FROM TIMESTAMP DEFAULT current_timestamp NOT NULL;
