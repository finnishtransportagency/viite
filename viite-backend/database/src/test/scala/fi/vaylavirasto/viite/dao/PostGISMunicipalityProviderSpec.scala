...
class PostGISMunicipalityProviderSpec extends FunSuite with Matchers {
  ...
  private val elyCodeForLappi = Set(1)
  private val elyCodeForAhvenanmaa = Set(0)
  private val elyCodesForLappiAndAhvenanmaa = elyCodeForLappi ++ elyCodeForAhvenanmaa
  private val municipalitiesForLappiEly = Set(47, 148, 240, 241, 261, 273, 320, 498, 583, 614, 683, 698, 732, 742, 751, 758, 845, 851, 854, 890, 976)
  private val municipalitiesForAahvenanmaaEly = Set(35, 43, 60, 62, 65, 76, 170, 295, 318, 417, 438, 478, 736, 766, 771, 941)
