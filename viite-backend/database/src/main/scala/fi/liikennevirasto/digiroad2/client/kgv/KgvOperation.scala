...
object KgvCollection {
  case object Frozen                  extends KgvCollection { def value = "keskilinjavarasto:frozenlinks" } // extends KgvCollection { def value = "keskilinjavarasto:road_links_versions" }
