...
object KgvCollection {
  case object Frozen                  extends KgvCollection { def value = "keskilinjavarasto:frozenlinks" }    //extends KgvCollection { def value = "keskilinjavarasto:road_links_20251020" }   // extends KgvCollection { def value = "keskilinjavarasto:road_links_versions" }
