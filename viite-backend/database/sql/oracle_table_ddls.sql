 ...
 NOCOMPRESS LOGGING
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "MUNI_ELY_MANTAINER_UK" UNIQUE ("ID", "ELY_NRO", "ROAD_MAINTAINER_ID", "ROAD_MAINTAINER")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "ROADWAY"
   (	"ID" NUMBER(38,0) NOT NULL ENABLE,
	...
	"VALID_FROM" DATE DEFAULT sysdate NOT NULL ENABLE,
	"VALID_TO" DATE,
    "ROAD_MAINTAINER" VARCHAR(5) NOT NULL DEFAULT 'EVK0' ENABLE,
  ...
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE,
	 CONSTRAINT "ROADWAY_HISTORY_UK" UNIQUE ("ROAD_NUMBER", "ROAD_PART_NUMBER", "START_ADDR_M", "END_ADDR_M", "TRACK", "DISCONTINUITY", "START_DATE", "END_DATE", "VALID_FROM", "VALID_TO", "ROAD_MAINTAINER", "ROAD_TYPE", "TERMINATED")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
 ...
 NOCOMPRESS LOGGING
  ...
  CREATE TABLE "ROADWAY_CHANGES"
   (	"PROJECT_ID" NUMBER(38,0) NOT NULL ENABLE,
	...
	"NEW_ROAD_MAINTAINER" VARCHAR(5) ENABLE,
	"OLD_ROAD_TYPE" NUMBER(2,0),
	"OLD_DISCONTINUITY" NUMBER(1,0),
	"OLD_ROAD_MAINTAINER" VARCHAR(5),
