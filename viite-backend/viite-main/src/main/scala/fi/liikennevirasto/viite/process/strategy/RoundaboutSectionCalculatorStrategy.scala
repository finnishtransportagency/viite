    ...
    if (projectLinks.isEmpty) {
      ...
      projectLinks.tail.foldLeft(Seq(Seq(projectLinks.head))) {
        case (acc, pl) =>
          ...
          if (lastLink.addrMRange.continuesTo(pl.addrMRange) && lastLink.administrativeClass == pl.administrativeClass && lastLink.arealRoadMaintainer == pl.arealRoadMaintainer) {
