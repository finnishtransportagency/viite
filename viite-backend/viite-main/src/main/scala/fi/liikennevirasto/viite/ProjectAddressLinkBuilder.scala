...
object ProjectAddressLinkBuilder extends AddressLinkBuilder {
  ...
  def build(pl: ProjectLink, splitPart: Option[ProjectLink] = None): ProjectAddressLink = {
    ...
    ProjectAddressLink(
      ...
      pl.geometry,
      pl.geometryLength,
      AdministrativeClass.Unknown,
      LifecycleStatus.UnknownLifecycleStatus,
      pl.linkGeomSource,
      pl.administrativeClass,
      pl.roadName,
      0L,
      "",
      None,
  ...
  def build(ral: RoadAddressLinkLike): ProjectAddressLink = {
    ProjectAddressLink(
      ...
      ral.geometry,
      ral.length,
      ral.administrativeClassMML,
      ral.lifecycleStatus,
      ral.roadLinkSource,
      ral.administrativeClass,
      ral.roadName,
      ral.municipalityCode,
      ral.municipalityName,
      ral.modifiedAt,
      ral.modifiedBy,
      ral.roadPart,
      ral.trackCode,
      ...
      ral.endMValue,
      ral.sideCode,
      ral.startCalibrationPoint,
      ral.endCalibrationPoint,
      RoadAddressChangeType.Unknown,
      ral.id,
  ...
  private def build(
                     ...
                     originalAddrMRange: Option[AddrMRange],
                     startMValue: Double,
                     endMValue: Double,
                     sideCode: SideCode,
    ...
    ProjectAddressLink(
      ...
      originalGeometry,
      sourceId = "",
      originalAddrMRange = originalAddrMRange)
  }
