...
println()
  ...
  private def convertToAValidSplitChange(change: LinkNetworkChange): Option[LinkNetworkSplitChange] = {
    ...
    def checkForInvalidLinkIds(oldLink: LinkInfo, newLinks: Seq[LinkInfo], splitInfos: Seq[ReplaceInfo]) = {
    ...
    def checksForInvalidGeometry(oldLink: LinkInfo, newLinks: Seq[LinkInfo]) = {
    ...
    checkForInvalidLinkIds(oldLink, newLinks, splitInfos)

    checksForInvalidLinkLengths(oldLink: LinkInfo, newLinks, splitInfos)
    ...
    checksForInvalidGeometry(oldLink, newLinks)
