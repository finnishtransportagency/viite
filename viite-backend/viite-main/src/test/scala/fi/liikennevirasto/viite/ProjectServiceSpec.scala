...
class ProjectServiceSpec extends AnyFunSuite with Matchers with BeforeAndAfter with BaseDAO {
 ...
 val defaultChangeInfo = RoadwayChangeInfo(
   ...
   RoadwayChangeSection(Option(403), Option(0), Option(8), Option(0), Option(AddrMRange(8,1001)),
     Option(AdministrativeClass.State), Option(Discontinuity.Continuous), Option(5), Option(ArealRoadMaintainer.getEVK(8))),
 ...
 test("Test saveProject When new part is added Then return project with new reservation") {
   ...
   runWithRollback {
     ...
     val addresses: List[ProjectReservedPart] = List(ProjectReservedPart(Sequences.nextViitePrimaryKeySeqValue: Long, RoadPart(5, 207), Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None))
 ...
 test("Test checkRoadPartsExist When roadway exist Then return None") {
   runWithRollback {
     ...
     val ra = Seq(Roadway(id1, roadwayNumber, RoadPart(roadNumber, roadStartPart), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, "tester", Some("test road"), 1L, ArealRoadMaintainer.getEVK(1)))
 ...
 test("Test checkRoadPartsExist When start road way exists and end doesn't then return error message") {
   runWithRollback {
     ...
     val roadwayNumber = 8000
     val id1 = Sequences.nextRoadwayId
     val ra = Seq(Roadway(id1, roadwayNumber, RoadPart(roadNumber, roadStartPart), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, "tester", Some("test road"), 1L, ArealRoadMaintainer.getEVK(8)))
     roadwayDAO.create(ra)
     val check = projectService.checkRoadPartsExist(roadNumber, roadStartPart, roadEndPart)
 ...
 test("Test checkRoadPartsExist When start road way does not exist and end exists then return error message") {
   runWithRollback {
     ...
     val roadwayNumber = 8000
     val id1 = Sequences.nextRoadwayId
     val ra = Seq(Roadway(id1, roadwayNumber, RoadPart(roadNumber, roadEndPart), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, "tester", Some("test road"), 1L, ArealRoadMaintainer.getEVK(8)))
     roadwayDAO.create(ra)
     val check = projectService.checkRoadPartsExist(roadNumber, roadStartPart, roadEndPart)
     check should be(Some(ErrorStartingRoadPartNotFound))
   }
 ...
 test("Test checkRoadPartsReservable When road can Then return on right part 2") {
   ...
   runWithRollback {
     val id1 = Sequences.nextRoadwayId
     val ra = Seq(Roadway(id1, roadwayNumber, RoadPart(roadNumber, roadStartPart), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, "tester", Some("test road"), 8L, ArealRoadMaintainer.getEVK(8)))
     ...
     val rb = Seq(Roadway(id2, roadwayNumber, RoadPart(roadNumber, roadEndPart), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, "tester", Some("Test road 2"), 8L, ArealRoadMaintainer.getEVK(8)))
 ...
 test("Test checkRoadPartsReservable When road part is already reserved to the current project Then should return reserved info.") {
   ...
   runWithRollback {
     roadwayDAO.create(
                       Seq(Roadway(Sequences.nextRoadwayId, roadwayNumber, RoadPart(roadNumber, roadStartPart), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, testUser, Some("test road"), 8L, ArealRoadMaintainer.getEVK(8)),
                           Roadway(Sequences.nextRoadwayId, roadwayNumber, RoadPart(roadNumber, roadEndPart),   AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, testUser, Some("Test road 2"), 8L, ArealRoadMaintainer.getEVK(8)))
                      )
 ...
 test("Test projectService.saveProject When after project creation we reserve roads to it Then return the count of created project should be increased AND Test projectService.getAllProjects When not specifying a projectId Then return the count of returned projects should be 0 ") {
   ...
   runWithRollback {
     ...
     projectService.saveProject(project.copy(reservedParts = List(ProjectReservedPart(Sequences.nextViitePrimaryKeySeqValue: Long, RoadPart(1130, 4), Some(5L), Some(Discontinuity.Continuous), Some(1L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None)), elys = Set()))
     val countAfterInsertProjects = projectService.getAllProjects
     count = countCurrentProjects.size + 1
     countAfterInsertProjects.size should be(count)
   }
 ...
 test("Test projectService.validateProjectDate() When evaluating project links with start date are equal as the project start date Then return no error message") {
   runWithRollback {
     ...
     val addresses = List(ProjectReservedPart(5: Long, RoadPart(5, 205), Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None))
 ...
 test("Test projectService.getSingleProjectById() When after creation of a new project, with reserved parts Then return only 1 project whose name is the same that was defined. ") {
   ...
   runWithRollback {
     val countCurrentProjects = projectService.getAllProjects
     val addresses: List[ProjectReservedPart] = List(ProjectReservedPart(Sequences.nextViitePrimaryKeySeqValue: Long, RoadPart(5, 206), Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None))
 ...
 test("Test getRoadAddressSingleProject When project with reserved parts is created Then return the created project") {
   ...
   runWithRollback {
     ...
     val ra = Seq(Roadway(id, roadwayNumber, roadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 1000L), reversed = false, DateTime.parse("1901-01-01"), None, "Tester", Option("test name"), 8L, ArealRoadMaintainer.getEVK(8)))
...
//    Project1 projectlink is connected to Project2 projectlink at point 1000, 10 and there is no junction which means that Project2 projectlink cannot be created with new action
   runWithRollback {
     val id = Sequences.nextViiteProjectId
     val ra1 = Seq(
       RoadAddress(12345, linearLocationId,     RoadPart(19999, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0L,  5L), Some(DateTime.parse("1901-01-01")), None, Some("User"), 1000.toString, 0, 5, SideCode.TowardsDigitizing,  DateTime.now().getMillis, (None, None), Seq(Point(1000.0,  0.0), Point(1000.0,  5.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, roadwayNumber1, Some(DateTime.parse("1901-01-01")), None, None),
       RoadAddress(12346, linearLocationId + 1, RoadPart(19999, 1), AdministrativeClass.State, Track.Combined, Discontinuity.EndOfRoad,  AddrMRange(5L, 10L), Some(DateTime.parse("1901-01-01")), None, Some("User"), 1001.toString, 0, 5, SideCode.TowardsDigitizing,  DateTime.now().getMillis, (None, None), Seq(Point(1000.0,  5.0), Point(1000.0, 10.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, roadwayNumber2, Some(DateTime.parse("1901-01-01")), None, None)
     )
     val ra2 = Seq(
       RoadAddress(12347, linearLocationId + 2, RoadPart(12345, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(10L, 15L), Some(DateTime.parse("1901-01-01")), None, Some("User"), 1002.toString, 0, 5, SideCode.TowardsDigitizing, DateTime.now().getMillis, (None, None), Seq(Point(1000.0, 10.0), Point(1000.0, 25.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, roadwayNumber3, Some(DateTime.parse("1901-01-01")), None, None),
       RoadAddress(12348, linearLocationId + 3, RoadPart(12345, 1), AdministrativeClass.State, Track.Combined, Discontinuity.EndOfRoad,  AddrMRange(15L, 20L), Some(DateTime.parse("1901-01-01")), None, Some("User"), 1003.toString, 0, 5, SideCode.TowardsDigitizing, DateTime.now().getMillis, (None, None), Seq(Point(1000.0, 25.0), Point(1000.0, 30.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, roadwayNumber4, Some(DateTime.parse("1901-01-01")), None, None)
     )
     ...
     val response1 = projectService.createProjectLinks(Seq(1000L.toString, 1001L.toString), rap1.id, RoadPart(56, 207), Track.Combined, Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8L, ArealRoadMaintainer.getEVK(8), "test", "road name")
     ...
     val response2 = projectService.createProjectLinks(Seq(1002L.toString,1003L.toString), rap2.id, RoadPart(55, 206), Track.Combined, Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8L, ArealRoadMaintainer.getEVK(8), "test", "road name")
 ...
 test("Test addNewLinksToProject When reserving part already used in other project Then return error message") {
   runWithRollback {
     ...
     val projectLink = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idr, 123, RoadPart(5, 207), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 10L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0, 9.8, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(0.0, 0.0), Point(0.0, 9.8)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     projectDAO.create(rap)
     projectService.saveProject(rap)


     val rap2 = Project(id + 1, ProjectState.apply(1), "TestProject2", "TestUser", DateTime.parse("2700-01-01"), "TestUser", DateTime.now(), DateTime.parse("2700-01-01"), "Some additional info", List.empty[ProjectReservedPart], Seq(), None, elys = Set())
     val projectLink2 = toProjectLink(rap2, RoadAddressChangeType.New)(RoadAddress(idr, 1234, RoadPart(5, 999), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0L, 10L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0, 9.8, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(0.0, 0.0), Point(0.0, 9.8)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     projectDAO.create(rap2)
     projectService.saveProject(rap2)
 ...
 test("Test createProjectLinks When adding new links to a new road and roadpart Then discontinuity should be on correct link.") {
   def runTest(reversed: Boolean) = {
     ...
     val projectLinks   = Seq(
       toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 123, roadPart, AdministrativeClass.Unknown, Track.Combined, continuous, AddrMRange(0L,  0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0,  9.8, SideCode.Unknown, 0, (None, None), Seq(Point(0.0, 0.0), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0)),
       toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 124, roadPart, AdministrativeClass.Unknown, Track.Combined, continuous, AddrMRange(0L,  0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12346L.toString, 0.0, 19.8, SideCode.Unknown, 0, (None, None), Seq(Point(0.0, 9.8), Point(9.8, 29.6)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     )
     projectDAO.create(rap)
     projectService.saveProject(rap)
     ...
     val message1project1 = projectService.createProjectLinks(longs, rap.id, roadPart, Track.Combined, discontinuity, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), user, "new road")
 ...
 test("Test addNewLinksToProject When adding new links to a new road and roadpart Then values should be correct.") {
   runWithRollback {
     ...
     val user           = "TestUser"
     val rap            = Project(projectId, ProjectState.apply(1), "TestProject", user, DateTime.parse("2700-01-01"), user, DateTime.parse("1972-03-03"), DateTime.parse("2700-01-01"), "Some additional info", List.empty[ProjectReservedPart], Seq(), None, elys = Set())
     val projectLink1   = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 123, roadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L,  0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0,  9.8, SideCode.Unknown, 0, (None, None), Seq(Point(0.0, 0.0), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     val projectLink2   = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 124, roadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L,  0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12346L.toString, 0.0, 19.8, SideCode.Unknown, 0, (None, None), Seq(Point(0.0, 9.8), Point(9.8, 29.6)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     projectDAO.create(rap)
     projectService.saveProject(rap)
     projectReservedPartDAO.reserveRoadPart(projectId, roadPart, user)
 ...
 test("Test addNewLinksToProject When adding new links to existing road and new roadpart Then values should be correct.") {
   runWithRollback {
     ...
     val rap = Project(projectId, ProjectState.apply(1), "TestProject", user, DateTime.parse("2700-01-01"), user, DateTime.parse("1972-03-03"), DateTime.parse("2700-01-01"), "Some additional info", List.empty[ProjectReservedPart], Seq(), None, elys = Set())
     val projectLinks = Seq(
      toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 125, newRoadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0, 10.4, SideCode.Unknown, 0, (None, None), Seq(Point(532427.945,6998488.475,0.0),Point(532395.164,6998549.616,0.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0)),
      toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 126, newRoadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12346L.toString, 0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(532427.945,6998488.475,0.0),Point(532495.0,  6998649.0,  0.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     )
     projectDAO.create(rap)
     projectService.saveProject(rap)
     projectReservedPartDAO.reserveRoadPart(projectId, roadPart,    user)
 ...
 test("Test addNewLinksToProject When adding new links to existing road and existing roadpart Then values should be correct.") {
   runWithRollback {
     ...
     val projectLinks = Seq(
       toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 125, roadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0, 10.4, SideCode.Unknown, 0, (None, None), Seq(Point(0,20),Point(0,30,0.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0)),
       toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(Sequences.nextRoadwayId, 126, roadPart, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1963-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12346L.toString, 0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(0.0,30.0),Point(0.0,40.0)), LinkGeomSource.NormalLinkInterface, 8, ArealRoadMaintainer.getEVK(8), NoTermination, 0))
     )
     projectDAO.create(rap)
 ...
 test("Test projectService.fetchPreFillData " +
   ...
   runWithRollback {
     ...
     projectService.fetchPreFillData(projectLinks.head.linkId, roadAddressProject.id) should be(Right(PreFillInfo(roadPart.roadNumber, roadPart.partNumber, "", RoadNameSource.UnknownSource, projectLinks.head.ely, projectLinks.head.roadMaintainer)))
   }
 }
 ...
 test("Test projectService.fetchPreFillData " +
   ...
   runWithRollback {
     ...
     val projectLinks = roadwayAddressMapper.getRoadAddressesByRoadway(roadwayDAO.fetchAllByRoadPart(roadPart)).map(toProjectLink(roadAddressProject))
     projectLinkDAO.create(projectLinks)
     projectService.fetchPreFillData(projectLinks.head.linkId, roadAddressProject.id) should be(Right(PreFillInfo(roadPart.roadNumber, roadPart.partNumber, "road name test", RoadNameSource.RoadAddressSource, projectLinks.head.ely, projectLinks.head.roadMaintainer)))
   }
 }
 ...
 test("Test projectService.fetchPreFillData() " +
   ...
   runWithRollback{
     ...
     val projectLinks = roadwayAddressMapper.getRoadAddressesByRoadway(roadwayDAO.fetchAllByRoadPart(roadPart)).map(toProjectLink(roadAddressProject))
     projectLinkDAO.create(projectLinks)
     projectService.fetchPreFillData(projectLinks.head.linkId, roadAddressProject.id) should be(Right(PreFillInfo(roadPart.roadNumber, roadPart.partNumber, "TestRoadName_Project_Link", RoadNameSource.ProjectLinkSource, projectLinks.head.ely, projectLinks.head.roadMaintainer)))
   }
 }
...
//    }
   ...
   runWithRollback {
     ...
     val pl2 = ProjectLink(-1000L, RoadPart(9999, 1), Track.apply(2), Discontinuity.Continuous, AddrMRange(0L,  0L), AddrMRange(0L,  0L), None, None, None, 12346L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), Seq(Point(20.0, 10.0), Point(30.0, 15.0)), 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(Seq(Point(20.0, 10.0), Point(30.0, 15.0))), 0L, 0, 0, ArealRoadMaintainer.getEVK(0), reversed = false, None, 86400L)
     val pl3 = ProjectLink(-1000L, RoadPart(9999, 1), Track.apply(2), Discontinuity.Continuous, AddrMRange(0L,  0L), AddrMRange(0L,  0L), None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), Seq(Point(30.0, 15.0), Point(45.0, 10.0)), 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(Seq(Point(30.0, 15.0), Point(45.0, 10.0))), 0L, 0, 0, ArealRoadMaintainer.getEVK(0), reversed = false, None, 86400L)
     val pl4 = ProjectLink(-1000L, RoadPart(9999, 1), Track.apply(1), Discontinuity.Continuous, AddrMRange(0L,  0L), AddrMRange(0L,  0L), None, None, None, 12348L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), Seq(Point(20.0, 10.0), Point(25.0, 5.0), Point(45.0, 10.0)), 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(Seq(Point(20.0, 10.0), Point(25.0, 5.0), Point(45.0, 10.0))), 0L, 0, 0, ArealRoadMaintainer.getEVK(0), reversed = false, None, 86400L)
     val pl5 = ProjectLink(-1000L, RoadPart(9999, 1), Track.apply(0), Discontinuity.Continuous, AddrMRange(0L,  0L), AddrMRange(0L,  0L), None, None, None, 12349L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), Seq(Point(45.0, 10.0), Point(60.0, 10.0)), 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(Seq(Point(45.0, 10.0), Point(60.0, 10.0))), 0L, 0, 0, ArealRoadMaintainer.getEVK(0), reversed = false, None, 86400L)
 ...
 test("Test projectService.changeDirection() When after the creation of valid project links on a project Then the discontinuity of road addresses that are not the same road number and road part number should not be altered.") {
   runWithRollback {
     ...
     projectService.createProjectLinks(Seq(12346L.toString, 12347L.toString), project.id, RoadPart(9999, 1), Track.LeftSide, Discontinuity.Continuous, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8L, ArealRoadMaintainer.getEVK(8), "test", "road name")
     when(mockRoadLinkService.getRoadLinksByLinkIds(any[Set[String]])).thenReturn(Seq(pl5).map(toRoadLink))
     projectService.createProjectLinks(Seq(12349L.toString), project.id, RoadPart(9998, 1), Track.Combined, Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8L, ArealRoadMaintainer.getEVK(8), "test", "road name")
 ...
 test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       ...
       Roadway(80905,202230394,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,        AddrMRange(716, 806),reversed = false,DateTime.parse("2013-10-01T00:00:00.000+03:00"),None,createdBy,roadName,2,ArealRoadMaintainer.getEVK(2),TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
   ...
   "Then the mAddressValues of the last links should be equal in both sides of the tracks for part 1.")
 {
   runWithRollback {
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 123,9999,1,1,0,26,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL,'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 124,9999,1,2,0,26,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL, 'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 125,9999,2,1,0,7,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL, 'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 126,9999,2,2,0,11,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL, 'EVK1')""")
...
//        */
     ...
     projectService.updateProjectLinks(id, part1AdjacentToPart2LinkRightSide, Seq(), RoadAddressChangeType.Transfer, "test", RoadPart(9999, 2), 1, None, 1, 5, Some(1L), Option(ArealRoadMaintainer.getEVK(1)), reversed = false, None)
     projectService.updateProjectLinks(id, part1AdjacentToPart2LinkLeftSide,  Seq(), RoadAddressChangeType.Transfer, "test", RoadPart(9999, 2), 2, None, 1, 5, Some(1L), Option(ArealRoadMaintainer.getEVK(1)), reversed = false, None)
     ...
     projectService.updateProjectLinks(id, part2track1Links, Seq(), RoadAddressChangeType.Transfer, "test", RoadPart(9999, 2), 1, None, 1, 5, Some(1L), Option(ArealRoadMaintainer.getEVK(1)), reversed = false, None)
     projectService.updateProjectLinks(id, part2Track2Links, Seq(), RoadAddressChangeType.Transfer, "test", RoadPart(9999, 2), 2, None, 1, 5, Some(1L), Option(ArealRoadMaintainer.getEVK(1)), reversed = false, None)
   ...
   "Then the mAddressValues of the last links should be equal in both sides of the tracks for part 1." )
 {
   runWithRollback {
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 1234567,9999,1,1,0,26,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL,'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 1234568,9999,1,2,0,26,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL,'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 1234569,9999,2,1,0,7,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL,'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer)
       values (nextval('roadway_seq'), 1234570,9999,2,2,0,11,0,1,to_date('22-10-90','DD-MM-YY'),NULL,'TR',to_timestamp('21-09-18 12.04.42.970245000','DD-MM-YY HH24.MI.SSXFF'),1,8,0,to_date('16-10-98','DD-MM-YY'),NULL,'EVK1')""")
 ...
 test("Test expireHistoryRows " +
   ...
   runWithRollback {
     ...
     *  with history rows. */
     ...
     val roadwayNumber   = Sequences.nextRoadwayNumber
     val currentRoadway  = Roadway(Sequences.nextRoadwayId, roadwayNumber, RoadPart(9999, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0, oldEndAddress), reversed = false, DateTime.now().minusYears(10).withTime(0, 0, 0, 0), None, "test", Some("Test Road"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination, DateTime.now().minusYears(10), None)
     val history_roadway = Seq(
       Roadway(Sequences.nextRoadwayId, roadwayNumber, RoadPart(9999, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous, AddrMRange(0, oldEndAddress), reversed = false, DateTime.now().minusYears(15).withTime(0, 0, 0, 0), Some(DateTime.now().minusYears(10).withTime(0, 0, 0, 0)), "test", Some("Test Road"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination, DateTime.now().minusYears(15), None),
       Roadway(Sequences.nextRoadwayId, roadwayNumber, RoadPart(9999, 1), AdministrativeClass.State,        Track.Combined, Discontinuity.Continuous, AddrMRange(0, oldEndAddress), reversed = false, DateTime.now().minusYears(20).withTime(0, 0, 0, 0), Some(DateTime.now().minusYears(15).withTime(0, 0, 0, 0)), "test", Some("Test Road"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination, DateTime.now().minusYears(20), None)
     )
     roadwayDAO.create(Seq(currentRoadway) ++ history_roadway)
 ...
 test("Test Road names should not have valid road name for any roadnumber after TR response") {
   runWithRollback {
     ...
     val changes = List(
       ProjectRoadwayChange(projectId, Some("test project"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos.head, DateTime.now())
     )
 ...
 test("Test getLatestRoadName When existing TR success response Then multiple names should be saved") {
   runWithRollback {
     ...
     val changes = List(
       ProjectRoadwayChange(projectId, Some("test project"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos.head, DateTime.now()),
       ProjectRoadwayChange(projectId, Some("test project"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos(1), DateTime.now())
     )
 ...
 test("Test getProjectLinks When doing some operations (Unchanged with termination test, repeats termination update), Then the calibration points are cleared and moved to correct positions") {
   ...
   runWithRollback {
     ...
     val countCurrentProjects = projectService.getAllProjects
     val id = 0
     val addresses = Seq(ProjectReservedPart(5: Long, RP205, Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None),
       ProjectReservedPart(5: Long, RP206, Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None))
 ...
 test("Test getProjectLinks When doing some operations (Transfer and then Terminate), Then the calibration points are cleared and moved to correct positions") {
   ...
   runWithRollback {
     val countCurrentProjects = projectService.getAllProjects
     val id = 0
     val addresses = List(ProjectReservedPart(5: Long, RP207, Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None))
 ...
 test("Test getProjectLinks When doing some operations (Terminate then transfer), Then the calibration points are cleared and moved to correct positions") {
   ...
   runWithRollback {
     val countCurrentProjects = projectService.getAllProjects
     val id = 0
     val addresses = List(ProjectReservedPart(5: Long, RoadPart(5, 207), Some(5L), Some(Discontinuity.Continuous), Some(8L), newLength = None, newDiscontinuity = None, newRoadMaintainer = None))
     val project = Project(id, ProjectState.apply(1), "TestProject", "TestUser", DateTime.now(), "TestUser", DateTime.parse("1970-01-01"), DateTime.now(), "Some additional info", Seq(), Seq(), None, elys = Set())
     val savedProject = projectService.createRoadLinkProject(project)
 ...
 test("Test handleNewRoadNames - Test if a new RoadName is created from a project link and without duplicates") {
   runWithRollback {
     ...
     val changes = List(
       ProjectRoadwayChange(project.id, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos.head, projectStartTime),
       ProjectRoadwayChange(project.id, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos(1), projectStartTime),
       ProjectRoadwayChange(project.id, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos(2), projectStartTime)
     )
 ...
 test("Test handleTerminatedRoadwayChanges - When a project has a Termination RoadWayChange then the RoadName(s) for that RoadNumber have to be expired") {
   runWithRollback {
     ...
     val changes = List(
       ProjectRoadwayChange(0L, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos.head, projectStartTime),
       ProjectRoadwayChange(0L, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos(1), projectStartTime),
       ProjectRoadwayChange(0L, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos(2), projectStartTime)
     )
 ...
 test("Test handleTransferAndRenumeration: Transfer to new road - If source road exists expire its road name and create new road name for target road number") {
   runWithRollback {
     ...
     val changes = List(
       ProjectRoadwayChange(project.id, Some("projectName"), 8, ArealRoadMaintainer.getEVK(8), "Test", DateTime.now(), changeInfos.head, project.startDate)
     )
 ...
 test("Test handleTransferAndRenumeration: Transfer to existing roadway - If source roadway exists expire its roadname") {
   runWithRollback {
     ...
     val roadways = List(
       Roadway( 0L, 0L, RoadPart(srcRoadNumber,    0), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), reversed = false, DateTime.now, Some(DateTime.now), "dummy", None, 0L, ArealRoadMaintainer.getEVK(0), NoTermination),
       Roadway(-1L, 0L, RoadPart(targetRoadNumber, 0), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), reversed = false, DateTime.now, Some(DateTime.now), "dummy", None, 0L, ArealRoadMaintainer.getEVK(0), NoTermination)
     )
     roadwayDAO.create(roadways)
 ...
 test("Test handleTransferAndRenumeration: Renumeration to existing roadway - If source roadway exists expire its roadname") {
   runWithRollback {
     ...
     val roadways = List(
       Roadway( 0L, 0L, RoadPart(srcRoadNumber,    0), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), startDate = DateTime.now, endDate = Some(DateTime.now), createdBy = "dummy", roadName = None, ely = 0L, roadMaintainer = ArealRoadMaintainer.getEVK(0), terminated = NoTermination),
       Roadway(-1L, 0L, RoadPart(targetRoadNumber, 0), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), reversed = false, DateTime.now, Some(DateTime.now), "dummy", None, 0L, ArealRoadMaintainer.getEVK(0), NoTermination)
     )
     roadwayDAO.create(roadways)
 ...
 test("Test changeDirection When after the creation of valid project links on a project Then the side code of road addresses should be successfully reversed.") {
   runWithRollback {
     ...
     projectService.createProjectLinks(Seq(12355L, 12356L, 12357L).map(_.toString), project.id, RoadPart(9999, 1), Track.LeftSide, Discontinuity.Continuous, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8L, ArealRoadMaintainer.getEVK(8), "test", "road name")
 ...
 test("Test checkRoadPartsReservable When there are some transferred road links to that same road part.") {
   runWithRollback {
     ...
     val ra = Seq(
       //Combined
       Roadway(raId,     roadwayNumber1, roadPart,    AdministrativeClass.State, Track.Combined, Discontinuity.EndOfRoad, AddrMRange(0L, 20L), reversed = false, DateTime.now(), None, "test_user", None, 8, ArealRoadMaintainer.getEVK(8), NoTermination, startDate, None),
       //RightSide
       Roadway(raId + 1, roadwayNumber2, newRoadPart, AdministrativeClass.State, Track.Combined, Discontinuity.EndOfRoad, AddrMRange(0L, 50L), reversed = false, DateTime.now(), None, "test_user", None, 8, ArealRoadMaintainer.getEVK(8), NoTermination, startDate, None))
     ...
     projectService.updateProjectLinks(project_id, lastLink, Seq(), RoadAddressChangeType.Transfer, "test", newRoadPart, 0, None, 1, 5, Some(8L), Option(ArealRoadMaintainer.getEVK(8)), reversed = false, None)
     ...
     projectService.updateProjectLinks(project_id, projectLinksSet, Seq(), RoadAddressChangeType.Transfer, "test", newRoadPart, 0, None, 1, 5, Some(1L), Option(ArealRoadMaintainer.getEVK(1)), reversed = false, None)
 ...
 test("Test projectService.createProjectLinks() discontinuity assignment When creating some links Then " +
   ...
   runWithRollback {
     ...
     projectService.createProjectLinks(Seq(12347L.toString, 12346L.toString), project.id, RoadPart(9999, 1), Track.Combined, Discontinuity.MinorDiscontinuity, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 8L, ArealRoadMaintainer.getEVK(8), "test", "road name")
 ...
 test("Test updateRoadwaysAndLinearLocationsWithProjectLinks When VIITE-2236 situation Then don't violate unique constraint on roadway_point table.") {
   runWithRollback {
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052907','40998','22006','12','0','0','215','0','5',to_date('01.01.2017','DD.MM.YYYY'),NULL,'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','0',to_date('28.12.2016','DD.MM.YYYY'),NULL,'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052911','40998','22006','12','0','0','215','0','2',to_date('01.01.1989','DD.MM.YYYY'),to_date('31.12.2016','DD.MM.YYYY'),'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','0',to_date('28.12.2016','DD.MM.YYYY'),NULL,'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052912','40999','22006','12','0','215','216','0','2',to_date('01.01.1989','DD.MM.YYYY'),to_date('30.12.1997','DD.MM.YYYY'),'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','1',to_date('31.01.2013','DD.MM.YYYY'),NULL,'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052910','41000','22006','34','0','0','310','0','2',to_date('01.01.1989','DD.MM.YYYY'),NULL,'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','0',to_date('14.06.2016','DD.MM.YYYY'),NULL,'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052909','6446223','22006','23','0','0','45','0','2',to_date('20.05.2007','DD.MM.YYYY'),NULL,'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','0',to_date('14.06.2016','DD.MM.YYYY'),NULL,'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052906','6446225','22006','45','0','0','248','0','1',to_date('20.05.2007','DD.MM.YYYY'),NULL,'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','0',to_date('25.01.2017','DD.MM.YYYY'),NULL,'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id,roadway_number,road_number,road_part_number,track,start_addr_m,end_addr_m,reversed,discontinuity,start_date,end_date,created_by,created_time,administrative_class,ely,terminated,valid_from,valid_to,road_maintainer) values ('1052908','166883589','22006','12','0','215','295','0','2',to_date('01.01.2017','DD.MM.YYYY'),NULL,'import',to_timestamp('27.12.2019 13:12:51','DD.MM.YYYY HH24:MI:SS'),'1','2','0',to_date('28.12.2016','DD.MM.YYYY'),NULL,'EVK1')""")
     ...
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000356','1000351','0','2','22006','67','169','177','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052907','1039047',NULL,'2','1','2',0,7.685,'568164','1449097206000','4',      ST_GeomFromText('LINESTRING(267444.126 6789234.9 53.176999999996, 267440.935 6789235.99 53.2259999999951, 267437.206395653 6789238.15776997 53.2499974535623)', 3067),'0','8','166883765',0,3,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000357','1000351','0','5','22006','67','0','169','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052907','1039048',NULL,'2','1','3',0,171.504,'7256584','1498959782000','4',     ST_GeomFromText('LINESTRING(267444.126 6789234.9 53.176999999996, 267464.548 6789227.526 52.8959999999934, 267496.884 6789219.216 52.2939999999944, 267515.938 6789216.916 51.7979999999952, 267535.906 6789218.028 51.1319999999978, 267556.73 6789224.333 50.304999999993, 267574.187 6789234.039 49.5789999999979, 267588.124 6789247.565 49.0240000000049, 267597.460867063 6789260.63281394 48.7730035736591)', 3067),'8','177','166883765',3,3,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000358','1000351','0','5','22006','56','80','118','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052907','1039049',NULL,'2','1','3',0,38.688,'7256586','1503961971000','4',     ST_GeomFromText('LINESTRING(267597.461 6789260.633 48.773000000001, 267597.534 6789260.792 48.7719999999972, 267600.106 6789269.768 48.6059999999998, 267600.106 6789280.257 48.4780000000028, 267597.713 6789287.648 48.4360000000015, 267591.642 6789293.381 48.4370000000054, 267589.345139337 6789294.52943033 48.4244527667907)', 3067),'177','215','166883761',3,3,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000359','1000351','0','5','22006','56','0','80','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052908','1039050',NULL,'2','1','3',38.688,120.135,'7256586','1503961971000','4', ST_GeomFromText('LINESTRING(267589.345139337 6789294.52943033 48.4244527667907, 267578.828 6789299.788 48.3669999999984, 267559.269 6789308.892 48.2510000000038, 267546.792 6789314.963 48.2390000000014, 267533.979 6789321.707 48.2140000000072, 267524.2 6789327.103 48.226999999999, 267521.164 6789329.463 48.247000000003, 267518.603162863 6789333.45774594 48.2559994276524)', 3067),'215','295','166883589',3,0,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000360','1000351','0','1','22006','68','0','45','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052909','1039051',NULL,'2','1','2',0,44.211,'7256594','1533681057000','4',       ST_GeomFromText('LINESTRING(267597.461 6789260.633 48.773000000001, 267603.782 6789267.752 48.6589999999997, 267610.19 6789273.485 48.5580000000045, 267616.597 6789277.869 48.4689999999973, 267623.131 6789280.868 48.4400000000023, 267633.897953407 6789283.72598763 48.4409999956788)', 3067),'0','45','6446223',3,3,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000361','1000351','0','5','22006','12','0','127','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052910','1039052',NULL,'2','0','2',0,130.538,'7256590','1498959782000','4',     ST_GeomFromText('LINESTRING(267431.685 6789375.9 48.4470000000001, 267424.673 6789383.39 48.4180000000051, 267415.075 6789389.356 48.448000000004, 267401.067 6789396.879 48.5190000000002, 267384.985 6789404.661 48.6150000000052, 267366.307 6789414.259 48.6889999999985, 267356.079 6789421.259 48.6999999999971, 267351.522 6789425.931 48.7119999999995, 267349.187 6789432.416 48.7799999999988, 267348.928 6789442.533 48.9700000000012, 267352.041 6789450.574 49.1230000000069, 267357.266 6789458.693 49.3099999999977)', 3067),'0','127','166883763',3,3,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000362','1000351','0','5','22006','23','0','174','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052910','1039053',NULL,'2','0','3',0,177.547,'568121','1446398762000','4',      ST_GeomFromText('LINESTRING(267525.375 6789455.936 52.7309999999998, 267499.516 6789463.571 52.426999999996, 267458.911 6789473.392 52.0339999999997, 267426.281 6789480.881 51.4360000000015, 267403.97 6789481.494 50.7459999999992, 267378.849 6789475.013 49.9879999999976, 267357.54 6789459.007 49.3179999999993, 267357.266194778 6789458.69322321 49.3100056869441)', 3067),'127','301','166883762',3,0,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000363','1000351','0','2','22006','23','174','183','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052910','1039054',NULL,'2','0','3',0,9.514,'568122','1449097206000','4',      ST_GeomFromText('LINESTRING(267534.612 6789453.659 52.7939999999944, 267529.741 6789454.905 52.8300000000017, 267525.375 6789455.936 52.7309999999998)', 3067),'301','310','166883762',0,3,0,0,'EVK3')""")
     runUpdateToDb(sql"""INSERT INTO project_link (id,project_id,track,discontinuity_type,road_number,road_part_number,start_addr_m,end_addr_m,created_by,modified_by,created_date,modified_date,status,administrative_class,roadway_id,linear_location_id,connected_link_id,ely,reversed,side,start_measure,end_measure,link_id,adjusted_timestamp,link_source,geometry,original_start_addr_m,original_end_addr_m,roadway_number,start_calibration_point,end_calibration_point,orig_start_calibration_point,orig_end_calibration_point,road_maintainer) VALUES ('1000364','1000351','0','2','22006','24','0','248','silari','silari',to_date('27.12.2019','DD.MM.YYYY'),to_date('27.12.2019','DD.MM.YYYY'),'3','1','1052906','1039046',NULL,'2','1','2',0,248.793,'7256596','1498959782000','4',     ST_GeomFromText('LINESTRING(267357.266 6789458.693 49.3099999999977, 267343.965 6789448.141 49.0489999999991, 267334.962 6789442.665 48.8600000000006, 267328.617 6789440.381 48.7949999999983, 267322.527 6789439.365 48.8000000000029, 267314.914 6789441.141 48.8439999999973, 267303.749 6789445.455 48.976999999999, 267287.508 6789453.576 49.0160000000033, 267268.999 6789462.419 49.2119999999995, 267228.658 6789482.321 49.3870000000024, 267201.225 6789496.844 49.4649999999965, 267167.876 6789511.367 49.7329999999929, 267147.437 6789519.436 49.9670000000042, 267131.966200167 6789520.78998248 50.2599962090907)', 3067),'0','248','6446225',3,3,0,0,'EVK3')""")
     ...
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUES ('1000351','3','22006','22006','12','67','0','0','0','0','177','177','2','1','2','1','5','2','1','1000753','EVK3','EVK3')""")
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUES ('1000351','3','22006','22006','34','12','0','0','0','0','127','127','5','1','2','1','5','2','0','1000754','EVK3','EVK3')""")
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUES ('1000351','3','22006','22006','12','56','0','0','215','0','295','80','5','1','2','1','2','2','1','1000755','EVK3','EVK3')""")
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUES ('1000351','3','22006','22006','34','23','0','0','127','0','310','183','2','1','2','1','2','2','0','1000756','EVK3','EVK3')""")
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUES ('1000351','3','22006','22006','23','68','0','0','0','0','45','45','1','1','2','1','2','2','1','1000757','EVK3','EVK3')""")
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUES ('1000351','3','22006','22006','45','24','0','0','0','0','248','248','2','1','2','1','1','2','1','1000758','EVK3','EVK3')""")
     runUpdateToDb(sql"""INSERT INTO roadway_changes (project_id,change_type,old_road_number,new_road_number,old_road_part_number,new_road_part_number,old_track,new_track,old_start_addr_m,new_start_addr_m,old_end_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class,new_ely,old_administrative_class,old_discontinuity,old_ely,reversed,roadway_change_id, new_road_maintainer, old_road_maintainer) VALUEs ('1000351','3','22006','22006','12','56','0','0','177','80','215','118','5','1','2','1','5','2','1','1000759','EVK3','EVK3')""")
 ...
 test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
   ...
   runWithRollback {
     ...
     val createSuccessLeft  = projectService.createProjectLinks(rl1.map(_.linkId), project.id, RoadPart(9999, 1), Track.LeftSide,  Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 0, ArealRoadMaintainer.getEVK(0), project.createdBy, "9999_1")
     when(mockRoadLinkService.getRoadLinksByLinkIds(any[Set[String]])).thenReturn(rl2)
     val createSuccessRight = projectService.createProjectLinks(rl2.map(_.linkId), project.id, RoadPart(9999, 1), Track.RightSide, Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 0, ArealRoadMaintainer.getEVK(0), project.createdBy, "9999_1")
 ...
 test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
   ...
   runWithRollback {
     ...
     when(mockRoadLinkService.getRoadLinksHistoryFromVVH(any[Set[String]])).thenReturn(Seq())
     when(mockRoadLinkService.getRoadLinksByLinkIds(any[Set[String]])).thenReturn(rl1)
     val createSuccessLeft  = projectService.createProjectLinks(rl1.map(_.linkId), project.id, RoadPart(9999, newRoadPartNumber), Track.LeftSide,  Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 0, ArealRoadMaintainer.getEVK(0), project.createdBy, "9999_1")
     when(mockRoadLinkService.getRoadLinksByLinkIds(any[Set[String]])).thenReturn(rl2)
     val createSuccessRight = projectService.createProjectLinks(rl2.map(_.linkId), project.id, RoadPart(9999, newRoadPartNumber), Track.RightSide, Discontinuity.EndOfRoad, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, 0, ArealRoadMaintainer.getEVK(0), project.createdBy, "9999_1")
 ...
 test("Test defaultSectionCalculatorStrategy.updateRoadwaysAndLinearLocationsWithProjectLinks() " +
   ...
   runWithRollback {
     ...
     runUpdateToDb(sql"""INSERT INTO roadway (id, roadway_number, road_number, road_part_number, track, start_addr_m, end_addr_m, reversed, discontinuity, start_date, end_date, created_by, created_time, administrative_class, ely, terminated, valid_from, valid_to, road_maintainer) VALUES(107964, 335560416, 46020, 1, 0, 0, 785, 0, 1, '2022-01-01', NULL, $user, '2022-02-17 09:48:15.355', 2, 3, 0, '2022-02-17 09:48:15.355', NULL, 'EVK1')""")
   ...
   runWithRollback {
     ...
     runUpdateToDb(sql"""INSERT INTO project VALUES($project_id, 11, 'test project', $user, TIMESTAMP '2018-03-23 11:36:15.000000', '-', TIMESTAMP '2018-03-23 12:26:33.000000', NULL, TIMESTAMP '2018-03-23 00:00:00.000000', NULL, 564987.0, 6769633.0, 12)""")
     runUpdateToDb(sql"""INSERT INTO project_reserved_road_part VALUES (${Sequences.nextViitePrimaryKeySeqValue}, 46020, 1, $project_id, '-')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id, roadway_number, road_number, road_part_number, track, start_addr_m, end_addr_m, reversed, discontinuity, start_date, end_date, created_by, created_time, administrative_class, ely, terminated, valid_from, valid_to, road_maintainer) VALUES(107964, 335560416, 46020, 1, 0, 0, 369, 0, 4, '2022-01-01', NULL, $user, '2022-02-17 09:48:15.355', 2, 3, 0, '2022-02-17 09:48:15.355', NULL, 'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO roadway (id, roadway_number, road_number, road_part_number, track, start_addr_m, end_addr_m, reversed, discontinuity, start_date, end_date, created_by, created_time, administrative_class, ely, terminated, valid_from, valid_to, road_maintainer) VALUES(1111, 335560417, 46020, 1, 0, 369, 624, 0, 1, '2022-01-01', NULL, $user, '2022-02-17 09:48:15.355', 2, 3, 0, '2022-02-17 09:48:15.355', NULL, 'EVK1')""")
     runUpdateToDb(sql"""INSERT INTO link (id, "source", adjusted_timestamp, created_time) VALUES(2621644, 4, 1634598047000, '2022-02-17 09:48:15.355'),(2621698, 4, 1533863903000, '2022-02-17 09:48:15.355'),(2621642, 4, 1634598047000, '2022-02-17 09:48:15.355'),(2621640, 4, 1634598047000, '2022-02-17 09:48:15.355'),(2621632, 4, 1634598047000, '2022-02-17 09:48:15.355'),(2621636, 4, 1533863903000, '2022-02-17 09:48:15.355'),(2621288, 4, 1533863903000, '2022-02-17 09:48:15.355'),(2621287, 4, 1533863903000, '2022-02-17 09:48:15.355')""")
 ...
 test("Test projectService.recalculateProjectLinks() and the way roadway numbers are handled in the process") {
   ...
   runWithRollback {
     ...
     roadwayDAO.create(Seq(
       Roadway(originalRoadwayId, originalRoadwayNumber, roadPart, AdministrativeClass.State, Track.Combined, Discontinuity.EndOfRoad, AddrMRange(0, 700), reversedBoolean, DateTime.now(),None,"Test", Some("Test"), elyNumber, ArealRoadMaintainer.getEVK(3), TerminationCode.NoTermination, DateTime.now(),None)
     ))
 ...
 test("Test projectService.recalculateProjectLinks() Real life project on road part 110/1, recalculation should complete successfully") {
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       Roadway(65784,90509805,roadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,AddrMRange(1800, 3940),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(65512,90509888,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(3940, 4960),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(65618,90510413,roadPart,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(3940, 4960),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75083,148600148,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity,AddrMRange(0, 1800),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75344,148694049,roadPart,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.MinorDiscontinuity,AddrMRange(0, 1800),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
 ...
 test("Test projectService.recalculateProjectLinks() When terminating part of two track section and part of one track section. " +
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       ...
       Roadway(6187,44928,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(615, 1135),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(7297,46088,roadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,AddrMRange(1365, 2510),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(7584,46089,roadPart,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(2510, 5638),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(70651,148121546,roadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,AddrMRange(0, 615),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(73189,148122112,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity,AddrMRange(1135, 1148),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(73470,148127435,roadPart,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(615, 1135),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(73064,148127875,roadPart,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.MinorDiscontinuity,AddrMRange(1135, 1148),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(83706,260730736,roadPart,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(1148, 1365),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(83762,260730742,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity,AddrMRange(1148, 1365),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
 ...
 test("Test projectService.recalculateProjectLinks() Real life project on road parts 4/218, 4/219 and 11960/1, recalculation should complete successfully") {
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       Roadway(7609,45461,roadPart1,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(0, 6104),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(7691,45462,roadPart2,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(0, 5624),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(7506,45463,roadPart2,AdministrativeClass.State,Track.Combined,Discontinuity.ChangingEVKCode,AddrMRange(5624, 6565),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
 ...
 test("Test recalculateProjectLinks() When creating roundabout from New and Transfer links then roadway numbers should be assigned correctly. (three different roadways for the roundabout in this case)") {
   ...
   runWithRollback{
     ...
     val roadways = Seq(
       Roadway(79881,190813844,roadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,AddrMRange(739, 957),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(79679,190813846,roadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.EndOfRoad,AddrMRange(1371, 2025),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(79381,190813848,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(957, 1371),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(78993,190813849,roadPart,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(957, 1371),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(88915,306319328,roadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.MinorDiscontinuity,AddrMRange(0, 739),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
 ...
 test("Test projectService.recalculateProjectLinks() When creating two track road from single track road" +
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       Roadway(19743,54807,roadPart1,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(0, 6008),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(19619,54808,roadPart2,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(0, 2459),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(19180,54809,roadPart2,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(2459, 7292),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
 ...
 private def addProjectLinksToProject(roadAddressChangeType: RoadAddressChangeType, addrM: Seq[Long], changeTrack: Boolean = false, roadPart: RoadPart = RoadPart(19999, 1),
  ...
  test("Test recalculateProjectLinks() When terminating last project links from two track section (that are of different lengths), creating a minor discontinuity on both tracks, then the tracks should be adjusted to match at the discontinuous part.") {
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       Roadway(82725,225079136,RoadPart(49529,1),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(0, 696),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(82872,225079139,RoadPart(49529,1),AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(0, 696),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(82220,225079142,RoadPart(49529,1),AdministrativeClass.Municipality,Track.Combined,Discontinuity.EndOfRoad,AddrMRange(696, 1042),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
  ...
  test("Test projectService.recalculateProjectLinks() Real life project on road parts 40921/2 and 31329/1, recalculation should complete successfully") {
   ...
   runWithRollback {
     ...
     val roadways = Seq(
       Roadway(59551,43168588,roadPart1,AdministrativeClass.Municipality,Track.Combined,Discontinuity.EndOfRoad,AddrMRange(5621, 5992),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(74878,148600188,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(5209, 5528),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75119,148600207,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(3481, 3915),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75007,148600384,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(3400, 3481),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(74886,148600417,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(3161, 3400),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75256,148600420,roadPart1,AdministrativeClass.Municipality,Track.Combined,Discontinuity.MinorDiscontinuity,AddrMRange(1170, 1494),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(74889,148600423,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(937, 1170),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75025,148600426,roadPart1,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,AddrMRange(695, 937),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(74690,148600429,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(0, 695),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(74803,148694062,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(5209, 5528),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(74576,148694072,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(3481, 3915),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75072,148694086,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(3161, 3400),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75327,148694087,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(937, 1170),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(75100,148694088,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(0, 695),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(76524,168748574,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(3400, 3481),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(79525,190813336,roundaboutRoadPart,AdministrativeClass.Municipality,Track.Combined,Discontinuity.EndOfRoad,AddrMRange(0, 67),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(79295,190960312,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,AddrMRange(5528, 5621),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(79183,190960315,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,AddrMRange(5528, 5621),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(81391,202221121,roadPart1,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,AddrMRange(1494, 3161),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(85053,262360669,roadPart1,AdministrativeClass.Municipality,Track.Combined,Discontinuity.MinorDiscontinuity,AddrMRange(3915, 5209),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
 ...
 test("Test assignAddrMValues() When Terminating a small section on a two track road in the middle of road part Then the terminated sections should be adjusted to match") {
   runWithRollback {
     ...
     val roadways = Seq(
       Roadway(85042,262301768,roadPart1,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.EndOfRoad,AddrMRange(0, 1463),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None),
       Roadway(85415,262301771,roadPart1,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.EndOfRoad,AddrMRange(0, 1463),false,DateTime.now().minusDays(2),None,"test",None,14,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.now().minusDays(2),None)
     )
