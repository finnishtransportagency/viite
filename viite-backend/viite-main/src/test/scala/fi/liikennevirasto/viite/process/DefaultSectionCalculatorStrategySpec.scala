...
class DefaultSectionCalculatorStrategySpec extends FunSuite with Matchers {
  ...
  def setUpSideCodeDeterminationTestData(): Seq[ProjectLink] = {
    ...
    val projectLink1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 1L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, 0, reversed = false, None, 86400L)
    ...
    val projectLink3 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 3L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, 0, reversed = false, None, 86400L)
    val projectLink4 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 4L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom4, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom4), 0L, 0, 0, reversed = false, None, 86400L)
    val projectLink5 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 5L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom5, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom5), 0L, 0, 0, reversed = false, None, 86400L)
    val projectLink6 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 6L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom6, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom6), 0L, 0, 0, reversed = false, None, 86400L)
    val projectLink7 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 7L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom7, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom7), 0L, 0, 0, reversed = false, None, 86400L)
    val projectLink8 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 8L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geom8, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom8), 0L, 0, 0, reversed = false, None, 86400L)
    ...
    */
    ...
    test("Test defaultSectionCalculatorStrategy.assignMValues() " +
      ...
      */
      runWithRollback {
        val roadNumber          = 110
        val roadPartNumber      = 22
        val createdBy           = "Test"
        val roadName            = None
        val projectId           = Sequences.nextViiteProjectId
        val tranferredRoad      = 22618
        val transferredRoadPart = 995
        val linearLocationId    = Sequences.nextLinearLocationId
        val roadwayId           = Sequences.nextRoadwayId

        val projectLinks = Seq(
          ProjectLink(Sequences.nextProjectLinkId,roadNumber,roadPartNumber,Track.RightSide,Discontinuity.Continuous,   0,  136,   0,  136,None,None,Some(createdBy),"ad920f09-0ed4-4eb2-86da-5ae8d8f10ec0:1",0.0,135.756,SideCode.AgainstDigitizing,(NoCP,           NoCP           ),(RoadAddressCP,  RoadAddressCP  ),List(Point(308364.0,6698821.0,0.0), Point(308365.0,6698832.0,0.0), Point(308480.0,6698861.0,0.0)),                               projectId,RoadAddressChangeType.Transfer, AdministrativeClass.State,FrozenLinkInterface,124.109,roadwayId+3,linearLocationId,  2,false,None,1590620411000L,332392368L,roadName,None,None,None,None,None,None),
          ProjectLink(Sequences.nextProjectLinkId,roadNumber,roadPartNumber,Track.Combined, Discontinuity.Continuous,   0,  907,   0,  907,None,None,Some(createdBy),"f324e593-1bbc-4d3c-8729-1adc527354bf:1",0.0,905.016,SideCode.AgainstDigitizing,(RoadAddressCP,  JunctionPointCP),(RoadAddressCP,  JunctionPointCP),List(Point(308480.0,6698861.0,0.0), Point(308685.0,6698911.0,0.0), Point(309040.0,6698965.0,0.0), Point(309371.0,6699012.0,0.0)),projectId,RoadAddressChangeType.Unchanged,AdministrativeClass.State,FrozenLinkInterface,334.521,roadwayId,  linearLocationId+1,2,false,None,1590620411000L,  7484795L,roadName,None,None,None,None,None,None),
          ProjectLink(Sequences.nextProjectLinkId,roadNumber,roadPartNumber,Track.LeftSide, Discontinuity.Continuous, 907, 1030, 907, 1030,None,None,Some(createdBy),"e168f5ec-0fe5-4520-8d8d-76d33a6972b9:1",0.0,122.719,SideCode.AgainstDigitizing,(JunctionPointCP,JunctionPointCP),(JunctionPointCP,JunctionPointCP),List(Point(308364.0,6698821.0,0.0), Point(308480.0,6698861.0,0.0)),                                                              projectId,RoadAddressChangeType.Transfer, AdministrativeClass.State,FrozenLinkInterface,122.719,roadwayId+1,linearLocationId+2,2,false,None,1590620411000L,  7484796L,roadName,None,None,None,None,None,None),
          ProjectLink(Sequences.nextProjectLinkId,roadNumber,roadPartNumber,Track.Combined, Discontinuity.Continuous,1030,12995,1030,12995,None,None,Some(createdBy),"86f1e841-366d-423e-84a3-cf7703a656ae:1",0.0,11942.217999999999,SideCode.AgainstDigitizing,(JunctionPointCP,NoCP),(JunctionPointCP,RoadAddressCP  ),List(Point(296779.0,6698725.0,0.0), Point(308364.0,6698821.0,0.0)),                                                              projectId,RoadAddressChangeType.Transfer, AdministrativeClass.State,FrozenLinkInterface,318.95 ,roadwayId+2,linearLocationId+3,2,false,None,1590620411000L,  7484797L,roadName,None,None,None,None,None,None)
        )

        val roadways = Seq(
          Roadway(roadwayId,7484795,roadNumber,roadPartNumber,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,0,907,false,DateTime.parse("2008-11-15T00:00:00.000+02:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2017-05-08T00:00:00.000+03:00"),None),
          Roadway(roadwayId+1,7484795,roadNumber,roadPartNumber,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,907,1030,false,DateTime.parse("2008-11-15T00:00:00.000+02:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2017-05-08T00:00:00.000+03:00"),None),
          Roadway(roadwayId+2,7484795,roadNumber,roadPartNumber,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,1030,12995,false,DateTime.parse("2008-11-15T00:00:00.000+02:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2017-05-08T00:00:00.000+03:00"),None),
          Roadway(roadwayId+3,332392368L,tranferredRoad,transferredRoadPart,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,0,136,false,DateTime.parse("2021-09-01T00:00:00.000+03:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2021-10-06T00:00:00.000+03:00"),None)
        )
        ...
        projectDAO.create(Project(projectId, ProjectState.Incomplete, "f", createdBy, DateTime.now(), "", DateTime.now(), DateTime.now(),"", Seq(), Seq(), None, None))
        projectReservedPartDAO.reserveRoadPart(projectId, roadNumber, roadPartNumber, createdBy)
        projectReservedPartDAO.reserveRoadPart(projectId, tranferredRoad, transferredRoadPart, createdBy)
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() and findStartingPoints When there is MinorDiscontinuity + Continuous + EndOfRoad from east to west intention " +
    ...
    test("Test defaultSectionCalculatorStrategy.assignMValues() " +
      ...
      val roadways = Seq(
        Roadway(70627,148122025,roadNumber,roadPartNumber,AdministrativeClass.Municipality,Track.Combined,Discontinuity.Continuous,0,870,reversed = false,DateTime.parse("1989-01-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(67591,126326211,roadNumber,roadPartNumber,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,870,1312,reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(73459,148127804,roadNumber,roadPartNumber,AdministrativeClass.Municipality,Track.LeftSide,Discontinuity.Continuous,870,1312,reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(67741,126326240,roadNumber,roadPartNumber,AdministrativeClass.State,Track.RightSide,Discontinuity.Continuous,1312,1583,reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(67703,126326358,roadNumber,roadPartNumber,AdministrativeClass.State,Track.LeftSide,Discontinuity.Continuous,1312,1583,reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(67649,126326474,roadNumber,roadPartNumber,AdministrativeClass.State,Track.RightSide,Discontinuity.Continuous,1583,2046,reversed = false,DateTime.parse("2002-10-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(67670,126326660,roadNumber,roadPartNumber,AdministrativeClass.State,Track.LeftSide,Discontinuity.Continuous,1583,2046,reversed = false,DateTime.parse("2002-10-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(72801,148125286,roadNumber,roadPartNumber,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,2046,2664,reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(72751,148125011,roadNumber,roadPartNumber,AdministrativeClass.State,Track.RightSide,Discontinuity.Continuous,2664,3073,reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(73006,148127940,roadNumber,roadPartNumber,AdministrativeClass.State,Track.LeftSide,Discontinuity.Continuous,2664,3073,reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73573,148124389,roadNumber,roadPartNumber,AdministrativeClass.State,Track.Combined,Discontinuity.Discontinuous,3073,4271,reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None)
      )
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() and findStartingPoints When using 4 geometries that end up in a point " +
    ...
    runWithRollback {
      ...
      val projectLinkRight1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomRight1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomRight1), 0L, 0, 0, reversed = false, None, 86400L)
      ...
      val additionalProjectLinkRight1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12350L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), additionalGeomRight1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(additionalGeomRight1), 0L, 0, 0, reversed = false, None, 86400L)
      ...
      val additionalProjectLinkRightBefore = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12352L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), additionalGeomRightBefore, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(additionalGeomRightBefore), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() " +
    ...
    runWithRollback {
      ...
      val projectLinkRight1 = ProjectLink(projectLinkId + 2, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,    0L,  5L, 0L,  5L, None, None, Some("user"), 12347L.toString, 0.0,  5.0, SideCode.Unknown, (RoadAddressCP, NoCP), (NoCP, NoCP), geomRight1, projId, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomRight1), roadwayId,     linearLocationId, 0,     reversed = false, None, 86400L, roadwayNumber = 12346L)
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() When using 2 tracks with proper pairing administrative class sections Then they will calculate values properly") {
    runWithRollback {
      ...
      val projectLinkRight1 = ProjectLink(projectLinkId + 2, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,    0L,  5L, 0L,  5L, None, None, Some("user"), 12347L.toString, 0.0,  5.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomRight1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomRight1), roadwayId, linearLocationId,   0, reversed = false, None, 86400L, roadwayNumber = roadwaynumber)
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() " +
    ...
    runWithRollback {
      ...
      val projectLinkRight2 = ProjectLink(projectLinkId + 1, 9999L, 1L, Track.RightSide, Discontinuity.Continuous, 0L,   0L, 0L,   0L, None, None, Some("user"), 12346L.toString, 0.0,  92.849, SideCode.Unknown, (NoCP, NoCP),          (NoCP, NoCP), geomLeft2, projId, RoadAddressChangeType.New,       AdministrativeClass.State,         LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomLeft2), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test defaultSectionCalculatorStrategy.assignMValues() " +
    ...
    runWithRollback {
      ...
      */
      ...
      val projectLinks = Seq(
        ProjectLink(1000,roadNumber,roadPartNumber,Track.RightSide,Discontinuity.Continuous,           0,1550,   0,1550,None,None,Some(createdBy),452570.toString, 0.0,  geomRight1length,SideCode.TowardsDigitizing,(RoadAddressCP,  JunctionPointCP),(RoadAddressCP,  JunctionPointCP),geomRight1,                                                        project_id,RoadAddressChangeType.Unchanged,AdministrativeClass.Municipality,FrozenLinkInterface,geomRight1length,  761,  4558,1,false,None,1629932416000L,    38259,roadName,None,None,None,None,None,None),
        ProjectLink(1037,roadNumber,roadPartNumber,Track.RightSide,Discontinuity.Continuous,        1550,1717,1550,1717,None,None,Some(createdBy),451986.toString, 0.0,           170.075,SideCode.TowardsDigitizing,(NoCP,           JunctionPointCP),(NoCP,           JunctionPointCP),List(Point(382891.0,6675103.0,0.0), Point(382737.0,6675175.0,0.0)),project_id,RoadAddressChangeType.Unchanged,AdministrativeClass.Municipality,FrozenLinkInterface,         170.075,  761,  4576,1,false,None,1629932416000L,    38259,roadName,None,None,None,None,None,None),
        ProjectLink(1040,roadNumber,roadPartNumber,Track.RightSide,Discontinuity.MinorDiscontinuity,1717,1742,1717,1742,None,None,Some(createdBy),452008.toString, 0.0,            24.988,SideCode.TowardsDigitizing,(JunctionPointCP,RoadAddressCP  ),(JunctionPointCP,RoadAddressCP  ),List(Point(382737.0,6675175.0,0.0), Point(382714.0,6675186.0,0.0)),project_id,RoadAddressChangeType.Unchanged,AdministrativeClass.Municipality,FrozenLinkInterface,          24.988,  761,  4577,1,false,None,1629932416000L,    38259,roadName,None,None,None,None,None,None),
        ...
        ProjectLink(1039,roadNumber,roadPartNumber,Track.LeftSide,Discontinuity.Continuous,         1726,1742,1726,1742,None,None,Some(createdBy),452014.toString, 0.0,            16.468,SideCode.TowardsDigitizing,(JunctionPointCP,NoCP           ),(JunctionPointCP,NoCP           ),List(Point(382728.0,6675158.0,0.0), Point(382713.0,6675164.0,0.0)),project_id,RoadAddressChangeType.Unchanged,AdministrativeClass.Municipality,FrozenLinkInterface,          16.468,  715,  4308,1,false,None,1629932416000L,    38260,roadName,None,None,None,None,None,None),
        ProjectLink(1041,roadNumber,roadPartNumber,Track.LeftSide,Discontinuity.Continuous,         1742,1752,1742,1752,None,None,Some(createdBy),452014.toString,16.468,          26.761,SideCode.TowardsDigitizing,(NoCP,           JunctionPointCP),(NoCP,           JunctionPointCP),List(Point(382713.0,6675164.0,0.0), Point(382704.0,6675168.0,0.0)),project_id,RoadAddressChangeType.Unchanged,AdministrativeClass.Municipality,FrozenLinkInterface,          10.293,80486,458576,1,false,None,1629932416000L,202219282,roadName,None,None,None,None,None,None),
        ProjectLink(1043,roadNumber,roadPartNumber,Track.LeftSide,Discontinuity.Continuous,         1752,1773,1752,1773,None,None,Some(createdBy),451992.toString, 0.0,            21.002,SideCode.TowardsDigitizing,(JunctionPointCP,JunctionPointCP),(JunctionPointCP,JunctionPointCP),List(Point(382704.0,6675168.0,0.0), Point(382714.0,6675186.0,0.0)),project_id,RoadAddressChangeType.Unchanged,AdministrativeClass.Municipality,FrozenLinkInterface,          21.002,80486,458577,1,false,None,1629932416000L,202219282,roadName,None,None,None,None,None,None),
  ...
  test("Test findStartingPoints When transfering some links from one two track road to the beginning of another two track road that is not been handled yet Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val Road1TransferLeftLink       = ProjectLink(plId + 1, 9999L, 1L, Track.LeftSide,  Discontinuity.Continuous,   0L,  10L, 890L, 900L, None, None, None, 12345L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomRoad1TransferLeft,       0L, RoadAddressChangeType.Transfer,   AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomRoad1TransferLeft),       0L, 0, 0, reversed = false, None, 86400L)
      val Road1TransferRightLink      = ProjectLink(plId + 2, 9999L, 1L, Track.RightSide, Discontinuity.Continuous, 890L, 900L, 890L, 900L, None, None, None, 12346L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomRoad1TransferRight,      0L, RoadAddressChangeType.Transfer,   AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomRoad1TransferRight),      0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints " +
    ...
    runWithRollback {
      ...
      val otherProjectLinks = Seq(
        ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous,    0L, 0L, 0L, 0L, None, None, None, 12345L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous,    0L, 0L, 0L, 0L, None, None, None, 12346L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous,    0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, 0, reversed = true, None, 86400L),
        ...
        ProjectLink(plId + 4, 9999L, 1L, Track.Combined, Discontinuity.Continuous,    0L, 0L, 0L, 0L, None, None, None, 12349L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom5, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom5), 0L, 0, 0, reversed = true, None, 86400L),
  ...
  test("Test findStartingPoints When adding one (New) link before the existing (Transfer) road Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val projectLink1 = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous,  0L, 15L, 15L, 30L, None, None, None, 12345L.toString, 0.0, 15.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransfer1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransfer1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLink2 = ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 15L, 30L, 30L, 45L, None, None, None, 12346L.toString, 0.0, 15.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransfer2, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransfer2), 0L, 0, 0, reversed = false, None, 86400L)

      val geomNew3 = Seq(Point(40.0, 10.0), Point(30.0, 20.0))

      val projectLinkNew3 = ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  private def testFindStartingPointsWithOneMinorDiscontinuity(sideCode: SideCode, roadAddressChangeType: RoadAddressChangeType): Unit = {
    runWithRollback {
      ...
      val projectLink1 = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 15L, 0L, 15L, None, None, None, 12345L.toString, 0.0, 15.0, sideCode, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, roadAddressChangeType, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, 0, reversed = false, None, 86400L)
      ...
      val projectLinkNew2 = ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  private def testFindStartingPointsWithTwoMinorDiscontinuitiesNewInMiddle(sideCode: SideCode, roadAddressChangeType: RoadAddressChangeType): Unit = {
    runWithRollback {
      ...
      // Notice that discontinuity value should not affect calculations, which are based on geometry. That's why we have here this value "Continuous".
      val projectLinkNew2 = ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew3 = ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  private def testFindStartingPointsWithTwoMinorDiscontinuitiesNewInMiddleTwoTrackOnOtherSide(sideCode: SideCode, roadAddressChangeType: RoadAddressChangeType): Unit = {
    runWithRollback {
      ...
      // Notice that discontinuity value should not affect calculations, which are based on geometry. That's why we have here this value "Continuous".
      val projectLinkNew2 = ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12346L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding two track road (New) with minor discontinuity before the existing (Transfer) road Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val projectLink1 = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 15L, 0L, 15L, None, None, None, 12345L.toString, 0.0, 15.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransfer1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransfer1), 0L, 0, 0, reversed = false, None, 86400L)

      val geomNew2 = Seq(Point(35.0, 0.0), Point(25.0, 10.0))
      val geomNew3 = Seq(Point(25.0, 0.0), Point(15.0, 10.0))

      val projectLinkNew2 = ProjectLink(plId + 2, 9999L, 1L, Track.RightSide, Discontinuity.MinorDiscontinuity, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew3 = ProjectLink(plId + 3, 9999L, 1L, Track.LeftSide,  Discontinuity.MinorDiscontinuity, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When creating New Left track link which have its geometry reversed and Transfer Combined to RightSide before existing NotHandled link road Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val projectLinkTransfer = ProjectLink(plId + 2, 9999L, 1L, Track.RightSide, Discontinuity.Continuous,  0L, 10L,  0L, 10L, None, None, None, 12347L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight, 0L, RoadAddressChangeType.Transfer,   AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew      = ProjectLink(plId + 3, 9999L, 1L, Track.LeftSide,  Discontinuity.Continuous,  0L,  0L,  0L,  0L, None, None, None, 12347L.toString, 0.0, 10.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomNewLeft,       0L, RoadAddressChangeType.New,        AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNewLeft),       0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding two (New) links before and after existing transfer links(s) Then the road should maintain the previous direction") {
    runWithRollback {
      ...
      val projectLinkComb1 = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 15L, 30L, 15L, 30L, None, None, None, 12345L.toString, 0.0, 15.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferComb1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferComb1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkComb2 = ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 30L, 45L, 30L, 45L, None, None, None, 12346L.toString, 0.0, 15.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferComb2, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferComb2), 0L, 0, 0, reversed = false, None, 86400L)

      val geomNewCombBefore = Seq(Point(50.0, 20.0), Point(40.0, 30.0))
      val geomNewCombAfter = Seq(Point(10.0, 60.0), Point(20.0, 60.0))

      val projectLinkCombNewBefore = ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNewCombBefore, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNewCombBefore), 0L, 0, 0, reversed = false, None, 86400L)
...
//      //Right New
//      val projectLinkRight1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,         0L,  0L, 0L,  0L, None, None, None, 12347L, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNewRight1,     projectId, RoadAddressChangeType.New,      AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNewRight1), 0, 0, 8L, reversed = false, None, 86400L)
...
//      //Right Transfer
//      val projectLinkRight3 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 0L,  5L,  0L,  5L, None, None, None, 12352L, 0.0,  5.1, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight3, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight3), roadwayId + 2, linearLocationId + 2, 8L, reversed = false, None, 86400L, roadwayNumber = Sequences.nextRoadwayNumber)
//      val nextRwNumber = Sequences.nextRoadwayNumber
//      val projectLinkRight4 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 5L, 10L,  5L, 10L, None, None, None, 12352L, 0.0,  5.1, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight4, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight4), roadwayId + 3, linearLocationId + 3, 8L, reversed = false, None, 86400L, roadwayNumber = nextRwNumber)
//      val projectLinkRight5 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 0L, 15L, 10L, 15L, None, None, None, 12353L, 0.0, 15.2, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight5, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight5), roadwayId + 4, linearLocationId + 4, 8L, reversed = false, None, 86400L, roadwayNumber = nextRwNumber)
//
...
//
//      //  Right: Before Roundabout (New)
//      val projectLinkRight1 = ProjectLink(Sequences.nextProjectLinkId, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,         0L,  5L, 0L, 0L, None, None, None, 12347L, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNewRight1, projectId, RoadAddressChangeType.New,    AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNewRight1), 0, 0, 8L, reversed = false, None, 86400L)
...
//      //  Right: After roundabout (Transfer)
//      val projectLinkRight3 = ProjectLink(Sequences.nextProjectLinkId, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 10L, 15L, 0L, 5L, None, None, None, 12352L, 0.0, 5.1, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight3, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight3), roadwayId + 2, linearLocationId + 2, 8L, reversed = false, None, 86400L, roadwayNumber = Sequences.nextRoadwayNumber)
//
//      //  Create after Transfer Data
//      val (linearRight3, rwRight3): (LinearLocation, Roadway) = Seq(projectLinkRight3).map(toRoadwayAndLinearLocation).head
//      val rw3WithId = rwRight3.copy(id = roadwayId+2, ely = 8L)
...
Left     |  ^   Right
      ...
      */
      ...
      //Combined Transfer
      val projectLinkCombined1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous,     0L,  5L,  0L,  5L, None, None, None, 12345L, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferCombined1, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferCombined1), roadwayId1, linearLocationId1, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber1)
      val projectLinkCombined2 = ProjectLink(-1000L, 9999L, 1L, Track.apply(0), Discontinuity.Continuous,     5L, 10L,  5L, 10L, None, None, None, 12346L, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferCombined2, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferCombined2), roadwayId2, linearLocationId2, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber2)
      ...
      //Right Transfer
      val projectLinkRight1    = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,    10L, 23L, 10L, 23L, None, None, None, 12346L, 5.0, 18.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight1,   projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight1),    roadwayId2, linearLocationId3, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber2)
...
Left     ^  ^   Right
  ...
  /*test("Test defaultSectionCalculatorStrategy.assignMValues() and the attribution of roadway_numbers for new Left Right sections with diff number of links Then " +
    ...
    runWithRollback {
      ...
      //  Right Transfer
      val projectLinkRight1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,    10L, 23L, 10L, 23L, None, None, None, 12346L, 5.0, 18.0,  SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight1,    projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight1), roadwayId2, linearLocationId3, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber2)
      val projectLinkRight2 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,    23L, 24L, 23L, 24L, None, None, None, 12349L, 0.0,  1.0,  SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight2,    projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight2), roadwayId3, linearLocationId4, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber3)
  ...
  /*test("Test defaultSectionCalculatorStrategy.assignMValues() and the attribution of roadway_numbers for new Left Right sections with diff number of links Then " +
    ...
    runWithRollback {
      ...
      //  Right Transfer
      val projectLinkRight1 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous,  5L, 10L,  5L, 10L, None, None, None, 12346L, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight1, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight1), roadwayId1, linearLocationId2, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber1)
      val projectLinkRight2 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 10L, 13L, 10L, 13L, None, None, None, 12347L, 3.0, 6.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight2, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight2), roadwayId1, linearLocationId3, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber1)
      val projectLinkRight3 = ProjectLink(-1000L, 9999L, 1L, Track.apply(1), Discontinuity.Continuous, 13L, 16L, 13L, 16L, None, None, None, 12347L, 0.0, 3.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferRight3, projectId, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferRight3), roadwayId2, linearLocationId4, 8L, reversed = false, None, 86400L, roadwayNumber = roadwayNumber2)
  ...
  test("Test findStartingPoints When adding two new left and right track links before new and existing Combined links Then the starting points for the left and right road should be points of Left and Right Tracks and not one from the completely opposite side (where the existing Combined link is)") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkOtherPartComb1 = ProjectLink(plId + 1, 9999L, 2L, Track.Combined,  Discontinuity.Continuous,          0L,  5L,  0L,  5L, None, None, None, 12344L.toString, 0.0, 5.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), otherPartGeomTransferComb1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(otherPartGeomTransferComb1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkComb1          = ProjectLink(plId + 1, 9999L, 1L, Track.Combined,  Discontinuity.Continuous,          5L, 10L,  5L, 10L, None, None, None, 12345L.toString, 0.0, 5.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferComb1,          0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferComb1),          0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkComb2          = ProjectLink(plId + 2, 9999L, 1L, Track.Combined,  Discontinuity.MinorDiscontinuity, 10L, 15L, 10L, 15L, None, None, None, 12346L.toString, 0.0, 5.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferComb2,          0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferComb2),          0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkCombNewBefore  = ProjectLink(plId + 3, 9999L, 1L, Track.Combined,  Discontinuity.MinorDiscontinuity,  0L,  5L,  0L,  5L, None, None, None, 12347L.toString, 0.0, 5.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNewComb1,               0L, RoadAddressChangeType.New,      AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNewComb1),               0L, 0, 0, reversed = false, None, 86400L)
      ...
      val projectLinkNewRight       = ProjectLink(plId + 5, 9999L, 1L, Track.RightSide, Discontinuity.Continuous,          0L,  0L,  0L,  0L, None, None, None, 12349L.toString, 0.0, 0.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomRight1,                 0L, RoadAddressChangeType.New,      AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomRight1),                 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding new combined link before existing Unhandled links Then the starting point should be the loose candidate from the new link") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkNewComb1Before = ProjectLink(plId,     9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0,   0,   0,  None, None, None, 12344L.toString, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNewComb1,      0L, RoadAddressChangeType.New,        AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNewComb1),      0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkComb1          = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 5L,  0L,  5L, None, None, None, 12345L.toString, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferComb1, 0L, RoadAddressChangeType.NotHandled, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferComb1), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test defaultSectionCalculatorStrategy.findStartingPoint() When transferring existing first link of part 2 to part 1, that is after that last link of part 1 Then the starting point should be the one from first link of part 1 that is not handled and the direction of part 1 should not change") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkNotHandledComb1Part1      = ProjectLink(plId,     9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L,  5L, 0L,  5L, None, None, None, 12344L.toString, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNotHandledComb1Part1,      0L, RoadAddressChangeType.NotHandled, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNotHandledComb1Part1),      0L, 0L, 0L, reversed = false, None, 86400L)
      val projectLinkNotHandledComb2Part1      = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 5L, 10L, 5L, 10L, None, None, None, 12345L.toString, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNotHandledComb2Part1,      0L, RoadAddressChangeType.NotHandled, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNotHandledComb2Part1),      0L, 0,  0,  reversed = false, None, 86400L)
  ...
  test("Test defaultSectionCalculatorStrategy.findStartingPoint() When transferring last link of part 1 to part 2, that is before the old first part 2 link Then the starting point should be the one from new link of part2 that is being transferred and the direction of both parts should not change") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkTransferNewFirstLinkPart2 = ProjectLink(plId + 1, 9999L, 2L, Track.Combined, Discontinuity.Continuous, 5L, 10L, 5L, 10L, None, None, None, 12345L.toString, 0.0, 5.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomTransferNewFirstLinkPart2, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomTransferNewFirstLinkPart2), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding one (New) link before the existing (New) road that goes against the digitization Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkNew1 = ProjectLink(plId,     9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 10L, 0L, 0L, None, None, None, 12344L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNew1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew2 = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12347L.toString, 0.0,  0.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding two completely (New) links both with end addresses 0, unknown side code and with one of them having inverted geometry grow, Then the direction should not be the one starting in the mid.") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkNew1 = ProjectLink(plId,     9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12344L.toString, 0.0,  9.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew2 = ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L, 0L, 0L, 0L, None, None, None, 12345L.toString, 0.0, 10.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding two track road (New) after the existing (New) road that goes against the digitization Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkNew1 = ProjectLink(plId,     9999L, 1L, Track.Combined,  Discontinuity.Continuous, 0L, 10L, 0L, 0L, None, None, None, 12344L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNew1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew2 = ProjectLink(plId + 1, 9999L, 1L, Track.RightSide, Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12345L.toString, 0.0,  0.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew3 = ProjectLink(plId + 2, 9999L, 1L, Track.LeftSide,  Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12346L.toString, 0.0,  0.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomNew3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test findStartingPoints When adding left side of two track road (New) before the existing (New) road Then the road should still maintain the previous existing direction") {
    runWithRollback {
      ...
      val plId = Sequences.nextProjectLinkId
      val projectLinkNew1 = ProjectLink(plId,     9999L, 1L, Track.Combined,  Discontinuity.Continuous, 0L, 10L, 0L, 0L, None, None, None, 12344L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geomNew1, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew2 = ProjectLink(plId + 1, 9999L, 1L, Track.LeftSide,  Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12345L.toString, 0.0,  0.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew3 = ProjectLink(plId + 2, 9999L, 1L, Track.RightSide, Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12346L.toString, 0.0,  0.0, SideCode.Unknown,           (NoCP, NoCP), (NoCP, NoCP), geomNew3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  private def testNewExistingNew(statusOfExisting: RoadAddressChangeType, sideCode: SideCode): Unit = {
    runWithRollback {
      ...
      val projectLinkNew2 = ProjectLink(2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12345L.toString, 0.0,  0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew2, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLinkNew3 = ProjectLink(3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 0L,  0L, 0L, 0L, None, None, None, 12346L.toString, 0.0,  0.0, SideCode.Unknown, (NoCP, NoCP), (NoCP, NoCP), geomNew3, 0L, RoadAddressChangeType.New, AdministrativeClass.State, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geomNew3), 0L, 0, 0, reversed = false, None, 86400L)
