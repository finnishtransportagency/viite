...
class DefaultSectionCalculatorStrategySpec extends FunSuite with Matchers {
  ...
  test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
      ...
      */
      runWithRollback {
        ...
        val roadways = Seq(
          Roadway(roadwayId,  7484795,   roadPart,        AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,   AddrMRange(   0,  907),false,DateTime.parse("2008-11-15T00:00:00.000+02:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2017-05-08T00:00:00.000+03:00"),None),
          Roadway(roadwayId+1,7484795,   roadPart,        AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,   AddrMRange( 907, 1030),false,DateTime.parse("2008-11-15T00:00:00.000+02:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2017-05-08T00:00:00.000+03:00"),None),
          Roadway(roadwayId+2,7484795,   roadPart,        AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,   AddrMRange(1030,12995),false,DateTime.parse("2008-11-15T00:00:00.000+02:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2017-05-08T00:00:00.000+03:00"),None),
          Roadway(roadwayId+3,332392368L,transferredRoadPart,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(   0,  136),false,DateTime.parse("2021-09-01T00:00:00.000+03:00"),None,"import",roadName,2,TerminationCode.NoTermination,DateTime.parse("2021-10-06T00:00:00.000+03:00"),None)
        )
  ...
  test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
      ...
      val roadways = Seq(
        Roadway(70627,148122025,roadPart,AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,   AddrMRange(   0, 870),reversed = false,DateTime.parse("1989-01-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(67591,126326211,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,   AddrMRange( 870,1312),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(73459,148127804,roadPart,AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,   AddrMRange( 870,1312),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(67741,126326240,roadPart,AdministrativeClass.State,       Track.RightSide,Discontinuity.Continuous,   AddrMRange(1312,1583),reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(67703,126326358,roadPart,AdministrativeClass.State,       Track.LeftSide, Discontinuity.Continuous,   AddrMRange(1312,1583),reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(67649,126326474,roadPart,AdministrativeClass.State,       Track.RightSide,Discontinuity.Continuous,   AddrMRange(1583,2046),reversed = false,DateTime.parse("2002-10-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(67670,126326660,roadPart,AdministrativeClass.State,       Track.LeftSide, Discontinuity.Continuous,   AddrMRange(1583,2046),reversed = false,DateTime.parse("2002-10-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2015-12-11T00:00:00.000+02:00"),None),
        Roadway(72801,148125286,roadPart,AdministrativeClass.State,       Track.Combined, Discontinuity.Continuous,   AddrMRange(2046,2664),reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(72751,148125011,roadPart,AdministrativeClass.State,       Track.RightSide,Discontinuity.Continuous,   AddrMRange(2664,3073),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(73006,148127940,roadPart,AdministrativeClass.State,       Track.LeftSide, Discontinuity.Continuous,   AddrMRange(2664,3073),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73573,148124389,roadPart,AdministrativeClass.State,       Track.Combined, Discontinuity.Discontinuous,AddrMRange(3073,4271),reversed = false,DateTime.parse("1974-11-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None)
      )
  ...
  test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
    ...
    runWithRollback {
      ...
      */
      ...
      val roadways = Seq(
        Roadway(  715,    38260,roadPart,AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,        AddrMRange(   0,1742),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,1,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(  761,    38259,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity,AddrMRange(   0,1742),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,1,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(80486,202219282,roadPart,AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Discontinuous,     AddrMRange(1742,2570),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,1,TerminationCode.NoTermination,DateTime.parse("2018-07-11T00:00:00.000+03:00"),None),
        Roadway(80546,202219273,roadPart,AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,        AddrMRange(1742,2570),reversed = false,DateTime.parse("1989-01-01T00:00:00.000+02:00"),None,createdBy,roadName,1,TerminationCode.NoTermination,DateTime.parse("2018-07-04T00:00:00.000+03:00"),None)
      )
  ...
  test("Test defaultSectionCalculatorStrategy.assignAddrMValues() " +
    ...
    runWithRollback {
      ...
      val roadways = Seq(
        Roadway(13006,    49024,RoadPart(3821,2),AdministrativeClass.State,       Track.Combined, Discontinuity.EndOfRoad,          AddrMRange(5708,6826),reversed = false,DateTime.parse("2005-06-30T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2009-12-09T00:00:00.000+02:00"),None),
        Roadway(14278,    50308,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(4457,5188),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(45590,    79184,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity, AddrMRange( 507, 561),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(45508,    79190,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(   0, 507),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(48822,  6651364,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange( 812,1656),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(59859, 43166556,RoadPart(3821,1),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange( 780, 909),reversed = false,DateTime.parse("2011-04-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(59736, 43166504,RoadPart(3821,1),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Discontinuous,      AddrMRange(4665,5430),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(70660,148121696,RoadPart(3821,1),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange( 222, 780),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(70589,148121784,RoadPart(3821,1),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange(3905,4665),reversed = false,DateTime.parse("2011-04-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(72749,148127709,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.MinorDiscontinuity, AddrMRange( 507, 561),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(72754,148127686,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange( 812,1656),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(72949,148125051,RoadPart(3821,2),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange(2190,2790),reversed = false,DateTime.parse("2005-06-30T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(72972,148125617,RoadPart(3821,1),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange( 909,1145),reversed = false,DateTime.parse("2011-04-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(72976,148125309,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(1656,2190),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(72981,148124335,RoadPart(3821,1),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange(   0, 222),reversed = false,DateTime.parse("2011-04-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73040,148125276,RoadPart(3821,1),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(2535,2802),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(72853,148125446,RoadPart(3821,1),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange(1520,2535),reversed = false,DateTime.parse("2011-04-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(74788,148128101,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(1656,2190),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(74641,148127970,RoadPart(3821,1),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(2535,2802),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73562,148125036,RoadPart(3821,1),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange(2802,3550),reversed = false,DateTime.parse("2011-04-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73426,148124341,RoadPart(3821,1),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(3550,3905),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(73430,148124318,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(2790,3020),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(74754,148128092,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(2790,3020),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73177,148127455,RoadPart(3821,1),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Discontinuous,      AddrMRange(4665,5430),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73190,148127472,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.MinorDiscontinuity, AddrMRange(4457,5188),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(73235,148127824,RoadPart(3821,1),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange( 222, 780),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(74536,148128121,RoadPart(3821,1),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(1145,1520),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73303,148122120,RoadPart(3821,2),AdministrativeClass.Municipality,Track.Combined, Discontinuity.Continuous,         AddrMRange(3020,4457),reversed = false,DateTime.parse("2005-06-30T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(75204,148128250,RoadPart(3821,1),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(3550,3905),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(73606,148125555,RoadPart(3821,1),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(1145,1520),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-30T00:00:00.000+03:00"),None),
        Roadway(73607,148127711,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(   0, 507),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2016-03-08T00:00:00.000+02:00"),None),
        Roadway(81119,202230176,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.MinorDiscontinuity, AddrMRange( 561, 812),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(81129,202228103,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity, AddrMRange(5188,5651),reversed = false,DateTime.parse("2018-07-01T00:00:00.000+03:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(80988,202230183,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.MinorDiscontinuity, AddrMRange( 561, 812),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        ...
        Roadway(81365,202230207,RoadPart(3821,2),AdministrativeClass.Municipality,Track.RightSide,Discontinuity.Continuous,         AddrMRange(5651,5708),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None),
        Roadway(80536,202230200,RoadPart(3821,2),AdministrativeClass.Municipality,Track.LeftSide, Discontinuity.Continuous,         AddrMRange(5651,5708),reversed = false,DateTime.parse("2016-03-01T00:00:00.000+02:00"),None,createdBy,roadName,3,TerminationCode.NoTermination,DateTime.parse("2018-07-05T00:00:00.000+03:00"),None)
      )
...
Left     ^  ^   Right
  ...
  test("Test assignAddrMValues() When two track road part has terminated links at the track changing spot and new minor discontinuity on both tracks Then calculation should be able to adjust the tracks to match") {
    ...
    runWithRollback {
      ...
      val roadwayIdCombinedSection = Sequences.nextRoadwayId
      val roadwayIdLeftTrack = Sequences.nextRoadwayId
      val roadwayIdRightTrack = Sequences.nextRoadwayId
      val roadwayNumberCombinedSection = Sequences.nextRoadwayNumber
      val roadwayNumberRightTrackSection = Sequences.nextRoadwayNumber
      val roadwayNumberLeftTrackSection = Sequences.nextRoadwayNumber

      val geom1 = Seq(Point(443695.047, 7376331.256, 85.483)	,Point(443780.5609999993, 7376415.993000319, 81.168))
      val geom2 = Seq(Point(443780.561, 7376415.993, 81.168)	,Point(443786.531, 7376424.055, 80.79901704515324))
      val geom3 = Seq(Point(443786.531, 7376424.055, 80.799)	,Point(443818.744, 7376495.203, 79.9240011690673))
      val geom4 = Seq(Point(443818.744, 7376495.203, 79.924)	,Point(443864.362, 7376599.54, 82.02798840242914))
      val geom5 = Seq(Point(443864.362, 7376599.54, 82.028)	    ,Point(443867.8419999993, 7376607.958000319, 82.31))
      val geom6 = Seq(Point(443867.842, 7376607.958, 82.31)	    ,Point(443871.9669999994, 7376619.22500032, 82.34))
      val geom7 = Seq(Point(443492.259, 7375680.103, 84.052)	,Point(443498.7249999994, 7375709.3810003195, 83.546))
      val geom8 = Seq(Point(443498.725, 7375709.381, 83.546)	,Point(443499.845, 7375718.023, 83.53400051520578))
      val geom9 = Seq(Point(443499.845, 7375718.023, 83.534)	,Point(443500.375, 7375722.637, 83.5739978456284))
      val geom10 = Seq(Point(443500.375, 7375722.637, 83.574)	,Point(443502.579, 7375741.41, 83.81099797428476))
      val geom11 = Seq(Point(443502.579, 7375741.41, 83.811)	    ,Point(443502.2169999994, 7375758.832000319, 83.951))
      val geom12 = Seq(Point(443502.217, 7375758.832, 83.951)	,Point(443500.173, 7375866.363, 84.31100065015279))
      val geom13 = Seq(Point(443500.173, 7375866.363, 84.311)	,Point(443508.949, 7375888.836, 84.18800280157677))
      val geom14 = Seq(Point(443508.949, 7375888.836, 84.188)	,Point(443516.236, 7375900.382, 84.11199870184565))
      val geom15 = Seq(Point(443516.236, 7375900.382, 84.112)	,Point(443522.6979999994, 7375912.652000319, 84.123))
      val geom16 = Seq(Point(443522.698, 7375912.652, 84.123)	,Point(443551.677, 7375974.533, 85.23999766335862))
      val geom17 = Seq(Point(443551.677, 7375974.533, 85.24)	    ,Point(443583.0509999992, 7376038.16700032, 86.563))
      val geom18 = Seq(Point(443583.051, 7376038.167, 86.563)	,Point(443591.4179999993, 7376059.053000319, 86.914))
      val geom19 = Seq(Point(443591.418, 7376059.053, 86.914)	,Point(443594.9009999993, 7376072.020000318, 87.031))
      val geom20 = Seq(Point(443594.901, 7376072.02, 87.031)	    ,Point(443626.4129999993, 7376158.88200032, 86.494))
      val geom21 = Seq(Point(443626.413, 7376158.882, 86.494)	,Point(443630.4639999993, 7376171.269000321, 86.432))
      val geom22 = Seq(Point(443630.464, 7376171.269, 86.432)	,Point(443677.179, 7376292.999, 85.81000004776878))
      val geom23 = Seq(Point(443677.179, 7376292.999, 85.81)	    ,Point(443683.5929999993, 7376311.32600032, 85.751))
      val geom24 = Seq(Point(443683.593, 7376311.326, 0)	        ,Point(443695.047, 7376331.256, 0))
      val geom25 = Seq(Point(443485.148, 7375680.886, 83.991)	,Point(443491.386, 7375709.004, 83.5840001928757))
      val geom26 = Seq(Point(443491.386, 7375709.004, 83.584)	,Point(443492.74, 7375717.669, 83.6149992546376))
      val geom27 = Seq(Point(443492.74, 7375717.669, 83.615)	    ,Point(443493.2359999992, 7375723.16900032, 83.68))
      val geom28 = Seq(Point(443493.236, 7375723.169, 83.68)	    ,Point(443494.175, 7375741.528, 83.84599986040107))
      val geom29 = Seq(Point(443494.175, 7375741.528, 83.846)	,Point(443494.099, 7375758.495, 84.13399334939625))
      val geom30 = Seq(Point(443494.099, 7375758.495, 84.134)	,Point(443492.5799999994, 7375867.982000319, 84.433))
      val geom31 = Seq(Point(443492.58, 7375867.982, 84.433)	    ,Point(443494.906, 7375886.053, 84.24700335742143))
      val geom32 = Seq(Point(443494.906, 7375886.053, 84.247)	,Point(443501.4159999995, 7375897.461000321, 84.106))
      val geom33 = Seq(Point(443501.416, 7375897.461, 84.106)	,Point(443508.565, 7375904.151, 84.05100103825822))
      val geom34 = Seq(Point(443508.565, 7375904.151, 84.051)	,Point(443514.1049999993, 7375910.812000319, 84.028))
      val geom35 = Seq(Point(443514.105, 7375910.812, 84.028)	,Point(443583.486, 7376061.579, 86.96499522732097))
      val geom36 = Seq(Point(443583.486, 7376061.579, 86.965)	,Point(443615.7369999994, 7376162.54300032, 86.499))
      val geom37 = Seq(Point(443615.737, 7376162.543, 86.499)	,Point(443620.4599999994, 7376174.545000319, 86.459))
      val geom38 = Seq(Point(443620.46, 7376174.545, 86.459)	    ,Point(443676.263, 7376314.303, 85.76499785339493))
      val geom39 = Seq(Point(443676.263, 7376314.303, 0)	        ,Point(443695.047, 7376331.256, 0))

      val projectLinks = Seq(
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.Combined,	Discontinuity.Continuous,	AddrMRange(696,	817),	AddrMRange(696,	817),	 None, None, Some("test"), "4c184326-404e-4e3b-b13c-e256a3312aa1:2",	0.000,	120.399,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom1,	projectId,	RoadAddressChangeType.Transfer,	AdministrativeClass.Municipality,	FrozenLinkInterface, 120.399,	roadwayIdCombinedSection,	466778,	14,	reversed = false, None, 1652179948783L,		roadwayNumberCombinedSection,Some("roadName"),None,None,None,None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.Combined,	Discontinuity.Continuous,	AddrMRange(817,	827),	AddrMRange(817,	827),	 None, None, Some("test"), "549ea1bc-02ef-4e66-9240-adaa77471331:2",	0.000,	10.049,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom2,	projectId,	RoadAddressChangeType.Transfer,	AdministrativeClass.Municipality,	FrozenLinkInterface, 10.049,	roadwayIdCombinedSection,	466779,	14,	reversed = false, None, 1652179948783L,		roadwayNumberCombinedSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.Combined,	Discontinuity.Continuous,	AddrMRange(827,	906),	AddrMRange(827,	906),	 None, None, Some("test"), "b3f70ee2-16d3-40cf-a67f-9c78c5ec879f:2",	0.000,	78.104,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom3,	projectId,	RoadAddressChangeType.Transfer,	AdministrativeClass.Municipality,	FrozenLinkInterface, 78.104,	roadwayIdCombinedSection,	466780,	14,	reversed = false, None, 1652179948783L,		roadwayNumberCombinedSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.Combined,	Discontinuity.Continuous,	AddrMRange(906,	1021),	AddrMRange(906,	1021),	 None, None, Some("test"), "bffb8c7d-aac0-4e7c-a115-101e14952a09:2",	0.000,	113.886,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom4,	projectId,	RoadAddressChangeType.Transfer,	AdministrativeClass.Municipality,	FrozenLinkInterface, 113.886,	roadwayIdCombinedSection,	466781,	14,	reversed = false, None, 1652179948783L,		roadwayNumberCombinedSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.Combined,	Discontinuity.Continuous,	AddrMRange(1021,	1030),	AddrMRange(1021,	1030),	 None, None, Some("test"), "3121460f-5d95-43b0-ae1d-88d71ba91ffe:2",	0.000,	9.109,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom5,	projectId,	RoadAddressChangeType.Transfer,	AdministrativeClass.Municipality,	FrozenLinkInterface, 9.109,	roadwayIdCombinedSection,	466782,	14,	reversed = false, None, 1652179948783L,		roadwayNumberCombinedSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.Combined,	Discontinuity.EndOfRoad,	AddrMRange(1030,	1042),	AddrMRange(1030,	1042),	 None, None, Some("test"), "92d3f0ef-db38-476f-b5ff-49b18d74b4aa:2",	0.000,	12.007,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom6,	projectId,	RoadAddressChangeType.Transfer,	AdministrativeClass.Municipality,	FrozenLinkInterface, 12.007,	roadwayIdCombinedSection,	466783,	14,	reversed = false, None, 1652179948783L,		roadwayNumberCombinedSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(0,	    30),	    AddrMRange(0,	    30),	     None, None, Some("test"), "b4775d3e-9c3f-4c0a-a4cb-31bc586a3a29:2",	0.000,	29.986,	SideCode.TowardsDigitizing,(RoadAddressCP, NoCP), (RoadAddressCP, NoCP),geom7,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 29.986,	roadwayIdRightTrack,	465370,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(30,	    39),	    AddrMRange(30,	    39),	     None, None, Some("test"), "f2e89f78-beff-48c2-82e2-3f57ce345572:2",	0.000,	8.715,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom8,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 8.715,	roadwayIdRightTrack,	465371,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(39,	    44),	    AddrMRange(39,	    44),	     None, None, Some("test"), "cb9d5aff-ec59-4ca0-9dc8-8252ce3ec2b9:2",	0.000,	4.644,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom9,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 4.644,	roadwayIdRightTrack,	465372,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(44,	    63),	    AddrMRange(44,	    63),	     None, None, Some("test"), "d7eb3af7-eb2b-4372-bfd9-0b717d153347:2",	0.000,	18.902,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom10,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 18.902,	roadwayIdRightTrack,	465373,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(63,	    80),	    AddrMRange(63,	    80),	     None, None, Some("test"), "ebf9e382-f212-49bb-bbe8-758e42ee69ae:2",	0.000,	17.426,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom11,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 17.426,	roadwayIdRightTrack,	465374,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(80,	    189),	AddrMRange(80,	    189),	 None, None, Some("test"), "b3f904e5-b7b6-499c-9ff5-bde55ad65d1e:2",	0.000,	107.869,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom12,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 107.869,	roadwayIdRightTrack,	465375,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(189,	213),	AddrMRange(189,	213),	 None, None, Some("test"), "167a230f-f59a-4d3a-84b1-e131c248cb7a:2",	0.000,	24.180,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom13,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 24.180,	roadwayIdRightTrack,	465376,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(213,	227),	AddrMRange(213,	227),	 None, None, Some("test"), "9acdcdf3-7a11-49e8-9f5f-f62863290f5a:2",	0.000,	13.658,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom14,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 13.658,	roadwayIdRightTrack,	465377,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(227,	241),	AddrMRange(227,	241),	 None, None, Some("test"), "2a2c5c75-dc63-4d2d-9379-9c5ddaf64546:2",	0.000,	13.868,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom15,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 13.868,	roadwayIdRightTrack,	465378,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(241,	309),	AddrMRange(241,	309),	 None, None, Some("test"), "fb18fd8c-64b6-4f89-a039-68de753b0bef:2",	0.000,	68.332,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom16,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 68.332,	roadwayIdRightTrack,	465379,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(309,	380),	AddrMRange(309,	380),	 None, None, Some("test"), "4401fa25-6e4e-4934-9678-d1e88e5bce2a:2",	0.000,	70.971,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom17,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 70.971,	roadwayIdRightTrack,	465380,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(380,	403),	AddrMRange(380,	403),	 None, None, Some("test"), "454db012-0d1e-4d2c-b5fb-f124a734ae07:2",	0.000,	22.514,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom18,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 22.514,	roadwayIdRightTrack,	465381,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(403,	416),	AddrMRange(403,	416),	 None, None, Some("test"), "a70a4c2f-c104-44fe-a4d7-3f3718b162aa:2",	0.000,	13.427,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom19,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 13.427,	roadwayIdRightTrack,	465382,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(416,	509),	AddrMRange(416,	509),	 None, None, Some("test"), "6e98cc1c-7bbe-4b88-ab24-f362665e3311:2",	0.000,	92.416,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom20,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 92.416,	roadwayIdRightTrack,	465383,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(509,	522),	AddrMRange(509,	522),	 None, None, Some("test"), "d7aa5b8d-4db7-4d3a-b438-ad32ae2de8dc:2",	0.000,	13.036,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom21,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 13.036,	roadwayIdRightTrack,	465384,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(522,	653),	AddrMRange(522,	653),	 None, None, Some("test"), "24b62493-3d76-41a5-a676-98589bed32be:2",	0.000,	130.922,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom22,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 130.922,	roadwayIdRightTrack,	465385,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.MinorDiscontinuity,	AddrMRange(653,	672),	AddrMRange(653,	672),	 None, None, Some("test"), "96d2a31a-fafc-4a1e-aeda-ef7e047207b0:2",	0.000,	19.434,	SideCode.TowardsDigitizing,(NoCP, RoadAddressCP), (NoCP, NoCP),geom23,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 19.434,	roadwayIdRightTrack,	465386,	14,	reversed = false, None, 1652179948783L,		roadwayNumberRightTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.RightSide,	Discontinuity.Continuous,	AddrMRange(672,	696),	AddrMRange(672,	696),	 None, None, Some("test"), "d061fce2-c526-4967-bf33-62b8005c9c97:1",	0.000,	22.987,	SideCode.TowardsDigitizing,(NoCP, RoadAddressCP), (NoCP, RoadAddressCP),geom24,	projectId,	RoadAddressChangeType.Termination,	AdministrativeClass.Municipality,	FrozenLinkInterface, 22.987,	roadwayIdRightTrack,	465387,	14,	reversed = false, None, 1652179948783L,		    -1000,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(0,	    29),	    AddrMRange(0,	    29),	     None, None, Some("test"), "82501ee0-0003-4c96-af57-fe9e003caa23:2",	0.000,	28.820,	SideCode.TowardsDigitizing,(RoadAddressCP, NoCP), (RoadAddressCP, NoCP),geom25,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 28.820,	roadwayIdLeftTrack,	465412,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(29,	    37),	    AddrMRange(29,	    37),	     None, None, Some("test"), "3b4060d2-f2e4-484c-a350-36285707b93b:2",	0.000,	8.775,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom26,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 8.775,	roadwayIdLeftTrack,	465413,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(37,	    43),	    AddrMRange(37,	    43),	     None, None, Some("test"), "f99ae6ea-ecea-4f94-9c1e-8df98d679b37:2",	0.000,	5.523,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom27,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 5.523,	roadwayIdLeftTrack,	465414,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(43,	    61),	    AddrMRange(43,	    61),	     None, None, Some("test"), "ec3597c7-0c11-4f9b-bb5a-b545f49c8787:2",	0.000,	18.388,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom28,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 18.388,	roadwayIdLeftTrack,	465415,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(61,	    78),	    AddrMRange(61,	    78),	     None, None, Some("test"), "32601586-1464-4e5b-be20-bf56f055aa10:2",	0.000,	16.967,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom29,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 16.967,	roadwayIdLeftTrack,	465416,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(78,	    188),	AddrMRange(78,	    188),	 None, None, Some("test"), "38c473c7-28d5-433b-9678-c9f08d67c142:2",	0.000,	110.036,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom30,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 110.036,	roadwayIdLeftTrack,	465417,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(188,	206),	AddrMRange(188,	206),	 None, None, Some("test"), "49ecdce7-4115-4d3d-b63d-2115d7dba40b:2",	0.000,	18.220,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom31,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 18.220,	roadwayIdLeftTrack,	465418,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(206,	219),	AddrMRange(206,	219),	 None, None, Some("test"), "be5499ac-03bf-4fca-abac-bd8af0e7eaf3:2",	0.000,	13.135,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom32,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 13.135,	roadwayIdLeftTrack,	465419,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(219,	229),	AddrMRange(219,	229),	 None, None, Some("test"), "7987813c-6870-4883-81fe-d7e1c25fa21f:2",	0.000,	9.794,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom33,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 9.794,	roadwayIdLeftTrack,	465420,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(229,	237),	AddrMRange(229,	237),	 None, None, Some("test"), "3bf22c87-ce97-4bc7-99fb-6bf157756e24:2",	0.000,	8.664,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom34,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 8.664,	roadwayIdLeftTrack,	465421,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(237,	403),	AddrMRange(237,	403),	 None, None, Some("test"), "1a9c7e0a-7c0f-40aa-a8db-b8e8c1bb6dd2:2",	0.000,	166.014,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom35,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 166.014,	roadwayIdLeftTrack,	465422,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(403,	508),	AddrMRange(403,	508),	 None, None, Some("test"), "68679010-c1a1-45a3-b752-64d483ec09ea:2",	0.000,	106.006,SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom36,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 106.006,	roadwayIdLeftTrack,	465423,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(508,	521),	AddrMRange(508,	521),	 None, None, Some("test"), "dfab6465-6395-4ac8-b72b-85ef40408443:2",	0.000,	12.898,	SideCode.TowardsDigitizing,(NoCP, NoCP), (NoCP, NoCP),geom37,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 12.898,	roadwayIdLeftTrack,	465424,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.MinorDiscontinuity,	AddrMRange(521,	671),	AddrMRange(521,	671),	 None, None, Some("test"), "ce492f47-e821-423d-ba5a-fd71fdeb71d5:2",	0.000,	150.546,SideCode.TowardsDigitizing,(NoCP, RoadAddressCP), (NoCP, NoCP),geom38,	projectId,	RoadAddressChangeType.Unchanged,	AdministrativeClass.Municipality,	FrozenLinkInterface, 150.546,	roadwayIdLeftTrack,	465425,	14,	reversed = false, None, 1652179948783L,		roadwayNumberLeftTrackSection,Some("roadName"), None, None, None, None),
        ProjectLink(Sequences.nextProjectLinkId, roadPart,	Track.LeftSide,	Discontinuity.Continuous,	AddrMRange(671,	696),	AddrMRange(671,	696),	 None, None, Some("test"), "629b8776-c3aa-47c5-b8ad-52cb1aed8f51:1",	0.000,	25.303,	SideCode.TowardsDigitizing,(NoCP, RoadAddressCP), (NoCP, RoadAddressCP),geom39,	projectId,	RoadAddressChangeType.Termination,	AdministrativeClass.Municipality,	FrozenLinkInterface, 25.303,	roadwayIdLeftTrack,	465426,	14,	reversed = false, None, 1652179948783L,		    -1000,Some("roadName"), None, None, None, None)
      )
      ...
      val linearlocations = Seq(
        ...
        LinearLocation(465387,18.0, "d061fce2-c526-4967-bf33-62b8005c9c97:1",0.0,22.987,    SideCode.TowardsDigitizing,1699999200000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(696),Some(RoadAddressCP))),List(Point(443683.593,7376311.326,0.0), Point(443695.047,7376331.256,0.0)),ComplementaryLinkInterface,roadwayNumberRightTrackSection,Some(DateTime.now().minusDays(2)),None),
        LinearLocation(466778,1.0,  "4c184326-404e-4e3b-b13c-e256a3312aa1:2",0.0,120.399,   SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(696),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(443695.047,7376331.256,0.0), Point(443780.561,7376415.993,0.0)),FrozenLinkInterface,roadwayNumberCombinedSection,Some(DateTime.now().minusDays(2)),None),
        ...
        LinearLocation(465370,1.0,  "b4775d3e-9c3f-4c0a-a4cb-31bc586a3a29:2",0.0,29.986,    SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(0),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(443492.259,7375680.103,0.0), Point(443498.725,7375709.381,0.0)),FrozenLinkInterface,roadwayNumberRightTrackSection,Some(DateTime.now().minusDays(2)),None),
        LinearLocation(466782,5.0,  "3121460f-5d95-43b0-ae1d-88d71ba91ffe:2",0.0,9.109,     SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(1030),Some(JunctionPointCP))),List(Point(443864.362,7376599.54,0.0), Point(443867.842,7376607.958,0.0)),FrozenLinkInterface,roadwayNumberCombinedSection,Some(DateTime.now().minusDays(2)),None),
        ...
        LinearLocation(465426,15.0, "629b8776-c3aa-47c5-b8ad-52cb1aed8f51:1",0.0,25.303,    SideCode.TowardsDigitizing,1699999200000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(696),Some(RoadAddressCP))),List(Point(443676.263,7376314.303,0.0), Point(443695.047,7376331.256,0.0)),ComplementaryLinkInterface,roadwayNumberLeftTrackSection,Some(DateTime.now().minusDays(2)),None),
        LinearLocation(466783,6.0,  "92d3f0ef-db38-476f-b5ff-49b18d74b4aa:2",0.0,12.007,    SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(1030),Some(JunctionPointCP)),CalibrationPointReference(Some(1042),Some(RoadAddressCP))),List(Point(443867.842,7376607.958,0.0), Point(443871.967,7376619.225,0.0)),FrozenLinkInterface,roadwayNumberCombinedSection,Some(DateTime.now().minusDays(2)),None),
        ...
        LinearLocation(465420,9.0,  "7987813c-6870-4883-81fe-d7e1c25fa21f:2",0.0,9.794,     SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(219),Some(JunctionPointCP)),CalibrationPointReference(None,None)),List(Point(443501.416,7375897.461,0.0), Point(443508.565,7375904.151,0.0)),FrozenLinkInterface,roadwayNumberLeftTrackSection,Some(DateTime.now().minusDays(2)),None),
        LinearLocation(465376,7.0,  "167a230f-f59a-4d3a-84b1-e131c248cb7a:2",0.0,24.18,     SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(None,None),CalibrationPointReference(Some(213),Some(JunctionPointCP))),List(Point(443500.173,7375866.363,0.0), Point(443508.949,7375888.836,0.0)),FrozenLinkInterface,roadwayNumberRightTrackSection,Some(DateTime.now().minusDays(2)),None),
        ...
        LinearLocation(465412,1.0,  "82501ee0-0003-4c96-af57-fe9e003caa23:2",0.0,28.82,     SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(0),Some(RoadAddressCP)),CalibrationPointReference(None,None)),List(Point(443485.148,7375680.886,0.0), Point(443491.386,7375709.004,0.0)),FrozenLinkInterface,roadwayNumberLeftTrackSection,Some(DateTime.now().minusDays(2)),None),
        ...
        LinearLocation(465419,8.0,  "be5499ac-03bf-4fca-abac-bd8af0e7eaf3:2",0.0,13.135,    SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(206),Some(JunctionPointCP)),CalibrationPointReference(Some(219),Some(JunctionPointCP))),List(Point(443494.906,7375886.053,0.0), Point(443501.416,7375897.461,0.0)),FrozenLinkInterface,roadwayNumberLeftTrackSection,Some(DateTime.now().minusDays(2)),None),
        LinearLocation(465377,8.0,  "9acdcdf3-7a11-49e8-9f5f-f62863290f5a:2",0.0,13.658,    SideCode.TowardsDigitizing,1698414053000L,(CalibrationPointReference(Some(213),Some(JunctionPointCP)),CalibrationPointReference(None,None)),List(Point(443508.949,7375888.836,0.0), Point(443516.236,7375900.382,0.0)),FrozenLinkInterface,roadwayNumberRightTrackSection,Some(DateTime.now().minusDays(2)),None),
      ...
      val sorted = recalculated.sortBy(pl => (pl.originalAddrMRange.start))
      ...
      terminated.filter(_.track == Track.LeftSide).head.addrMRange.start should be (nonTerminated.filter(_.track == Track.LeftSide).last.addrMRange.end) // terminated link should still be "continuous" with the previous unChanged link
      terminated.filter(_.track == Track.RightSide).head.addrMRange.start should be (nonTerminated.filter(_.track == Track.RightSide).last.addrMRange.end)
      val endAddrMValueOnMinorDiscontinuity = nonTerminated.filter(_.discontinuity == Discontinuity.MinorDiscontinuity).map(_.addrMRange.end).distinct
      endAddrMValueOnMinorDiscontinuity.size should be (1) // endAddrMValue should be the same on both tracks at the new minor discontinuity spot
      nonTerminated.filter(_.track == Track.Combined).head.addrMRange.start should be (endAddrMValueOnMinorDiscontinuity.head) //combined section startAddressMValue should be the same as the endAddrMValue of the minor discontinuity links
      nonTerminated.filter(_.status != RoadAddressChangeType.Transfer).foreach(pl => pl.addrMRange.start should be (pl.originalAddrMRange.start)) // addressMValues should match original addressMValues on all links except Transferred links
      nonTerminated.filter(_.status != RoadAddressChangeType.Transfer).foreach(pl => pl.addrMRange.end should be (pl.originalAddrMRange.end))
    }
  }

  test("Test assignAddrMValues() When creating roundabout from New and Transfer links then roadway numbers should be assigned correctly") {
    runWithRollback{

      val pls = projectLinkDAO.fetchProjectLinks(1012400)
      val rwns = pls.map(_.roadwayNumber)
      val rws = roadwayDAO.fetchAllByRoadwayNumbers(rwns.toSet)
      val llIds = pls.map(_.linearLocationId).filter(id => id !== 0)
      val lls = linearLocationDAO.fetchByIdMassQuery(llIds)

      rws.foreach(rw => println(
        s"Roadway(" +
        s"${rw.id}," +
          s"${rw.roadwayNumber}," +
          s"RoadPart(${rw.roadPart.roadNumber},${rw.roadPart.partNumber})," +
          s"AdministrativeClass.${rw.administrativeClass}," +
          s"Track.${rw.track.value match {
            case 0 => "Combined"
            case 1 => "RightSide"
            case 2 => "LeftSide"
          }}," +
          s"Discontinuity.${
            rw.discontinuity match {
              case Discontinuity.EndOfRoad => "EndOfRoad"
              case Discontinuity.Discontinuous => "Discontinuous"
              case Discontinuity.ChangingELYCode => "ChangingElyCode"
              case Discontinuity.MinorDiscontinuity => "MinorDiscontinuity"
              case Discontinuity.Continuous => "Continuous"
            }}," +
          s"AddrMRange(${rw.addrMRange.start}, ${rw.addrMRange.end})," +
          s"false," +
          s"DateTime.now().minusDays(2)," +
          s"None," +
          "\"test\"," +
          s"None," +
          s"14," +
          s"TerminationCode.NoTermination," +
          s"DateTime.now().minusDays(2)," +
          s"None" +
          s"),"
      ))

      lls.foreach(ll => println(
        s"LinearLocation(" +
          s"${ll.id}, " +
          s"${ll.orderNumber}," +
          "\"" + ll.linkId + "\"," +
          s"${ll.startMValue}," +
          s"${ll.endMValue}," +
          s"SideCode.${ll.sideCode}," +
          s"1698414053000L," +
          s"(CalibrationPointReference(None,None),CalibrationPointReference(None,None))," +
          s"${ll.geometry}," +
          s"FrozenLinkInterface," +
          s"${ll.roadwayNumber}," +
          s"Some(DateTime.now().minusDays(2))," +
          s"None" +
          s"),"
      ))

      pls.foreach(pl => println(
        s"ProjectLink(Sequences.nextProjectLinkId," +
          s" RoadPart(${pl.roadPart.roadNumber},${pl.roadPart.partNumber})," +
          s"Track.${pl.track.value match {
            case 0 => "Combined"
            case 1 => "RightSide"
            case 2 => "LeftSide"
          }}," +
          s"Discontinuity.${
            pl.discontinuity match {
              case Discontinuity.EndOfRoad => "EndOfRoad"
              case Discontinuity.Discontinuous => "Discontinuous"
              case Discontinuity.ChangingELYCode => "ChangingElyCode"
              case Discontinuity.MinorDiscontinuity => "MinorDiscontinuity"
          ...
          s"AddrMRange(${pl.addrMRange.start},${pl.addrMRange.end})," +
          s"AddrMRange(${pl.originalAddrMRange.start},${pl.originalAddrMRange.end})," +
          s"None," +
          s"None," +
          "Some(\"test\")," +
          "\"" + pl.linkId + "\", " +
          s"${pl.startMValue}," +
          s"${pl.endMValue}," +
          s"SideCode.${pl.sideCode}," +
          s"(NoCP, NoCP), (NoCP, NoCP)," +
          s"${pl.geometry}," +
          s"projectId, " +
          s" RoadAddressChangeType.${pl.status}," +
          s"AdministrativeClass.${pl.administrativeClass}, " +
          s"FrozenLinkInterface," +
          s"${pl.geometryLength}," +
          s"${pl.roadwayId}," +
          s"${pl.linearLocationId}," +
          s"${pl.ely}," +
          s"reversed = false," +
          s"None," +
          s"1652179948783L," +
      ...
      val fetchedPls = projectLinkDAO.fetchProjectLinks(projectId)

      val recalculated = defaultSectionCalculatorStrategy.assignAddrMValues(Seq(), fetchedPls, Seq())
      val recalculatedRoundabout = recalculated.filter(_.roadPart == roundAboutRoadPart)

      recalculatedRoundabout.map(_.roadwayNumber).distinct.size should be (2)
    }
  }
}