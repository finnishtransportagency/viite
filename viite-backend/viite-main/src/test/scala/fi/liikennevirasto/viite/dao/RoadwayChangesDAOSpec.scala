...
class RoadwayChangesDAOSpec extends AnyFunSuite with Matchers with BaseDAO {
 ...
 test("Test RoadwayChangesDAO().fetchRoadwayChanges() When searching for changes on a project with roadway changes Then return said changes."){
   runWithRollback{
     //inserts one case
     val addresses = List(ProjectReservedPart(5:Long, RoadPart(203, 203), Some(6L), Some(Discontinuity.apply("jatkuva")), roadMaintainer = Some(ArealRoadMaintainer.apply("EVK8")), newLength = None, newDiscontinuity = None))
     ...
     runUpdateToDb(
       sql"""
            INSERT INTO roadway_changes(project_id,change_type,new_road_number,new_road_part_number,new_track,new_start_addr_m,new_end_addr_m,new_discontinuity,new_administrative_class, roadway_change_id, new_road_maintainer, old_road_maintainer)
            values(100,1,6,1,1,0,10.5,1,1,1,'EVK8','EVK1')
            """
     )
 ...
 test("Test RoadwayChangesDAO().insertDeltaToRoadChangeTable() When inserting the results of the delta calculation for a project Then when querying directly the roadway_changes it should confirm data insertion.") {
   runWithRollback {
     ...
     val reservedParts = Seq(ProjectReservedPart(0, RoadPart(1, 1), Some(0), Some(Discontinuity.Continuous), Some(ArealRoadMaintainer.getEVK(8)), None, None, None, Some(12345L.toString)))
   ...
   runWithRollback {
     ...
     val ra = Seq(
       RoadAddress(12345, projectLink1.linearLocationId, projectLink1.roadPart, projectLink1.administrativeClass, projectLink1.track, projectLink1.discontinuity, projectLink1.addrMRange, projectLink1.startDate, projectLink1.endDate, projectLink1.createdBy, projectLink1.linkId, projectLink1.startMValue, projectLink1.endMValue, projectLink1.sideCode, DateTime.now().getMillis, projectLink1.calibrationPoints, projectLink1.geometry, projectLink1.linkGeomSource
         /*ELY*/, ArealRoadMaintainer.getEVK(8), NoTermination, projectLink1.roadwayNumber, None, None, None)
     )
     ...
     changes.foreach(c => {
       c.changeInfo.target.roadMaintainer.get.id should be("EVK8")
     })
   }
 }
 ...
 test("Test RoadwayChangesDAO().insertDeltaToRoadChangeTable() When a road is transferred to another road with reverse then roadway changetable should have one road reversed and the others roadnumber changed .") {
   ...
   runWithRollback {
     ...
     val rws           = Seq(Roadway(rw1, projectLink1.roadwayNumber, targetRoadPart,          AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,    AddrMRange( 0, 10), reversed = false, DateTime.parse("2020-01-03"), None, "test", None, ArealRoadMaintainer.getEVK(5), NoTermination),
                             Roadway(rw2, projectLink2.roadwayNumber, targetRoadPart,          AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,    AddrMRange( 0, 10), reversed = false, DateTime.parse("2020-01-03"), None, "test", None, ArealRoadMaintainer.getEVK(5), NoTermination),
                             Roadway(rw3, projectLink5.roadwayNumber, targetRoadPart,          AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Discontinuous, AddrMRange(10, 20), reversed = false, DateTime.parse("2020-01-03"), None, "test", None, ArealRoadMaintainer.getEVK(5), NoTermination),
                             Roadway(rw4, projectLink6.roadwayNumber, otherRoadSourceRoadPart, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Discontinuous, AddrMRange(10, 50), reversed = false, DateTime.parse("2020-01-03"), None, "test", None, ArealRoadMaintainer.getEVK(5), NoTermination),
                             Roadway(rw5, projectLink7.roadwayNumber, otherRoadSourceRoadPart, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Discontinuous, AddrMRange(10, 50), reversed = false, DateTime.parse("2020-01-03"), None, "test", None, ArealRoadMaintainer.getEVK(5), NoTermination)
                            )
     ...
     changes.foreach(c => {
       ...
       c.changeInfo.source.roadMaintainer.get.id should be(rws.head.roadMaintainer.id)
       ...
       c.changeInfo.target.roadMaintainer.get.id should be(rws.head.roadMaintainer.id)
     })
   }
 }
 ...
 test("Test RoadwayChangesDAO().insertDeltaToRoadChangeTable() When administrative class changes in the middle of an existing road.") {
   ...
   runWithRollback {
     ...
     val project1   = projectDAO.fetchById(projId1).get
     val rw         = Seq(Roadway(0, 1111, projectLink4.roadPart, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Discontinuous, AddrMRange(0, 40), reversed = false, DateTime.parse("2020-01-03"), None, "test", None, ArealRoadMaintainer.getEVK(5), NoTermination))
     val roadwayDAO = new RoadwayDAO
     roadwayDAO.create(rw)
     projectLinkDAO.create(Seq(projectLink1, projectLink2, projectLink3, projectLink4))
     val reservedParts     = Seq(ProjectReservedPart(0, RoadPart(1, 1), Some(0), Some(Discontinuity.Discontinuous), Some(ArealRoadMaintainer.getEVK(8)), None, None, None, Some(12345L.toString)))
     val roadwayChangesDAO = new RoadwayChangesDAO()
     ...
     changes.foreach(c => {
       ...
       c.changeInfo.source.roadMaintainer.get.id should be("EVK5")
       ...
       c.changeInfo.target.roadMaintainer.get.id should be("EVK5")
     })
 ...
 test("Test query for Roadway_change changes api") {
   runWithRollback {
     val testRoadway1 = Roadway(NewIdValue, roadwayNumber1, RoadPart(roadNumber1, roadPartNumber1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0, 100), reversed = false, DateTime.parse("2000-01-02"), None, "test", Some("TEST ROAD 1"), ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     val dao = new RoadwayChangesDAO()
     val roadwayDAO = new RoadwayDAO
...
//    val pr2 = projectDAO.fetchById(projId1)  // for debug
     ...
     runUpdateToDb(sql"""
      INSERT INTO roadway_changes(
        ...
        old_administrative_class, new_administrative_class,
        roadway_change_id, new_road_number, new_road_part_number,
        new_start_addr_m, new_end_addr_m, old_road_maintainer, new_road_maintainer -- Added this
      )
      VALUES(
        $projId1, $changeType, 1, 1,
        1, 1,
        1, $roadNumber1, $roadPartNumber1,
        0, 10.5,'EVK1', 'EVK1' -- Added a default value
      )
    """)
//    val rwcs = dao.fetchRoadwayChanges(Set(projId1))  // for debug
     ...
     runUpdateToDb(sql"""
      INSERT INTO roadway_changes(
        ...
        roadway_change_id, new_road_maintainer, old_road_maintainer,
 ...
 test("When roadway is partially transferred to another roadaddress " +
   ...
   runWithRollback {
     ...
     val oldroadway1 = Roadway(NewIdValue, roadwayNumber1, RoadPart(roadNumber, initialRoadPart),    AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(100, 200), reversed = false, DateTime.parse("2000-01-02"), Some(DateTime.parse("2010-01-01")), "test", Some("TEST ROAD 1"), ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     val oldroadway2 = Roadway(NewIdValue, roadwayNumber1, RoadPart(roadNumber, initialRoadPart),    AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(  0, 100), reversed = false, DateTime.parse("2000-01-02"), Some(DateTime.parse("2010-01-01")), "test", Some("TEST ROAD 1"), ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)

     val roadway1 = Roadway(NewIdValue, roadwayNumber1,   RoadPart(roadNumber, initialRoadPart),     AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(  0, 100), reversed = false, DateTime.parse("2010-01-02"), None, "test", Some("TEST ROAD 1"), ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     val roadway2 = Roadway(NewIdValue, roadwayNumber1+1, RoadPart(roadNumber, transferredRoadPart), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(  0, 100), reversed = false, DateTime.parse("2010-01-02"), None, "test", Some("TEST ROAD 2"), ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     ...
     runUpdateToDb(sql"""
       INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,new_road_number,new_road_part_number,new_track,new_start_addr_m,new_end_addr_m,old_discontinuity,new_discontinuity,old_administrative_class,new_administrative_class, roadway_change_id, new_road_maintainer, old_road_maintainer)
       VALUES($projId,$changeType,$roadNumber,$initialRoadPart,0,0,100,$roadNumber,$transferredRoadPart,0,0,100,5,5,1,1,8,'EVK1','EVK2')
       """)
     runUpdateToDb(sql"""
       INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,new_road_number,new_road_part_number,new_track,new_start_addr_m,new_end_addr_m,old_discontinuity,new_discontinuity,old_administrative_class,new_administrative_class, roadway_change_id, new_road_maintainer, old_road_maintainer)
       VALUES($projId,$changeType,$roadNumber,$initialRoadPart,0,100,200,$roadNumber,$initialRoadPart,0,0,100,5,5,1,1,2,'EVK2','EVK2')
       """)
 ...
 test("[ChangeInfoForRoadAddressChangesBrowser] When fetching road address change infos for road address browser then return change infos based on the parameters given") {
   runWithRollback {
     ...
     runUpdateToDb(sql"""INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,
                                           ...
                                           old_administrative_class,new_administrative_class,old_road_maintainer,new_road_maintainer, roadway_change_id)
                                 VALUES($projectId,$changeTypeUnchanged,$roadNumber,$roadPartNumber,$trackCombined,0,607,$roadNumber,$roadPartNumber,
                                        $trackCombined,0,607,$discontinuity,$discontinuity,$adminClass,$adminClass,$roadMaintainer,$roadMaintainer,$roadwayChangeId)
         """)
     ...
     runUpdateToDb(sql"""INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,
                                 ...
                                 VALUES($projectId,$changeTypeTransfer,$roadNumber,$roadPartNumber,$trackCombined,607,909,$roadNumber,$roadPartNumber,
                                        $trackRight,607,909,$discontinuity,$discontinuity,$adminClass,$adminClass,$roadMaintainer,$roadMaintainer,$roadwayChangeId + 1)
         """)
     ...
     runUpdateToDb(sql""" INSERT INTO roadway_changes(project_id,change_type,new_road_number,new_road_part_number,old_discontinuity,new_discontinuity,
                                           old_administrative_class,new_administrative_class,old_road_maintainer,new_road_maintainer,new_start_addr_m,new_end_addr_m, new_track,roadway_change_id)
                                  Values($projectId,$changeTypeNew,$roadNumber,$roadPartNumber,$discontinuity,$discontinuity,$adminClass,
                                         $adminClass,$roadMaintainer,$roadMaintainer,607,909, $trackLeft, $roadwayChangeId + 2)
         """)
     ...
     runUpdateToDb(sql"""INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,
                                 ...
                                 VALUES($projectId,$changeTypeTransfer,$roadNumber,$roadPartNumber,$trackCombined,909,7862,$roadNumber,$roadPartNumber,
                                        $trackCombined,909,7862,$discontinuity,$discontinuity,$adminClass,$adminClass,$roadMaintainer,$roadMaintainer,$roadwayChangeId + 3)
         """)
 ...
 test("[ChangeInfoForRoadAddressChangesBrowser] When the road has been terminated (-> type of change: termination) then return the change info of the terminated layer") {
   ...
   //  val ely = 10L
     ...
     runUpdateToDb(sql"""INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,
                                           old_discontinuity,old_administrative_class,old_road_maintainer,new_discontinuity,new_road_maintainer,new_administrative_class,roadway_change_id)
                                 VALUES($projectId,$changeTypeTerminated,$roadNumber,$roadPartNumber,$trackCombined,0,1000,
                                        $discontinuity,$adminClass,$roadMaintainer,$discontinuity,$roadMaintainer,$adminClass,$roadwayChangeId)
         """)
 ...
 test("[ChangeInfoForRoadAddressChangesBrowser] When a road has no road name then return the change info without a road name") {
   runWithRollback {
     ...
     runUpdateToDb(sql""" INSERT INTO roadway_changes(project_id,change_type,new_road_number,new_road_part_number,old_discontinuity,new_discontinuity,
                                           old_administrative_class,new_administrative_class,old_road_maintainer,new_road_maintainer,new_start_addr_m,new_end_addr_m, new_track,roadway_change_id)
                                  Values($projectId,$changeTypeNew,$roadNumber,$roadPartNumber,$discontinuity,$discontinuity,$adminClass,
                                         $adminClass,$roadMaintainer,$roadMaintainer,0,1000, $trackCombined, $roadwayChangeId)
         """)
    ...
    // val ely = 10L
     ...
     runUpdateToDb(sql"""INSERT INTO roadway_changes(project_id,change_type,old_road_number,old_road_part_number,old_track,old_start_addr_m,old_end_addr_m,
                                 ...
                                 VALUES($projectId,$changeTypeTransfer,$oldRoadNumber,$oldRoadPartNumber,$trackCombined,0,1000,$newRoadNumber,$newRoadPartNumber,
                                        $trackCombined,0,1000,$discontinuity,$discontinuity,$adminClass,$adminClass,$roadMaintainer,$roadMaintainer,$roadwayChangeId)
         """)
   ...
   //  val ely = 10L
     ...
     runUpdateToDb(sql""" INSERT INTO roadway_changes(project_id,change_type,new_road_number,new_road_part_number,old_discontinuity,new_discontinuity,
                                  ...
                                  VALUES ($projectId2,$changeTypeUnChanged,$roadNumber,$firstRoadPartNumber,$discontinuity,$discontinuity,$adminClass,
                                           $adminClass,$roadMaintainer,$roadMaintainer,0,1000, $trackCombined, $roadwayChangeId + 1)
                    """)
     ...
     runUpdateToDb(sql""" INSERT INTO roadway_changes(project_id,change_type,new_road_number,new_road_part_number,old_discontinuity,new_discontinuity,
                                  ...
                                  VALUES ($projectId2,$changeTypeNew,$roadNumber,$secondRoadPartNumber,$discontinuity,$discontinuity,$adminClass,
                                           $adminClass,$roadMaintainer,$roadMaintainer,1000,2000, $trackCombined, $roadwayChangeId + 2)
                    """)
     ...
     runUpdateToDb(sql""" INSERT INTO roadway_changes(project_id,change_type,new_road_number,new_road_part_number,old_discontinuity,new_discontinuity,
                                  ...
                                  VALUES ($projectId1,$changeTypeNew,$secondRoadNumber,$firstRoadPartNumber,$discontinuity,$discontinuity,$adminClass,
                                           $adminClass,$roadMaintainer,$roadMaintainer,0,500, $trackCombined, $roadwayChangeId + 3)
                    """)
