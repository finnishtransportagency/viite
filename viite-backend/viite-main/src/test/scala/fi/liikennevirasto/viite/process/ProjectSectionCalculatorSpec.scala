...
class ProjectSectionCalculatorSpec extends AnyFunSuite with Matchers {
  ...
  test("Test assignAddrMValues When assigning values for new road addresses Then values should be properly assigned") {
    runWithRollback {
      ...
      val idRoad2 = 2L
      val idRoad3 = 3L
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12345L.toString, 0.0,  9.8, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(0.0,  0.0), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12346L.toString, 0.0,  9.8, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(0.0, 30.0), Point(0.0, 39.8)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12347L.toString, 0.0,  9.8, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(0.0, 20.2), Point(0.0, 30.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 12348L.toString, 0.0, 10.4, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(0.0,  9.8), Point(0.0, 20.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When assigning values for new road addresses in a complex case Then values should be properly assigned") {
    ...
    runWithRollback {
      ...
      val idRoad7 = 7L //    \
      val idRoad8 = 8L //   |
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  0.0), Point( 0.0,  9.8)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  9.8), Point(-2.0, 20.2)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  9.8), Point( 2.0, 19.2)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(-2.0, 20.2), Point( 1.0, 30.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      val projectLink4 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad4.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 2.0, 19.2), Point( 1.0, 30.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad5.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 1.0, 30.0), Point( 0.0, 48.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      val projectLink6 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad6, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad6.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 48.0), Point( 2.0, 68.0), Point(0.0, 96.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
      ...
      val projectLink8 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad8, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad8.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 96.0), Point( 0.0,148.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving against digitization case Then values should be properly assigned") {
    runWithRollback {
      ...
      val idRoad7 = 7L //    \
      val idRoad8 = 8L //   |
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0,  9.8,  SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  0.0), Point( 0.0,   9.8)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 10.6,  SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  9.8), Point(-2.0,  20.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0,  9.21, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  9.8), Point( 2.0,  19.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, 10.29, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(-2.0, 20.2), Point( 1.0,  30.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink4 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad4.toString, 0.0, 10.60, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 2.0, 19.2), Point( 1.0,  30.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad5.toString, 0.0, 18.02, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 1.0, 30.0), Point( 0.0,  48.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink6 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad6, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad6.toString, 0.0, 48.17, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 48.0), Point( 2.0,  68.0), Point(0.0, 96.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink7 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad7, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad7.toString, 0.0, 48.17, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 48.0), Point(-2.0,  68.0), Point(0.0, 96.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink8 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad8, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad8.toString, 0.0, 52.0,  SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 96.0), Point( 0.0, 148.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When addressing calibration points and mixed directions Then values should be properly assigned") {
    runWithRollback {
      ...
      val idRoad3 = 3L //     <
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0,  9.8,  SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  0.0), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0,  4.61, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point( 4.0,  7.5), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 11.86, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 4.0,  7.5), Point(6.0, 19.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0,  5.8,  SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(10.0, 15.0), Point(6.0, 19.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When assigning values for Tracks 0+1+2 Then the result should not be dependent on the order of the links") {
    runWithRollback {
      ...
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(20.0, 10.0), Point(28, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(42,   14),   Point(28, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(28,   15),   Point(75, 19.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving one link Towards and one Against Digitizing Then calibrations points should be properly assigned") {
    runWithRollback {
      ...
      val projectLink0T = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(0L, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 0L.toString, 0.0, GeometryUtils.geometryLength(geometry), SideCode.TowardsDigitizing, 0, (None, None), geometry, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink0A = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(0L, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 0L.toString, 0.0, GeometryUtils.geometryLength(geometry), SideCode.AgainstDigitizing, 0, (None, None), geometry, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving links without opposite track Then exception is thrown and links are returned as-is") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(1L, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), 1L.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(28.0, 15.0), Point(38, 15)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving incompatible digitization on tracks Then the direction of left track is corrected to match the right track") {
    runWithRollback {
      ...
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (Some(ProjectCalibrationPoint(0L.toString, 0.0, 0L)), None), Seq(Point(28, 9.8), Point(20.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(42,  9.7), Point(28,  9.8)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(20, 10.1), Point(28, 10.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(28, 10.2), Point(42, 10.3)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving links with different track lengths Then different track lengths are adjusted") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 14.56, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15),   Point(42,  19  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 34.54, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19),   Point(75,  29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, 31.39, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point(75,  29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink4 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad4.toString, 0.0, 22.02, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point(42,  11  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad5.toString, 0.0, 61.13, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   11),   Point(103, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving links in one track with JunctionPointCP in the middle Then proper calibration points should be created and JunctionPointCPs kept in place") {
    runWithRollback {
      ...
      val geom2 = Seq(Point(42, 19), Point(75, 29.2))
      val geom3 = Seq(Point(103.0, 15.0), Point(75, 29.2))
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.Unchanged)(RoadAddress(idRoad0.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 9L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0, 0.0, GeometryUtils.geometryLength(geom0), SideCode.TowardsDigitizing, 0, (None, Some(ProjectCalibrationPoint(idRoad0, 9.0, 9L, JunctionPointCP))), geom0, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.Unchanged)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(9L,20L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0, GeometryUtils.geometryLength(geom1), SideCode.TowardsDigitizing, 0, (Some(ProjectCalibrationPoint(idRoad1, 0.0, 9L, JunctionPointCP)), None), geom1, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)      (RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, GeometryUtils.geometryLength(geom2), SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When giving links in one track with JunctionPointCP at the beginning and end Then JunctionPointCPs should be changed to RoadAddressCPs") {
    runWithRollback {
      ...
      val geom2 = Seq(Point(42, 19), Point(75, 29.2))
      val geom3 = Seq(Point(103.0, 15.0), Point(75, 29.2))
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange( 0L,  9L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, GeometryUtils.geometryLength(geom0), SideCode.TowardsDigitizing, 0, (Some(ProjectCalibrationPoint(idRoad0.toString, 0.0, 0L, JunctionPointCP)), None), geom0, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange( 9L, 20L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, GeometryUtils.geometryLength(geom1), SideCode.TowardsDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(20L, 30L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, GeometryUtils.geometryLength(geom2), SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, AddrMRange(30L, 40L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, GeometryUtils.geometryLength(geom3), SideCode.AgainstDigitizing, 0, (None, Some(ProjectCalibrationPoint(idRoad3.toString, GeometryUtils.geometryLength(geom3), 40L, JunctionPointCP))), geom3, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3)
      val ordered = ProjectSectionCalculator.assignAddrMValues(list)
  ...
  test("Test assignAddrMValues When track sections are combined to start from the same position Then tracks should still be different") {
    ...
    runWithRollback {
      ...
      val rwCombWithId = rwComb.copy(id = roadwayId, arealRoadMaintainer = arm)
  ...
  test("Test assignAddrMValues When giving unchanged + terminated links Then links should be calculated properly") {
    ...
    runWithRollback {
      ...
      val rwComb1WithId = rwComb1.copy(id = roadwayId,   arealRoadMaintainer = arm)
      val rwComb2WithId = rwComb2.copy(id = roadwayId+1, arealRoadMaintainer = arm)
      val rwComb3WithId = rwComb3.copy(id = roadwayId+2, arealRoadMaintainer = arm)
  ...
  test("Test assignAddrMValues When giving new + transfer links Then Project section calculator should assign values properly") {
    ...
    runWithRollback {
      ...
      val rwComb0WithId = rwComb0.copy(id = roadwayId,   arealRoadMaintainer = arm)
      val rwComb3WithId = rwComb3.copy(id = roadwayId+3, arealRoadMaintainer = arm)
  ...
  test("Test assignAddrMValues When there is a MinorDiscontinuity at end of address Then start of next one with 2 tracks (Left and Right) should also have calibration points, 4 in total") {
    runWithRollback{
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.MinorDiscontinuity, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0, 13.45, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15  ), Point( 41, 18  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 34.05, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point( 75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3, 0.0, 30.67, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point( 75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      ...
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad5, 0.0, 61.13, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   11  ), Point(103, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3, projectLink4, projectLink5)
      val ordered = ProjectSectionCalculator.assignAddrMValues(list)
  ...
  test("Test assignAddrMValues When there is a Discontinuity at end of address Then start of next one with 2 tracks (Left and Right) should also have calibration points, 4 in total") {
    runWithRollback {
      ...
      val idRoad5 = 5L.toString //   R>
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0, 0.0,  9.43, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point( 28, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.MinorDiscontinuity, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0, 13.60, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15  ), Point( 41, 18  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 35.97, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point( 75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3, 0.0, 30.89, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point( 75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      ...
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad5, 0.0, 61.61, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   11  ), Point(103, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3, projectLink4, projectLink5)
      val ordered = ProjectSectionCalculator.assignAddrMValues(list)
  ...
  test("Test assignAddrMValues When there is a MinorDiscontinuity at end of address Then start of next one with 1 track (Combined) should also have calibration points, 4 in total") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.MinorDiscontinuity, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0, 15.13, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15  ), Point(41, 18  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 37.18, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3, 0.0, 30.61, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3)
      val ordered = ProjectSectionCalculator.assignAddrMValues(list)
  ...
  test("Test assignAddrMValues When there is a Discontinuity at end of address Then start of next one with 1 track (Combined) should also have calibration points, 4 in total") {
    runWithRollback {
      ...
      val idRoad3 = 3L.toString //   C>
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0, 0.0,  9.43, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point(28, 15  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.MinorDiscontinuity, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0,  5.13, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15  ), Point(41, 18  )), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 37.18, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, RoadPart(5, 1), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3, 0.0, 30.61, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3)
      val ordered = ProjectSectionCalculator.assignAddrMValues(list)
 ...
 */
  test("Test assignAddrMValues When adding New link sections to the existing ones Then Direction for those should always be the same as the existing section (which are for e.g. Transfer, Unchanged, Numbering) making the addressMValues be sequential") {
    ...
    runWithRollback {
      ...
      val rwCombWithId = rwComb.copy(id = roadwayId, arealRoadMaintainer = arm)
      val rwLeft1And2WithId  =  rwLeft1.copy(id = roadwayId + 7, addrMRange = AddrMRange(projectLink3.addrMRange.start, projectLink5.addrMRange.end), arealRoadMaintainer = arm)
      val rwRight1And2WithId = rwRight1.copy(id = roadwayId + 8, addrMRange = AddrMRange(projectLink4.addrMRange.start, projectLink6.addrMRange.end), arealRoadMaintainer = arm)
  ...
  test("Test assignAddrMValues When adding New link sections with minor discontinuity to the existing ones Then Direction for those should always be the same as the existing section (which are for e.g. Transfer, Unchanged, Numbering) making the addressMValues be sequential") {
    ...
    runWithRollback {
      ...
      //NEW
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad0, 0.0, 14.1, SideCode.Unknown, 0, (None, None), Seq(Point( 0.0,  90.0), Point(10.0, 100.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined, Discontinuity.MinorDiscontinuity, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad1, 0.0, 22.3, SideCode.Unknown, 0, (None, None), Seq(Point(10.0, 100.0), Point(18.0,  78.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
      ...
      //NEW
      val projectLink7 = toProjectLink(rap, RoadAddressChangeType.New) (RoadAddress(idRoad7.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad7,  0.0, 14.14, SideCode.Unknown, 0, (None, None), Seq(Point(60.0, 30.0), Point(70.0, 40.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink8 = toProjectLink(rap, RoadAddressChangeType.New) (RoadAddress(idRoad8.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad8,  0.0, 14.14, SideCode.Unknown, 0, (None, None), Seq(Point(60.0, 20.0), Point(70.0, 30.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink9 = toProjectLink(rap, RoadAddressChangeType.New) (RoadAddress(idRoad9.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad9,  0.0, 14.14, SideCode.Unknown, 0, (None, None), Seq(Point(70.0, 40.0), Point(80.0, 50.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink10 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad10.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad10, 0.0, 22.36, SideCode.Unknown, 0, (None, None), Seq(Point(70.0, 30.0), Point(80.0, 50.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink11 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad11.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad11, 0.0, 14.14, SideCode.Unknown, 0, (None, None), Seq(Point(80.0, 50.0), Point(90.0, 60.0)), LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0)).copy(projectId = rap.id)
  ...
  test("Test assignAddrMValues When adding only New sections Then Direction for those should always be the same (on both Tracks) as the existing section (which are for e.g. Transfer, Unchanged, Numbering) making the addressMValues be sequential") {
    runWithRollback{
      ...
      //NEW
      val projectLink0  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad0,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(30.0,  0.0), Point(30.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad1,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(40.0,  0.0), Point(40.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      ...
      val projectLink4  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad4,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(40.0, 10.0), Point(30.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink5  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad5,  0.0, 20.0, SideCode.Unknown, 0, (None, None), Seq(Point(30.0, 10.0), Point(10.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      ...
      val projectLink7  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad7.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad7,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(10.0, 10.0), Point( 0.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test yet another assignAddrMValues When adding only New sections Then Direction for those should always be the same (on both Tracks) as the existing section (which are for e.g. Transfer, Unchanged, Numbering) making the addressMValues be sequential ") {
    runWithRollback{
      ...
      //NEW
      val projectLink0  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad0,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(10.0,  0.0), Point( 0.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink1  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad1,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(20.0,  0.0), Point(15.0, 10.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      ...
      val projectLink4  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad4,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(10.0, 20.0), Point(40.0, 30.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink5  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad5,  0.0, 20.0, SideCode.Unknown, 0, (None, None), Seq(Point(10.0, 20.0), Point(45.0, 25.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink6  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad6.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad6,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(40.0, 30.0), Point(50.0, 35.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink7  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad7.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad7,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(45.0, 25.0), Point(55.0, 30.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink8  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad8.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad8,  0.0, 20.0, SideCode.Unknown, 0, (None, None), Seq(Point(45.0, 25.0), Point(40.0, 30.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink9  = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad9.toLong,  0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad9,  0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(55.0, 30.0), Point(55.0, 35.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink10 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad10.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad10, 0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(40.0, 30.0), Point(30.0, 40.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink11 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad11.toLong, 0, RoadPart(5, 1), AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad11, 0.0, 10.0, SideCode.Unknown, 0, (None, None), Seq(Point(55.0, 35.0), Point(40.0, 50.0)), LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When having square MinorDiscontinuity links Then values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0,  89.0, SideCode.AgainstDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0,  89.7, SideCode.AgainstDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      ...
      val projectLink4 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12348L.toString, 0.0,  31.7, SideCode.AgainstDigitizing, 0, (None, None), geom4, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12349L.toString, 0.0,  17.3, SideCode.AgainstDigitizing, 0, (None, None), geom5, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink6 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad6.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.MinorDiscontinuity, AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12350L.toString, 0.0,  17.3, SideCode.AgainstDigitizing, 0, (None, None), geom6, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink7 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad7.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12351L.toString, 0.0,   8.7, SideCode.AgainstDigitizing, 0, (None, None), geom7, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink8 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad8.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Continuous,         AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12352L.toString, 0.0,  12.8, SideCode.AgainstDigitizing, 0, (None, None), geom8, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink9 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad9.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined,  Discontinuity.EndOfRoad,          AddrMRange(0L, 0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12353L.toString, 0.0, 308.9, SideCode.AgainstDigitizing, 0, (None, None), geom9, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When having triangular MinorDiscontinuity links Then values should be properly assigned") {
    runWithRollback {
      ...
      val raMap: Map[String, RoadAddress] = Map(
        idRoad1  -> RoadAddress(idRoad1.toLong,  linearLocationId +  1, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(  0L,   9L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0,  10.6,  SideCode.TowardsDigitizing, 0, (None, None), geom1,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  1),
        idRoad2  -> RoadAddress(idRoad2.toLong,  linearLocationId +  2, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(  9L,  38L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0,  33.55, SideCode.TowardsDigitizing, 0, (None, None), geom2,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  2),
        idRoad3  -> RoadAddress(idRoad3.toLong,  linearLocationId +  3, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.MinorDiscontinuity, AddrMRange( 38L,  52L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0,  16.22, SideCode.TowardsDigitizing, 0, (None, None), geom3,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  3),
        idRoad4  -> RoadAddress(idRoad4.toLong,  linearLocationId +  4, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange( 52L,  62L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12348L.toString, 0.0,  12.1,  SideCode.AgainstDigitizing, 0, (None, None), geom4,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  4),
        idRoad5  -> RoadAddress(idRoad5.toLong,  linearLocationId +  5, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange( 62L, 148L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12349L.toString, 0.0,  99.51, SideCode.AgainstDigitizing, 0, (None, None), geom5,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  5),
        idRoad6  -> RoadAddress(idRoad6.toLong,  linearLocationId +  6, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         AddrMRange(148L, 165L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12350L.toString, 0.0,  19.35, SideCode.AgainstDigitizing, 0, (None, None), geom6,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  6),
        idRoad7  -> RoadAddress(idRoad7.toLong,  linearLocationId +  7, RoadPart(5, 1), AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.MinorDiscontinuity, AddrMRange(165L, 224L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12351L.toString, 0.0,  68.66, SideCode.AgainstDigitizing, 0, (None, None), geom7,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  7),
        idRoad8  -> RoadAddress(idRoad8.toLong,  linearLocationId +  8, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange(  0L,  10L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12352L.toString, 0.0,  10.6,  SideCode.TowardsDigitizing, 0, (None, None), geom8,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  8),
        idRoad9  -> RoadAddress(idRoad9.toLong,  linearLocationId +  9, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange( 10L,  41L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12353L.toString, 0.0,  34.77, SideCode.TowardsDigitizing, 0, (None, None), geom9,  LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber +  9),
        idRoad10 -> RoadAddress(idRoad10.toLong, linearLocationId + 10, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange( 41L,  52L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12354L.toString, 0.0,  11.74, SideCode.TowardsDigitizing, 0, (None, None), geom10, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber + 10),
        idRoad11 -> RoadAddress(idRoad11.toLong, linearLocationId + 11, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange( 52L,  56L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12355L.toString, 0.0,   4.27, SideCode.TowardsDigitizing, 0, (None, None), geom11, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber + 11),
        idRoad12 -> RoadAddress(idRoad12.toLong, linearLocationId + 12, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange( 56L, 155L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12356L.toString, 0.0, 108.7,  SideCode.AgainstDigitizing, 0, (None, None), geom12, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber + 12),
        idRoad13 -> RoadAddress(idRoad13.toLong, linearLocationId + 13, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange(155L, 173L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12357L.toString, 0.0,  19.2,  SideCode.AgainstDigitizing, 0, (None, None), geom13, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber + 13),
        idRoad14 -> RoadAddress(idRoad14.toLong, linearLocationId + 14, RoadPart(5, 1), AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         AddrMRange(173L, 224L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12358L.toString, 0.0,  55.94, SideCode.AgainstDigitizing, 0, (None, None), geom14, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, roadwayNumber + 14)
      )
  ...
  test("Test assignAddrMValues When new link with discontinuity on both sides is added in the between of two other links Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        AddrMRange(10L, 20L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.TowardsDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity,AddrMRange( 0L, 10L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When new link with discontinuity on both sides is added in the between of two other links having calibration points at the beginning and end and discontinuity places Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        AddrMRange(10L, 20L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.TowardsDigitizing, 0, (Some(ProjectCalibrationPoint(12345L.toString, 0, 10L)), Some(ProjectCalibrationPoint(12345L.toString, 10.6, 20L))), geom1, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity,AddrMRange( 0L, 10L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (Some(ProjectCalibrationPoint(12346L.toString, 0,  0L)), Some(ProjectCalibrationPoint(12346L.toString, 11.2, 10L))), geom2, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When two new links with discontinuities are added before existing and transfer operation is done last Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = ProjectLink(plId + 1, roadPart, track, roadway1.discontinuity,          AddrMRange( 0L, 10L), roadway1.addrMRange,None, None, None, linkId1, linearLocation1.startMValue, linearLocation1.endMValue, linearLocation1.sideCode, (RoadAddressCP, RoadAddressCP), (RoadAddressCP, RoadAddressCP), linearLocation1.geometry, 0L, RoadAddressChangeType.Transfer, roadway1.administrativeClass, LinkGeomSource.apply(link1.source.intValue()), GeometryUtils.geometryLength(linearLocation1.geometry), roadway1.id, linearLocation1.id, ArealRoadMaintainer.ARMInvalid, roadway1.reversed, None, 86400L)
      val projectLink2 = ProjectLink(plId + 2, roadPart, track, Discontinuity.MinorDiscontinuity,AddrMRange( 0L, 10L), AddrMRange(0L, 0L), None, None, None, 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, ely14, reversed = false, None, 86400L)
      val projectLink3 = ProjectLink(plId + 3, roadPart, track, Discontinuity.Continuous,        AddrMRange(10L, 20L), AddrMRange(0L, 0L), None, None, None, 12347L.toString, 0.0, 12.3, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, ely14, reversed = false, None, 86400L)
  ...
  test("Test assignAddrMValues When new link with discontinuity on both sides is added in the between of two other links (against digitizing) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity,AddrMRange( 0L, 10L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.AgainstDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        AddrMRange(10L, 20L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.AgainstDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, RoadPart(5, 1), AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        AddrMRange( 0L,  0L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, ely8, NoTermination, 0))
  ...
  test("Test assignAddrMValues When new link with discontinuity on both sides is added in the between of two other links (against digitizing) (geom 2) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val track = Track.Combined
      val plId = Sequences.nextProjectLinkId
      val projectLink1 = ProjectLink(plId + 1, roadPart, track, Discontinuity.MinorDiscontinuity,AddrMRange( 0L, 10L), AddrMRange(0L, 0L), None, None, None, 12345L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, ArealRoadMaintainer.ARMInvalid, reversed = false, None, 86400L)
      val projectLink2 = ProjectLink(plId + 2, roadPart, track, Discontinuity.MinorDiscontinuity,AddrMRange( 0L, 10L), AddrMRange(0L, 0L), None, None, None, 12346L.toString, 0.0, 11.2, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, ArealRoadMaintainer.ARMInvalid, reversed = false, None, 86400L)
      val projectLink3 = ProjectLink(plId + 3, roadPart, track, Discontinuity.Continuous,        AddrMRange(10L, 20L), AddrMRange(0L, 0L), None, None, None, 12347L.toString, 0.0, 12.3, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, ArealRoadMaintainer.ARMInvalid, reversed = false, None, 86400L)
  ...
  test("Test assignAddrMValues When new link with discontinuity on both sides is added in the between of two other links (geom 2) Then the direction should stay same and new address values should be properly assigned") {
    ...
    runWithRollback {
      ...
      val track = Track.Combined
      val roadwayId1 = Sequences.nextRoadwayId
      val roadway1 = Roadway(roadwayId1, Sequences.nextRoadwayNumber, roadPart, administrativeClass, track, Discontinuity.MinorDiscontinuity, AddrMRange(0L, 10L), reversed = false, DateTime.parse("1901-01-01"), None, "tester", None, arm, NoTermination)
      roadwayDAO.create(Seq(roadway1))
      ...
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, roadPart, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous, AddrMRange(10L, 20L), Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, arm, NoTermination, 0))
