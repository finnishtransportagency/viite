...
class ProjectSectionCalculatorSpec extends FunSuite with Matchers {
  ...
  test("Test assignMValues When there is a MinorDiscontinuity at end of address Then start of next one with 1 track (Combined) should also have calibration points, 4 in total") {
    runWithRollback {
      ...
      val projectLink0 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad0.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point(28, 15  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15  ), Point(41, 18  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3)
      val ordered = ProjectSectionCalculator.assignMValues(list)
 ...
 */
  ...
  test("Test assignMValues When having square MinorDiscontinuity links Then values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0,  89.0, SideCode.AgainstDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0,  89.7, SideCode.AgainstDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0,  31.6, SideCode.AgainstDigitizing, 0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink4 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad4.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12348L.toString, 0.0,  31.7, SideCode.AgainstDigitizing, 0, (None, None), geom4, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad5.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12349L.toString, 0.0,  17.3, SideCode.AgainstDigitizing, 0, (None, None), geom5, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      ...
      val projectLink7 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad7.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12351L.toString, 0.0,   8.7, SideCode.AgainstDigitizing, 0, (None, None), geom7, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink8 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad8.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12352L.toString, 0.0,  12.8, SideCode.AgainstDigitizing, 0, (None, None), geom8, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink9 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad9.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined,  Discontinuity.EndOfRoad,          0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12353L.toString, 0.0, 308.9, SideCode.AgainstDigitizing, 0, (None, None), geom9, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links having calibration points at the beginning and end and discontinuity places Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.TowardsDigitizing, 0, (Some(CalibrationPoint(12345L.toString, 0, 10L)), Some(CalibrationPoint(12345L.toString, 10.6, 20L))), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (Some(CalibrationPoint(12346L.toString, 0,  0L)), Some(CalibrationPoint(12346L.toString, 11.2, 10L))), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,         0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None),                                                                                          geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When two new links with discontinuities are added before existing and transfer operation is done last Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink2 = ProjectLink(plId + 2, roadNumber, roadPartNumber, track, Discontinuity.MinorDiscontinuity, 0L, 10L, 0L, 0L, None, None, None, 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLink3 = ProjectLink(plId + 3, roadNumber, roadPartNumber, track, Discontinuity.Continuous,        10L, 20L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 12.3, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links (against digitizing) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.AgainstDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.AgainstDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,         0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links (against digitizing) (geom 2) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val track = Track.Combined
      val plId = Sequences.nextProjectLinkId
      val projectLink1 = ProjectLink(plId + 1, roadNumber, roadPartNumber, track, Discontinuity.MinorDiscontinuity, 0L, 10L, 0L, 0L, None, None, None, 12345L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLink2 = ProjectLink(plId + 2, roadNumber, roadPartNumber, track, Discontinuity.MinorDiscontinuity, 0L, 10L, 0L, 0L, None, None, None, 12346L.toString, 0.0, 11.2, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, 0, reversed = false, None, 86400L)
      val projectLink3 = ProjectLink(plId + 3, roadNumber, roadPartNumber, track, Discontinuity.Continuous,        10L, 20L, 0L, 0L, None, None, None, 12347L.toString, 0.0, 12.3, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.New, administrativeClass, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, 0, reversed = false, None, 86400L)
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links (geom 2) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink2 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad2, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous, 10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, RoadAddressChangeType.New)(RoadAddress(idRoad3, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,  0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
    ...
    runWithRollback {
      ...
      val projectLinkSeq = Seq(
        ProjectLink(plId + 1, 9999L, 1L, Track.Combined, Discontinuity.Continuous,   0L, 199L, 602L, 801L, None, None, None, 12345L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom1, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom1), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 2, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 199L, 298L, 503L, 602L, None, None, None, 12346L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom2, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom2), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 3, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 298L, 453L, 348L, 503L, None, None, None, 12347L.toString, 0.0, 10.0, SideCode.TowardsDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom3, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom3), 0L, 0, 0, reversed = true, None, 86400L),
        ...
        ProjectLink(plId + 5, 9999L, 1L, Track.Combined, Discontinuity.Continuous, 565L, 719L,  82L, 236L, None, None, None, 12349L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom5, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom5), 0L, 0, 0, reversed = true, None, 86400L),
        ProjectLink(plId + 6, 9999L, 1L, Track.Combined, Discontinuity.EndOfRoad,  719L, 801L,   0L,  82L, None, None, None, 12350L.toString, 0.0, 10.0, SideCode.AgainstDigitizing, (NoCP, NoCP), (NoCP, NoCP), geom6, 0L, RoadAddressChangeType.Transfer, AdministrativeClass.Municipality, LinkGeomSource.NormalLinkInterface, GeometryUtils.geometryLength(geom6), 0L, 0, 0, reversed = true, None, 86400L)
      )
  ...
  test("Test assignMValues " +
    ...
    runWithRollback {
      ...
      val projectLinkSeq = Seq(
        ...
        ProjectLink(newLinkId, roadNumber, roadPartNumber, Track.LeftSide,  Discontinuity.Continuous,         370,  513,    0,    0, None, None, None, 11892924.toString, 0.0,  138.999, SideCode.TowardsDigitizing, (RoadAddressCP, UserDefinedCP), (NoCP,          NoCP         ), List(Point(532.691, 10.0), Point( 671.69,   0.0)),                   project_id, RoadAddressChangeType.New,       AdministrativeClass.Municipality, LinkGeomSource.FrozenLinkInterface, 138.999,      0,      0, 9, false, None,                   1631228420000L, 335718220),
