...
class ProjectSectionCalculatorSpec extends FunSuite with Matchers {
  ...
  test("Test assignMValues When addressing calibration points and mixed directions Then values should be properly assigned") {
    runWithRollback {
      ...
      val idRoad3 = 3L //     <
      val projectLink0 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad0, 0, 5, 1, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  0.0), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1, 0, 5, 1, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point( 4.0,  7.5), Point(0.0,  9.8)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2, 0, 5, 1, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 4.0,  7.5), Point(6.0, 19.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3, 0, 5, 1, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(10.0, 15.0), Point(6.0, 19.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When giving incompatible digitization on tracks Then the direction of left track is corrected to match the right track") {
    runWithRollback {
      ...
      val projectLink0 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad0, 0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (Some(CalibrationPoint(0L.toString, 0.0, 0L)), None), Seq(Point(28, 9.8), Point(20.0, 10.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When giving links with different track lengths Then different track lengths are adjusted") {
    runWithRollback {
      ...
      val idRoad4 = 4L //   R>
      val idRoad5 = 5L //   R>
      val projectLink0 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad0, 0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point(28,  15  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1, 0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15),   Point(42,  19  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2, 0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19),   Point(75,  29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3, 0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point(75,  29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink4 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad4, 0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad4.toString, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point(42,  11  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When giving links in one track with JunctionPointCP at the beginning and end Then JunctionPointCPs should be changed to RoadAddressCPs") {
    runWithRollback {
      ...
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3, 0, 5, 1, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, 30L, 40L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3.toString, 0.0, GeometryUtils.geometryLength(geom3), SideCode.AgainstDigitizing, 0, (None, Some(CalibrationPoint(idRoad3.toString, GeometryUtils.geometryLength(geom3), 40L, JunctionPointCP))), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3)
      val ordered = ProjectSectionCalculator.assignMValues(list)
  ...
  test("Test assignMValues When track sections are combined to start from the same position Then tracks should still be different") {
    runWithRollback {
      ...
      val projectLink0 = toProjectLink(rap, LinkStatus.Unchanged)(RoadAddress(idRoad0.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, 0L, 8L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad0, 0.0, 8.0, SideCode.TowardsDigitizing, 0, (Some(CalibrationPoint(0L.toString, 0.0, 0L)), None), Seq(Point(20.0, 10.0), Point(28, 10)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(projectId = rap.id, roadwayId = roadwayId, linearLocationId = linearLocationId, roadwayNumber = roadwayNumber)
  ...
  test("Test assignMValues When giving created + unchanged links Then links should be calculated properly") {
    runWithRollback {
      ...
      val raMap: Map[String, RoadAddress] = Map(
        ...
        idRoad2 -> RoadAddress(idRoad2.toLong, linearLocationId + 1, 5, 1, AdministrativeClass.Unknown, Track.Combined, Discontinuity.Continuous, 9L, 19L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad2, 0.0, GeometryUtils.geometryLength(geom2), SideCode.TowardsDigitizing, 0, (None, Some(CalibrationPoint(idRoad2, 9.0, 19L, RoadAddressCP))), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber2),
  ...
  test("Test assignMValues When giving unchanged + terminated links Then links should be calculated properly") {
    runWithRollback {
      ...
      val list = List(projectLink0, projectLink1, projectLink2)
      val (_, unchanged) = list.partition(_.status == LinkStatus.Termination)
  ...
  test("Test assignMValues When there is a MinorDiscontinuity at end of address Then start of next one with 2 tracks (Left and Right) should also have calibration points, 4 in total") {
    runWithRollback{
      ...
      val idRoad4 = 4L.toString //   R>
      val idRoad5 = 5L.toString //   R>
      val projectLink0 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad0.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point( 28, 15  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      ...
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point( 75, 29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      ...
      val projectLink4 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad4.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.MinorDiscontinuity, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad4, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point( 42, 11  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When there is a Discontinuity at end of address Then start of next one with 2 tracks (Left and Right) should also have calibration points, 4 in total") {
    runWithRollback {
      ...
      val projectLink4 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad4.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad4, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point( 42, 11  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad5.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad5, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   11  ), Point(103, 15  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3, projectLink4, projectLink5)
      val ordered = ProjectSectionCalculator.assignMValues(list)
  ...
  test("Test assignMValues When there is a MinorDiscontinuity at end of address Then start of next one with 1 track (Combined) should also have calibration points, 4 in total") {
    runWithRollback {
      ...
      val projectLink0 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad0.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad0, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 20.0, 10.0), Point(28, 15  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad1, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 28,   15  ), Point(41, 18  )), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad2, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 42,   19  ), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), Some(DateTime.parse("1902-01-01")), Option("tester"), idRoad3, 0.0, 0.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(103.0, 15.0), Point(75, 29.2)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val list = List(projectLink0, projectLink1, projectLink2, projectLink3)
      val ordered = ProjectSectionCalculator.assignMValues(list)
...
//      val linearLocationId = Sequences.nextLinearLocationId
//
//      val projectLink1 = toProjectLink(rap, LinkStatus.UnChanged)(RoadAddress(idRoad1, 0, 5, 1, RoadType.Unknown, Track.Combined, Discontinuity.Continuous, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None),
...
//
//      val projectLink2 = toProjectLink(rap, LinkStatus.Transfer)(RoadAddress(idRoad2, 0, 5, 1, RoadType.Unknown, Track.RightSide, Discontinuity.Continuous, 0L, 12L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None),
...
//
//      val projectLink4 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad4, 0, 5, 1, RoadType.Unknown, Track.LeftSide, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None),
//        Seq(Point(3.0, 2.0), Point(5.0, 4.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(projectId = rap.id)
//      val projectLink5 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad5, 0, 5, 1, RoadType.Unknown, Track.LeftSide, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L, 0.0, 0.0, SideCode.AgainstDigitizing, 0, (None, None),
...
//  }
  ...
  test("Test assignTerminatedMValues When Terminating links on Left/Right tracks and different addrMValues Then they should be adjusted in order to have the same end address") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, LinkStatus.Unchanged)  (RoadAddress(testRoadway1.id, linearLocation1.id, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.Combined,  Discontinuity.Continuous, 0L,  50L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 50.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 5.0), Point( 50.0,  5.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, testRoadway1.roadwayNumber)).copy(roadAddressStartAddrM = Some( 0L), roadAddressEndAddrM = Some( 50L), roadAddressTrack = Some(Track.Combined))
      val projectLink2 = toProjectLink(rap, LinkStatus.Termination)(RoadAddress(testRoadway2.id, linearLocation2.id, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.EndOfRoad, 50L, 105L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 55.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(50.0, 5.0), Point(100.0, 10.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, testRoadway2.roadwayNumber)).copy(roadAddressStartAddrM = Some(50L), roadAddressEndAddrM = Some(105L), roadAddressTrack = Some(Track.RightSide))
      val projectLink3 = toProjectLink(rap, LinkStatus.Termination)(RoadAddress(testRoadway3.id, linearLocation3.id, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.EndOfRoad, 50L, 107L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 57.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(50.0, 5.0), Point(100.0,  0.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, testRoadway3.roadwayNumber)).copy(roadAddressStartAddrM = Some(50L), roadAddressEndAddrM = Some(107L), roadAddressTrack = Some(Track.LeftSide))
...
//  }
  ...
  test("Test assignTerminatedMValues When Terminating links on Left/Right tracks and different addrMValues Then both Unchanged links should be adjusted in order to have the same end address" +
    ...
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, LinkStatus.Unchanged)  (RoadAddress(roadwayId1, linearLocationId1, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, 0L,  50L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 50.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0, 10.0), Point( 50.0, 10.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(roadAddressStartAddrM = Some( 0L), roadAddressEndAddrM =
                          Some(50L), roadAddressTrack = Some(Track.RightSide))

      val projectLink2 = toProjectLink(rap, LinkStatus.Unchanged)  (RoadAddress(roadwayId2, linearLocationId2, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L,  52L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 52.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point( 0.0,  0.0), Point( 52.0,  0.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(roadAddressStartAddrM = Some( 0L), roadAddressEndAddrM =
                          Some(52L), roadAddressTrack = Some(Track.LeftSide))

      val projectLink3 = toProjectLink(rap, LinkStatus.Termination)(RoadAddress(roadwayId3, linearLocationId3, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.EndOfRoad, 50L, 105L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 55.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(50.0, 10.0), Point(100.0, 10.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(roadAddressStartAddrM = Some(50L), roadAddressEndAddrM =
                          Some(105L), roadAddressTrack = Some(Track.RightSide))

      val projectLink4 = toProjectLink(rap, LinkStatus.Termination)(RoadAddress(roadwayId4, linearLocationId4, roadNumber1, roadPartNumber1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.EndOfRoad, 52L, 109L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12348L.toString, 0.0, 57.0, SideCode.TowardsDigitizing, 0, (None, None), Seq(Point(52.0,  0.0), Point(102.0,  0.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(roadAddressStartAddrM = Some(50L), roadAddressEndAddrM =
 ...
 */
  test("Test assignMValues When adding New link sections to the existing ones Then Direction for those should always be the same as the existing section (which are for e.g. Transfer, Unchanged, Numbering) making the addressMValues be sequential") {
    runWithRollback {
      ...
      //NEW
      val projectLink7  = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad7.toLong,  0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad7,  0.0, 0.0, SideCode.Unknown, 0, (None, None), Seq(Point(60.0, 30.0), Point(70.0, 40.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink8  = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad8.toLong,  0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad8,  0.0, 0.0, SideCode.Unknown, 0, (None, None), Seq(Point(60.0, 20.0), Point(70.0, 30.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink9  = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad9.toLong,  0, 5, 1, AdministrativeClass.Unknown, Track.LeftSide,  Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad9,  0.0, 0.0, SideCode.Unknown, 0, (None, None), Seq(Point(70.0, 40.0), Point(80.0, 50.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(projectId = rap.id)
      val projectLink10 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad10.toLong, 0, 5, 1, AdministrativeClass.Unknown, Track.RightSide, Discontinuity.Continuous, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), idRoad10, 0.0, 0.0, SideCode.Unknown, 0, (None, None), Seq(Point(70.0, 30.0), Point(80.0, 50.0)), LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0)).copy(projectId = rap.id)
  ...
  test("Test assignMValues When having square MinorDiscontinuity links Then values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0,  89.0, SideCode.AgainstDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0,  89.7, SideCode.AgainstDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0,  31.6, SideCode.AgainstDigitizing, 0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink4 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad4.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12348L.toString, 0.0,  31.7, SideCode.AgainstDigitizing, 0, (None, None), geom4, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink5 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad5.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12349L.toString, 0.0,  17.3, SideCode.AgainstDigitizing, 0, (None, None), geom5, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink6 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad6.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.MinorDiscontinuity, 0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12350L.toString, 0.0,  17.3, SideCode.AgainstDigitizing, 0, (None, None), geom6, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink7 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad7.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12351L.toString, 0.0,   8.7, SideCode.AgainstDigitizing, 0, (None, None), geom7, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink8 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad8.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined,  Discontinuity.Continuous,         0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12352L.toString, 0.0,  12.8, SideCode.AgainstDigitizing, 0, (None, None), geom8, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink9 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad9.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined,  Discontinuity.EndOfRoad,          0L, 0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12353L.toString, 0.0, 308.9, SideCode.AgainstDigitizing, 0, (None, None), geom9, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When having triangular MinorDiscontinuity links Then values should be properly assigned") {
    runWithRollback {
      ...
      val raMap: Map[String, RoadAddress] = Map(
        idRoad1  -> RoadAddress(idRoad1.toLong,  linearLocationId +  1, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,          0L,    9L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0,  10.6,  SideCode.TowardsDigitizing, 0, (None, None), geom1,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  1),
        idRoad2  -> RoadAddress(idRoad2.toLong,  linearLocationId +  2, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,          9L,   38L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0,  33.55, SideCode.TowardsDigitizing, 0, (None, None), geom2,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  2),
        idRoad3  -> RoadAddress(idRoad3.toLong,  linearLocationId +  3, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.MinorDiscontinuity, 38L,   52L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0,  16.22, SideCode.TowardsDigitizing, 0, (None, None), geom3,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  3),
        idRoad4  -> RoadAddress(idRoad4.toLong,  linearLocationId +  4, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,          52L,  62L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12348L.toString, 0.0,  12.1,  SideCode.AgainstDigitizing, 0, (None, None), geom4,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  4),
        idRoad5  -> RoadAddress(idRoad5.toLong,  linearLocationId +  5, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,          62L, 148L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12349L.toString, 0.0,  99.51, SideCode.AgainstDigitizing, 0, (None, None), geom5,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  5),
        idRoad6  -> RoadAddress(idRoad6.toLong,  linearLocationId +  6, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.Continuous,         148L, 165L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12350L.toString, 0.0,  19.35, SideCode.AgainstDigitizing, 0, (None, None), geom6,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  6),
        idRoad7  -> RoadAddress(idRoad7.toLong,  linearLocationId +  7, 5, 1, AdministrativeClass.Municipality, Track.LeftSide,  Discontinuity.MinorDiscontinuity, 165L, 224L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12351L.toString, 0.0,  68.66, SideCode.AgainstDigitizing, 0, (None, None), geom7,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  7),
        idRoad8  -> RoadAddress(idRoad8.toLong,  linearLocationId +  8, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,           0L,  10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12352L.toString, 0.0,  10.6,  SideCode.TowardsDigitizing, 0, (None, None), geom8,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  8),
        idRoad9  -> RoadAddress(idRoad9.toLong,  linearLocationId +  9, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,          10L,  41L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12353L.toString, 0.0,  34.77, SideCode.TowardsDigitizing, 0, (None, None), geom9,  LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber +  9),
        idRoad10 -> RoadAddress(idRoad10.toLong, linearLocationId + 10, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,          41L,  52L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12354L.toString, 0.0,  11.74, SideCode.TowardsDigitizing, 0, (None, None), geom10, LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber + 10),
        idRoad11 -> RoadAddress(idRoad11.toLong, linearLocationId + 11, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,          52L,  56L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12355L.toString, 0.0,   4.27, SideCode.TowardsDigitizing, 0, (None, None), geom11, LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber + 11),
        idRoad12 -> RoadAddress(idRoad12.toLong, linearLocationId + 12, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,          56L, 155L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12356L.toString, 0.0, 108.7,  SideCode.AgainstDigitizing, 0, (None, None), geom12, LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber + 12),
        idRoad13 -> RoadAddress(idRoad13.toLong, linearLocationId + 13, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         155L, 173L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12357L.toString, 0.0,  19.2,  SideCode.AgainstDigitizing, 0, (None, None), geom13, LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber + 13),
        idRoad14 -> RoadAddress(idRoad14.toLong, linearLocationId + 14, 5, 1, AdministrativeClass.Municipality, Track.RightSide, Discontinuity.Continuous,         173L, 224L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12358L.toString, 0.0,  55.94, SideCode.AgainstDigitizing, 0, (None, None), geom14, LinkGeomSource.NormalLinkInterface, 8, NoTermination, roadwayNumber + 14)
      )
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.TowardsDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,         0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links having calibration points at the beginning and end and discontinuity places Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.TowardsDigitizing, 0, (Some(CalibrationPoint(12345L.toString, 0, 10L)), Some(CalibrationPoint(12345L.toString, 10.6, 20L))), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (Some(CalibrationPoint(12346L.toString, 0,  0L)), Some(CalibrationPoint(12346L.toString, 11.2, 10L))), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,         0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None),                                                                                          geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links (against digitizing) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val projectLink1 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad1.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.MinorDiscontinuity, 0L, 10L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12345L.toString, 0.0, 10.6, SideCode.AgainstDigitizing, 0, (None, None), geom1, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,        10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.AgainstDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3.toLong, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,         0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
  ...
  test("Test assignMValues When new link with discontinuity on both sides is added in the between of two other links (geom 2) Then the direction should stay same and new address values should be properly assigned") {
    runWithRollback {
      ...
      val track = Track.Combined
      val roadwayId1 = Sequences.nextRoadwayId
      val roadway1 = Roadway(roadwayId1, Sequences.nextRoadwayNumber, roadNumber, roadPartNumber, administrativeClass, track, Discontinuity.MinorDiscontinuity, 0L, 10L, reversed = false, DateTime.parse("1901-01-01"), None, "tester", None, 8, NoTermination)
      roadwayDAO.create(Seq(roadway1))
      ...
      val projectLink2 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad2, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous, 10L, 20L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12346L.toString, 0.0, 11.2, SideCode.TowardsDigitizing, 0, (None, None), geom2, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
      val projectLink3 = toProjectLink(rap, LinkStatus.New)(RoadAddress(idRoad3, 0, 5, 1, AdministrativeClass.Municipality, Track.Combined, Discontinuity.Continuous,  0L,  0L, Some(DateTime.parse("1901-01-01")), None, Option("tester"), 12347L.toString, 0.0, 12.3, SideCode.Unknown,           0, (None, None), geom3, LinkGeomSource.NormalLinkInterface, 8, NoTermination, 0))
