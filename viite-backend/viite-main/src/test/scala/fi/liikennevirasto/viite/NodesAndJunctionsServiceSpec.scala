...
import fi.vaylavirasto.viite.model.{RoadAddressChangeType, AdministrativeClass, BeforeAfter, Discontinuity, LinkGeomSource, LinkStatus, NodePointType, NodeType, SideCode, Track}
