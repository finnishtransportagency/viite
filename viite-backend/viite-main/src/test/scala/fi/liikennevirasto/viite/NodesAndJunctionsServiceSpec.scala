...
import fi.vaylavirasto.viite.model.{AdministrativeClass, BeforeAfter, Discontinuity, LinkGeomSource, RoadAddressChangeType, NodePointType, NodeType, SideCode, Track}
