...
import fi.vaylavirasto.viite.model.{AddrMRange, AdministrativeClass, ArealRoadMaintainer, CalibrationPoint, CalibrationPointLocation, CalibrationPointType, Discontinuity, LinkGeomSource, RoadPart, SideCode, Track}
...
class RoadNetworkDAOSpec extends AnyFunSuite with Matchers {
 ...
 private val testRoadway1 = Roadway(NewIdValue, roadwayNumber1, roadPart, AdministrativeClass.State, Track.Combined, Discontinuity.Continuous,   AddrMRange(0, 100), reversed = false, DateTime.parse("2000-01-01"), None, "test", Some("TEST ROAD 1"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
 ...
 test("Test When there are two rows of roadways with same roadway number at the same time period with different address values Then identify them") {
   runWithRollback {
     ...
     val roadway1 = Roadway(NewIdValue, roadwayNumber, roadPart,  AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(  0, 100), reversed = false, DateTime.parse("2000-01-01"), None, "test", Some("TEST ROAD 1"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     val roadway2 = Roadway(NewIdValue, roadwayNumber, roadPart,  AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(150, 200), reversed = false, DateTime.parse("2000-01-01"), None, "test", Some("TEST ROAD 1"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
 ...
 test("Test When there are overlapping roadway rows Then Identify them") {
   runWithRollback {
     val roadPart = RoadPart(10, 1)
     val roadway1 = Roadway(NewIdValue, Sequences.nextRoadwayNumber, roadPart, AdministrativeClass.State, Track.Combined,  Discontinuity.Continuous, AddrMRange(1069, 6890), reversed = false, DateTime.parse("1965-01-01"), Some(DateTime.parse("2008-11-14")), "test", Some("TEST ROAD 1"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     val roadway2 = Roadway(NewIdValue, Sequences.nextRoadwayNumber, roadPart, AdministrativeClass.State, Track.RightSide, Discontinuity.Continuous, AddrMRange(5390, 6265), reversed = false, DateTime.parse("2008-01-28"), Some(DateTime.parse("2009-01-27")), "test", Some("TEST ROAD 1"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
 ...
 test("Test When there are overlapping roadways on linear locations Then identify them") {
   runWithRollback {
     ...
     val roadway1 = Roadway(Sequences.nextRoadwayId, roadwayNumber,  RoadPart(roadNumber,  roadPartNumber), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(1000, 1288), reversed = false, DateTime.parse("1965-01-01"), Some(DateTime.parse("2008-11-14")), "test", Some("TEST ROAD 1"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
     val roadway2 = Roadway(Sequences.nextRoadwayId, roadwayNumber3, RoadPart(roadNumber2, roadPartNumber), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(   0,  288), reversed = false, DateTime.parse("2022-01-01"), None, "test", Some("TEST ROAD 2"), 1, ArealRoadMaintainer.getEVK(1), TerminationCode.NoTermination)
 ...
 test("Test When there are extra calibration points Then identify them") {
   runWithRollback {
     ...
     roadwayDAO.create(Seq(
       Roadway(Sequences.nextRoadwayId, roadwayNumber1, roadPart, AdministrativeClass.State, Track.Combined,Discontinuity.Continuous, AddrMRange(  0, 100), false, DateTime.now().minusDays(1), None, "test", Some("Test road"), 9, ArealRoadMaintainer.getEVK(9),TerminationCode.NoTermination, DateTime.now().minusDays(1),None),
       Roadway(Sequences.nextRoadwayId, roadwayNumber2, roadPart, AdministrativeClass.State, Track.Combined,Discontinuity.Continuous, AddrMRange(100, 150), false, DateTime.now().minusDays(1), None, "test", Some("Test road"), 9, ArealRoadMaintainer.getEVK(9), TerminationCode.NoTermination, DateTime.now().minusDays(1),None),
       Roadway(Sequences.nextRoadwayId, roadwayNumber3, roadPart, AdministrativeClass.State, Track.Combined,Discontinuity.EndOfRoad,  AddrMRange(150, 200), false, DateTime.now().minusDays(1), None, "test", Some("Test road"), 9, ArealRoadMaintainer.getEVK(9), TerminationCode.NoTermination, DateTime.now().minusDays(1),None)
     ))
