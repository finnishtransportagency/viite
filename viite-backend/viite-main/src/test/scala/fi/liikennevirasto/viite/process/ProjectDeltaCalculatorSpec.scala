...
import fi.vaylavirasto.viite.model.{AdministrativeClass, Discontinuity, LinkGeomSource, RoadAddressChangeType, RoadPart, Track}
...
class ProjectDeltaCalculatorSpec extends FunSuite with Matchers {
  ...
  test("Test ProjectDeltaCalculator.partition When executing a Unchanged and 2 transfer on single road part Then returns the correct From RoadSection -> To RoadSection mapping.") {
    runWithRollback {
      ...
      val addresses2 = (11 to 21).map(i => {
        ...
        a.copy(roadPart = RoadPart(a.roadPart.roadNumber, 206), startAddrMValue = a.startAddrMValue - 110L, endAddrMValue = a.endAddrMValue - 110L)
      })
      val (transferLinks1, transferLinks2) = addresses2.map(toTransition(project, RoadAddressChangeType.Transfer)).partition(_._2.startAddrMValue == 0L)
      val projectLinks                     = addresses.map(toTransition (project, RoadAddressChangeType.Unchanged)) ++ transferLinks1.map(l => {
        (l._1, l._2.copy(roadPart = RoadPart(l._2.roadPart.roadNumber, 205), startAddrMValue = 110L, endAddrMValue = 120L))
  ...
  test("Test ProjectDeltaCalculator.partition " +
    ...
    def toProjectLinks(transferLinks: IndexedSeq[(RoadAddress, ProjectLink)], track: Track)(implicit addresses: Seq[RoadAddress]): IndexedSeq[ProjectLink] = {
      ...
      transferLinks.map(l => {
        l._2.copy(track = track, startAddrMValue = addresses.max.endAddrMValue - l._2.endAddrMValue, endAddrMValue = addresses.max.endAddrMValue - l._2.startAddrMValue, roadwayId = roadwayId, reversed = true)
      })
    }
    runWithRollback {
      val distance = 10L
  ...
  test("Test ProjectDeltaCalculator.partition " +
    ...
    runWithRollback {
      ...
      val allProjectLinks = Seq(
        ProjectLink(1000,roadPart,Track.Combined,Discontinuity.Continuous,   0,  18,   0,  18,None,None,Some(createdBy),  243576.toString,  0.0  , 17.829,AgainstDigitizing,(JunctionPointCP,NoCP),(JunctionPointCP,NoCP),List(Point(418449.0,7069399.0,0.0), Point(418450.0,7069417.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface, 17.829,30920,258599,12,false,None,1633993775000L,335718902,roadName,None,None,None,None),
        ProjectLink(1001,roadPart,Track.Combined,Discontinuity.Continuous,  18,  81,  18,  81,None,None,Some(createdBy),  243612.toString,  0.0  , 63.291,AgainstDigitizing,(NoCP,           NoCP),(NoCP,           NoCP),List(Point(418453.0,7069336.0,0.0), Point(418449.0,7069399.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface, 63.291,30920,258600,12,false,None,1633993775000L,335718902,roadName,None,None,None,None),
        ProjectLink(1002,roadPart,Track.Combined,Discontinuity.Continuous,   0, 143,   0, 143,None,None,Some(createdBy),  247382.toString,  0.0  ,142.727,TowardsDigitizing,(RoadAddressCP,  NoCP),(JunctionPointCP,NoCP),List(Point(416275.0,7065372.0,0.0), Point(416398.0,7065442.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,142.727,30701,255183,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1003,roadPart,Track.Combined,Discontinuity.Continuous, 143, 193, 143, 193,None,None,Some(createdBy),  247385.toString,  0.0  , 49.552,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416398.0,7065442.0,0.0), Point(416430.0,7065479.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 49.552,30701,255184,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1004,roadPart,Track.Combined,Discontinuity.Continuous,  81, 209,  81, 209,None,None,Some(createdBy),  243607.toString,  0.0  ,127.544,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418468.0,7069209.0,0.0), Point(418453.0,7069336.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface,127.544,30920,258601,12,false,None,1446398762000L,335718902,roadName,None,None,None,None),
        ProjectLink(1005,roadPart,Track.Combined,Discontinuity.Continuous, 209, 322, 209, 322,None,None,Some(createdBy),  243603.toString,  0.0  ,113.171,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418489.0,7069098.0,0.0), Point(418468.0,7069209.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface,113.171,30920,258602,12,false,None,1446398762000L,335718902,roadName,None,None,None,None),
        ProjectLink(1006,roadPart,Track.Combined,Discontinuity.Continuous, 193, 439, 193, 439,None,None,Some(createdBy),  247383.toString,  0.0  ,245.943,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416430.0,7065479.0,0.0), Point(416543.0,7065698.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,245.943,30701,255185,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1007,roadPart,Track.Combined,Discontinuity.Continuous, 439, 483, 439, 483,None,None,Some(createdBy),  247373.toString,  0.0  , 44.291,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416543.0,7065698.0,0.0), Point(416564.0,7065737.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 44.291,30701,255186,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1008,roadPart,Track.Combined,Discontinuity.Continuous, 483, 512, 483, 512,None,None,Some(createdBy),  247371.toString,  0.0  , 28.553,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416564.0,7065737.0,0.0), Point(416576.0,7065763.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 28.553,30701,255187,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1009,roadPart,Track.Combined,Discontinuity.Continuous, 512, 541, 512, 541,None,None,Some(createdBy),  247369.toString,  0.0  , 29.658,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416576.0,7065763.0,0.0), Point(416590.0,7065789.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 29.658,30701,255188,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1010,roadPart,Track.Combined,Discontinuity.Continuous, 541, 570, 541, 570,None,None,Some(createdBy),  247367.toString,  0.0  , 28.408,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416590.0,7065789.0,0.0), Point(416603.0,7065814.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 28.408,30701,255189,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1011,roadPart,Track.Combined,Discontinuity.Continuous, 570, 682, 570, 682,None,None,Some(createdBy),  247366.toString,  0.0  ,111.875,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416603.0,7065814.0,0.0), Point(416654.0,7065914.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,111.875,30701,255190,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1012,roadPart,Track.Combined,Discontinuity.Continuous, 682, 747, 682, 747,None,None,Some(createdBy),10949305.toString,  0.0  , 64.611,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416654.0,7065914.0,0.0), Point(416684.0,7065971.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 64.611,30701,255191,12,false,None,1537225220000L,    64686,roadName,None,None,None,None),
        ProjectLink(1013,roadPart,Track.Combined,Discontinuity.Continuous, 322, 762, 322, 762,None,None,Some(createdBy),  246868.toString,  0.0  ,438.103,AgainstDigitizing,(NoCP,JunctionPointCP),(NoCP,JunctionPointCP),List(Point(418647.0,7068691.0,0.0), Point(418489.0,7069098.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface,438.103,30920,258603,12,false,None,1491001212000L,335718902,roadName,None,None,None,None),
        ProjectLink(1014,roadPart,Track.Combined,Discontinuity.Continuous, 747, 838, 747, 838,None,None,Some(createdBy),  247328.toString,  0.0  , 90.718,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416684.0,7065971.0,0.0), Point(416725.0,7066052.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 90.718,30701,255192,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1015,roadPart,Track.Combined,Discontinuity.Continuous, 838,1000, 838,1000,None,None,Some(createdBy),  247320.toString,  0.0  ,161.88 ,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416725.0,7066052.0,0.0), Point(416798.0,7066196.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,161.88 ,30701,255193,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1016,roadPart,Track.Combined,Discontinuity.Continuous,1000,1049,1000,1049,None,None,Some(createdBy),  247322.toString,  0.0  , 49.105,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416798.0,7066196.0,0.0), Point(416821.0,7066240.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 49.105,30701,255194,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1017,roadPart,Track.Combined,Discontinuity.Continuous,1049,1128,1049,1128,None,None,Some(createdBy),  247304.toString,  0.0  , 79.434,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416821.0,7066240.0,0.0), Point(416857.0,7066311.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 79.434,30701,255195,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1018,roadPart,Track.Combined,Discontinuity.Continuous,1128,1168,1128,1168,None,None,Some(createdBy),  247312.toString,  0.0  , 39.837,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416857.0,7066311.0,0.0), Point(416875.0,7066346.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 39.837,30701,255196,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1019,roadPart,Track.Combined,Discontinuity.Continuous,1168,1346,1168,1346,None,None,Some(createdBy),  247308.toString,  0.0  ,177.111,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416875.0,7066346.0,0.0), Point(416955.0,7066504.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,177.111,30701,255197,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1020,roadPart,Track.Combined,Discontinuity.Continuous,1346,1388,1346,1388,None,None,Some(createdBy), 7492578.toString,  0.0  , 42.837,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416955.0,7066504.0,0.0), Point(416974.0,7066543.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 42.837,30701,255198,12,false,None,1510836157000L,    64686,roadName,None,None,None,None),
        ProjectLink(1021,roadPart,Track.Combined,Discontinuity.Continuous,1388,1465,1388,1465,None,None,Some(createdBy), 7492577.toString,  0.0  , 76.487,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416974.0,7066543.0,0.0), Point(417009.0,7066611.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 76.487,30701,255199,12,false,None,1510836157000L,    64686,roadName,None,None,None,None),
        ProjectLink(1022,roadPart,Track.Combined,Discontinuity.Continuous,1465,1618,1465,1618,None,None,Some(createdBy),  247301.toString,  0.0  ,153.109,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417009.0,7066611.0,0.0), Point(417078.0,7066747.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,153.109,30701,255200,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1023,roadPart,Track.Combined,Discontinuity.Continuous,1618,1812,1618,1812,None,None,Some(createdBy),  247295.toString,  0.0  ,193.047,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417078.0,7066747.0,0.0), Point(417166.0,7066919.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,193.047,30701,255201,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1024,roadPart,Track.Combined,Discontinuity.Continuous,1812,1964,1812,1964,None,None,Some(createdBy),  247288.toString,  0.0  ,151.899,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417166.0,7066919.0,0.0), Point(417235.0,7067054.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,151.899,30701,255202,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1025,roadPart,Track.Combined,Discontinuity.Continuous,1964,2006,1964,2006,None,None,Some(createdBy),  247140.toString,  0.0  , 42.223,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417235.0,7067054.0,0.0), Point(417254.0,7067092.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 42.223,30701,255203,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1026,roadPart,Track.Combined,Discontinuity.Continuous,2006,2334,2006,2334,None,None,Some(createdBy),  246927.toString,  0.0  ,327.804,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417254.0,7067092.0,0.0), Point(417402.0,7067385.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,327.804,30701,255204,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1027,roadPart,Track.Combined,Discontinuity.Continuous,2334,2484,2334,2484,None,None,Some(createdBy),  247016.toString,  0.0  ,149.69 ,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417402.0,7067385.0,0.0), Point(417468.0,7067519.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,149.69 ,30701,255205,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1028,roadPart,Track.Combined,Discontinuity.Continuous,2484,2568,2484,2568,None,None,Some(createdBy),  246989.toString,  0.0  , 83.589,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417468.0,7067519.0,0.0), Point(417502.0,7067595.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 83.589,30701,255206,12,false,None,1446398762000L,    64686,roadName,None,None,None,None),
        ProjectLink(1029,roadPart,Track.Combined,Discontinuity.Continuous,2568,2569,2568,2569,None,None,Some(createdBy),  246989.toString, 83.589, 84.596,TowardsDigitizing,(NoCP,JunctionPointCP),(NoCP,JunctionPointCP),List(Point(417502.0,7067595.0,0.0), Point(417502.0,7067596.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,  1.007,30993,259608,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1030,roadPart,Track.Combined,Discontinuity.Continuous,2569,2715,2569,2715,None,None,Some(createdBy),  246999.toString,  0.0  ,145.708,TowardsDigitizing,(JunctionPointCP,NoCP),(JunctionPointCP,NoCP),List(Point(417502.0,7067596.0,0.0), Point(417501.0,7067731.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,145.708,30993,259609,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1031,roadPart,Track.Combined,Discontinuity.Continuous,2715,2757,2715,2757,None,None,Some(createdBy),  246997.toString,  0.0  , 41.556,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417501.0,7067731.0,0.0), Point(417497.0,7067772.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 41.556,30993,259610,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1032,roadPart,Track.Combined,Discontinuity.Continuous,2757,2875,2757,2875,None,None,Some(createdBy),  246995.toString,  0.0  ,117.846,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417497.0,7067772.0,0.0), Point(417504.0,7067890.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,117.846,30993,259611,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1033,roadPart,Track.Combined,Discontinuity.Continuous,2875,2881,2875,2881,None,None,Some(createdBy),  246949.toString,  0.0  ,  6.251,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417504.0,7067890.0,0.0), Point(417504.0,7067896.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,  6.251,30993,259612,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1034,roadPart,Track.Combined,Discontinuity.Continuous,2881,2963,2881,2963,None,None,Some(createdBy),  246945.toString,  0.0  , 82.163,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417504.0,7067896.0,0.0), Point(417509.0,7067978.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 82.163,30993,259613,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1035,roadPart,Track.Combined,Discontinuity.Continuous,2963,3023,2963,3023,None,None,Some(createdBy),  246948.toString,  0.0  , 60.1  ,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417509.0,7067978.0,0.0), Point(417513.0,7068038.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 60.1  ,30993,259614,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1036,roadPart,Track.Combined,Discontinuity.Continuous,3023,3039,3023,3039,None,None,Some(createdBy),  246944.toString,  0.0  , 15.151,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417513.0,7068038.0,0.0), Point(417519.0,7068052.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 15.151,30993,259615,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1037,roadPart,Track.Combined,Discontinuity.Continuous,3039,3146,3039,3146,None,None,Some(createdBy),  246932.toString,  0.0  ,107.314,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417519.0,7068052.0,0.0), Point(417609.0,7068111.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,107.314,30993,259616,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1038,roadPart,Track.Combined,Discontinuity.Continuous,3146,3280,3146,3280,None,None,Some(createdBy),  246939.toString,  0.0  ,134.064,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417609.0,7068111.0,0.0), Point(417715.0,7068193.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,134.064,30993,259617,12,false,None,1491001212000L,    64687,roadName,None,None,None,None),
        ProjectLink(1039,roadPart,Track.Combined,Discontinuity.Continuous,3280,3317,3280,3317,None,None,Some(createdBy),  246940.toString,  0.0  , 37.065,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417715.0,7068193.0,0.0), Point(417745.0,7068215.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 37.065,30993,259618,12,false,None,1491001212000L,    64687,roadName,None,None,None,None),
        ProjectLink(1040,roadPart,Track.Combined,Discontinuity.Continuous,3317,3423,3317,3423,None,None,Some(createdBy),  246935.toString,  0.0  ,105.728,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417745.0,7068215.0,0.0), Point(417845.0,7068247.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,105.728,30993,259619,12,false,None,1491001212000L,    64687,roadName,None,None,None,None),
        ProjectLink(1041,roadPart,Track.Combined,Discontinuity.Continuous,3423,3841,3423,3841,None,None,Some(createdBy),  246930.toString,  0.0  ,417.176,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(417845.0,7068247.0,0.0), Point(418154.0,7068482.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,417.176,30993,259620,12,false,None,1491001212000L,    64687,roadName,None,None,None,None),
        ProjectLink(1042,roadPart,Track.Combined,Discontinuity.Continuous,3841,4033,3841,4033,None,None,Some(createdBy),  246913.toString,  0.0  ,191.134,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418154.0,7068482.0,0.0), Point(418292.0,7068607.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,191.134,30993,259621,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1043,roadPart,Track.Combined,Discontinuity.Continuous,4033,4111,4033,4111,None,None,Some(createdBy),  246920.toString,  0.0  , 78.189,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418292.0,7068607.0,0.0), Point(418364.0,7068638.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 78.189,30993,259622,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1044,roadPart,Track.Combined,Discontinuity.Continuous,4111,4337,4111,4337,None,None,Some(createdBy),  246919.toString,  0.0  ,225.819,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418364.0,7068638.0,0.0), Point(418583.0,7068677.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,225.819,30993,259623,12,false,None,1481324409000L,    64687,roadName,None,None,None,None),
        ProjectLink(1045,roadPart,Track.Combined,Discontinuity.Continuous,4337,4385,4337,4385,None,None,Some(createdBy),  246898.toString,  0.0  , 47.536,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418583.0,7068677.0,0.0), Point(418630.0,7068684.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 47.536,30993,259624,12,false,None,1446398762000L,    64687,roadName,None,None,None,None),
        ProjectLink(1046,roadPart,Track.Combined,Discontinuity.Continuous,4385,4403,4385,4403,None,None,Some(createdBy),  246900.toString,  0.0  , 18.108,TowardsDigitizing,(NoCP,JunctionPointCP),(NoCP,JunctionPointCP),List(Point(418630.0,7068684.0,0.0), Point(418647.0,7068691.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 18.108,30993,259625,12,false,None,1491001212000L,    64687,roadName,None,None,None,None),
        ProjectLink(1047,roadPart,Track.Combined,Discontinuity.Continuous,4403,4486, 762, 845,None,None,Some(createdBy),  246893.toString,  0.0  , 82.953,AgainstDigitizing,(JunctionPointCP,NoCP),(JunctionPointCP,NoCP),List(Point(418688.0,7068619.0,0.0), Point(418647.0,7068691.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 82.953,30920,258604,12,false,None,1491001212000L,335718897,roadName,None,None,None,None),
        ProjectLink(1048,roadPart,Track.Combined,Discontinuity.Continuous,4486,4532, 845, 891,None,None,Some(createdBy),  246903.toString,  0.0  , 46.06 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418711.0,7068579.0,0.0), Point(418688.0,7068619.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 46.06 ,30920,258605,12,false,None,1491001212000L,335718897,roadName,None,None,None,None),
        ProjectLink(1049,roadPart,Track.Combined,Discontinuity.Continuous,4532,4623, 891, 982,None,None,Some(createdBy),  246895.toString,  0.0  , 90.05 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418756.0,7068501.0,0.0), Point(418711.0,7068579.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 90.05 ,30920,258606,12,false,None,1491001212000L,335718897,roadName,None,None,None,None),
        ProjectLink(1050,roadPart,Track.Combined,Discontinuity.Continuous,4623,4705, 982,1064,None,None,Some(createdBy),  246905.toString,  0.0  , 82.11 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418795.0,7068428.0,0.0), Point(418756.0,7068501.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 82.11 ,30920,258607,12,false,None,1491001212000L,335718897,roadName,None,None,None,None),
        ProjectLink(1051,roadPart,Track.Combined,Discontinuity.Continuous,4705,4866,1064,1225,None,None,Some(createdBy),  247023.toString,  0.0  ,160.277,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418854.0,7068280.0,0.0), Point(418795.0,7068428.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,160.277,30920,258608,12,false,None,1491001212000L,335718897,roadName,None,None,None,None),
        ProjectLink(1052,roadPart,Track.Combined,Discontinuity.Continuous,4866,5039,1225,1398,None,None,Some(createdBy),10954075.toString,  0.0  ,172.775,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418908.0,7068115.0,0.0), Point(418854.0,7068280.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,172.775,30920,258609,12,false,None,1537230701000L,335718897,roadName,None,None,None,None),
        ProjectLink(1053,roadPart,Track.Combined,Discontinuity.Continuous,5039,5041,1398,1400,None,None,Some(createdBy),10954076.toString,108.116,110.118,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418908.0,7068113.0,0.0), Point(418908.0,7068115.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,  2.002,30920,258610,12,false,None,1537230701000L,335718897,roadName,None,None,None,None),
        ProjectLink(1054,roadPart,Track.Combined,Discontinuity.Continuous,5041,5149,1400,1508,None,None,Some(createdBy),10954076.toString,  0.0  ,108.116,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418941.0,7068010.0,0.0), Point(418908.0,7068113.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,108.116,31341,265145,12,false,None,1537230701000L,    64356,roadName,None,None,None,None),
        ProjectLink(1055,roadPart,Track.Combined,Discontinuity.Continuous,5149,5225,1508,1584,None,None,Some(createdBy),  247036.toString,  0.0  , 75.156,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418964.0,7067939.0,0.0), Point(418941.0,7068010.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 75.156,31341,265146,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1056,roadPart,Track.Combined,Discontinuity.Continuous,5225,5258,1584,1617,None,None,Some(createdBy),  247039.toString,  0.0  , 33.651,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418974.0,7067907.0,0.0), Point(418964.0,7067939.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 33.651,31341,265147,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1057,roadPart,Track.Combined,Discontinuity.Continuous,5258,5391,1617,1750,None,None,Some(createdBy),  247054.toString,  0.0  ,132.283,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419014.0,7067781.0,0.0), Point(418974.0,7067907.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,132.283,31341,265148,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1058,roadPart,Track.Combined,Discontinuity.Continuous,5391,5498,1750,1857,None,None,Some(createdBy),  247052.toString,  0.0  ,106.948,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419046.0,7067679.0,0.0), Point(419014.0,7067781.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,106.948,31341,265149,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1059,roadPart,Track.Combined,Discontinuity.Continuous,5498,5567,1857,1926,None,None,Some(createdBy),  247056.toString,  0.0  , 68.855,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419068.0,7067613.0,0.0), Point(419046.0,7067679.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 68.855,31341,265150,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1060,roadPart,Track.Combined,Discontinuity.Continuous,5567,5669,1926,2028,None,None,Some(createdBy),  247047.toString,  0.0  ,101.123,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419098.0,7067517.0,0.0), Point(419068.0,7067613.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,101.123,31341,265151,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1061,roadPart,Track.Combined,Discontinuity.Continuous,5669,5754,2028,2113,None,None,Some(createdBy),  247057.toString,  0.0  , 85.278,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419124.0,7067436.0,0.0), Point(419098.0,7067517.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 85.278,31341,265152,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1062,roadPart,Track.Combined,Discontinuity.Continuous,5754,5818,2113,2177,None,None,Some(createdBy),  247058.toString,  0.0  , 64.169,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419140.0,7067373.0,0.0), Point(419124.0,7067436.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 64.169,31341,265153,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1063,roadPart,Track.Combined,Discontinuity.Continuous,5818,5941,2177,2300,None,None,Some(createdBy),  247060.toString,  0.0  ,122.064,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419156.0,7067252.0,0.0), Point(419140.0,7067373.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,122.064,31341,265154,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1064,roadPart,Track.Combined,Discontinuity.Continuous,5941,5983,2300,2342,None,None,Some(createdBy),  247046.toString,  0.0  , 42.131,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419161.0,7067211.0,0.0), Point(419156.0,7067252.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 42.131,31341,265155,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1065,roadPart,Track.Combined,Discontinuity.Continuous,5983,6016,2342,2375,None,None,Some(createdBy),  247080.toString,  0.0  , 33.262,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419165.0,7067178.0,0.0), Point(419161.0,7067211.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 33.262,31341,265156,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1066,roadPart,Track.Combined,Discontinuity.Continuous,6016,6038,2375,2397,None,None,Some(createdBy),  247079.toString,  0.0  , 21.343,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419168.0,7067156.0,0.0), Point(419165.0,7067178.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 21.343,31341,265157,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1067,roadPart,Track.Combined,Discontinuity.Continuous,6038,6099,2397,2458,None,None,Some(createdBy),  247077.toString,  0.0  , 61.294,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419176.0,7067096.0,0.0), Point(419168.0,7067156.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 61.294,31341,265158,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1068,roadPart,Track.Combined,Discontinuity.Continuous,6099,6124,2458,2483,None,None,Some(createdBy),  247081.toString,  0.0  , 25.136,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419181.0,7067071.0,0.0), Point(419176.0,7067096.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 25.136,31341,265159,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1069,roadPart,Track.Combined,Discontinuity.Continuous,6124,6314,2483,2673,None,None,Some(createdBy),  247093.toString,  0.0  ,188.847,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419271.0,7066906.0,0.0), Point(419181.0,7067071.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,188.847,31341,265160,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1070,roadPart,Track.Combined,Discontinuity.Continuous,6314,6461,2673,2820,None,None,Some(createdBy),  247102.toString,  0.0  ,147.263,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419349.0,7066782.0,0.0), Point(419271.0,7066906.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,147.263,31341,265161,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1071,roadPart,Track.Combined,Discontinuity.Continuous,6461,6549,2820,2908,None,None,Some(createdBy),  247100.toString,  0.0  , 87.254,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419387.0,7066703.0,0.0), Point(419349.0,7066782.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 87.254,31341,265162,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1072,roadPart,Track.Combined,Discontinuity.Continuous,6549,6694,2908,3053,None,None,Some(createdBy),  247103.toString,  0.0  ,144.828,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419448.0,7066572.0,0.0), Point(419387.0,7066703.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,144.828,31341,265163,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1073,roadPart,Track.Combined,Discontinuity.Continuous,6694,6966,3053,3325,None,None,Some(createdBy),10952119.toString,  0.0  ,271.447,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419565.0,7066326.0,0.0), Point(419448.0,7066572.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,271.447,31341,265164,12,false,None,1537228663000L,    64356,roadName,None,None,None,None),
        ProjectLink(1074,roadPart,Track.Combined,Discontinuity.Continuous,6966,7005,3325,3364,None,None,Some(createdBy),  247115.toString,  0.0  , 38.501,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419580.0,7066291.0,0.0), Point(419565.0,7066326.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 38.501,31341,265165,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1075,roadPart,Track.Combined,Discontinuity.Continuous,7005,7312,3364,3671,None,None,Some(createdBy),10952120.toString,  0.0  ,306.756,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419625.0,7065988.0,0.0), Point(419580.0,7066291.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,306.756,31341,265166,12,false,None,1537228663000L,    64356,roadName,None,None,None,None),
        ProjectLink(1076,roadPart,Track.Combined,Discontinuity.Continuous,7312,7380,3671,3739,None,None,Some(createdBy),  247125.toString,  0.0  , 67.312,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419634.0,7065921.0,0.0), Point(419625.0,7065988.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 67.312,31341,265167,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1077,roadPart,Track.Combined,Discontinuity.Continuous,7380,7433,3739,3792,None,None,Some(createdBy),  247449.toString,  0.0  , 52.982,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419644.0,7065869.0,0.0), Point(419634.0,7065921.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 52.982,31341,265168,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1078,roadPart,Track.Combined,Discontinuity.Continuous,7433,7594,3792,3953,None,None,Some(createdBy),  247446.toString,  0.0  ,160.97 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419706.0,7065721.0,0.0), Point(419644.0,7065869.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,160.97 ,31341,265169,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1079,roadPart,Track.Combined,Discontinuity.Continuous,7594,7743,3953,4102,None,None,Some(createdBy),  247439.toString,  0.0  ,148.28 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419739.0,7065578.0,0.0), Point(419706.0,7065721.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,148.28 ,31341,265170,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1080,roadPart,Track.Combined,Discontinuity.Continuous,7743,7924,4102,4283,None,None,Some(createdBy),  247460.toString,  0.0  ,180.89 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419761.0,7065398.0,0.0), Point(419739.0,7065578.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,180.89 ,31341,265171,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1081,roadPart,Track.Combined,Discontinuity.Continuous,7924,7990,4283,4349,None,None,Some(createdBy),  247462.toString,  0.0  , 65.605,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419762.0,7065333.0,0.0), Point(419761.0,7065398.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 65.605,31341,265172,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1082,roadPart,Track.Combined,Discontinuity.Continuous,7990,8206,4349,4565,None,None,Some(createdBy),10952140.toString,  0.0  ,215.81 ,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419852.0,7065147.0,0.0), Point(419762.0,7065333.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,215.81 ,31341,265173,12,false,None,1537228663000L,    64356,roadName,None,None,None,None),
        ProjectLink(1083,roadPart,Track.Combined,Discontinuity.Continuous,8206,8277,4565,4636,None,None,Some(createdBy),  248468.toString,  0.0  , 70.731,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419913.0,7065112.0,0.0), Point(419852.0,7065147.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 70.731,31341,265174,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1084,roadPart,Track.Combined,Discontinuity.Continuous,8277,8301,4636,4660,None,None,Some(createdBy),  248469.toString,  0.0  , 23.829,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(419933.0,7065099.0,0.0), Point(419913.0,7065112.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 23.829,31341,265175,12,false,None,1446398762000L,    64356,roadName,None,None,None,None),
        ProjectLink(1085,roadPart,Track.Combined,Discontinuity.Continuous,8301,8469,4660,4828,None,None,Some(createdBy),10949334.toString,  0.0  ,167.624,AgainstDigitizing,(NoCP,RoadAddressCP  ),(NoCP,JunctionPointCP),List(Point(420026.0,7064963.0,0.0), Point(419933.0,7065099.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,167.624,31341,265176,12,false,None,1537225220000L,    64356,roadName,None,None,None,None)
      )
   ...
   */
    runWithRollback {
      ...
      val allProjectLinks = Seq(
        ProjectLink(1000,roadPart,Track.Combined, Discontinuity.Continuous,          0,107,0,0,None,None,Some(createdBy),1633342.toString,0.0,106.991,TowardsDigitizing,(RoadAddressCP,NoCP         ),(NoCP,NoCP),List(Point(388414.0,7291967.0,0.0), Point(388498.0,7292033.0,0.0)),projectId,RoadAddressChangeType.New,AdministrativeClass.Municipality,FrozenLinkInterface,106.991,0,0,14,reversed = false,None,1614640323000L,335718924,roadName,None,None,None,None,None),
        ProjectLink(1001,roadPart,Track.Combined, Discontinuity.Continuous,        107,125,0,0,None,None,Some(createdBy),1633252.toString,0.0, 17.781,TowardsDigitizing,(NoCP,         RoadAddressCP),(NoCP,NoCP),List(Point(388498.0,7292033.0,0.0), Point(388512.0,7292044.0,0.0)),projectId,RoadAddressChangeType.New,AdministrativeClass.Municipality,FrozenLinkInterface, 17.781,0,0,14,reversed = false,None,1614640323000L,335718924,roadName,None,None,None,None,None),
        ProjectLink(1003,roadPart,Track.RightSide,Discontinuity.MinorDiscontinuity,125,241,0,0,None,None,Some(createdBy),1633247.toString,0.0,116.085,TowardsDigitizing,(RoadAddressCP,RoadAddressCP),(NoCP,NoCP),List(Point(388512.0,7292044.0,0.0), Point(388437.0,7292133.0,0.0)),projectId,RoadAddressChangeType.New,AdministrativeClass.Municipality,FrozenLinkInterface,116.085,0,0,14,reversed = false,None,1614640323000L,335718927,roadName,None,None,None,None,None),
        ProjectLink(1002,roadPart,Track.LeftSide, Discontinuity.Continuous,        125,241,0,0,None,None,Some(createdBy),1633251.toString,0.0,115.928,TowardsDigitizing,(RoadAddressCP,RoadAddressCP),(NoCP,NoCP),List(Point(388498.0,7292033.0,0.0), Point(388424.0,7292123.0,0.0)),projectId,RoadAddressChangeType.New,AdministrativeClass.Municipality,FrozenLinkInterface,115.928,0,0,14,reversed = false,None,1614640323000L,335718928,roadName,None,None,None,None,None),
        ProjectLink(1004,roadPart,Track.Combined, Discontinuity.Continuous,        241,258,0,0,None,None,Some(createdBy),1633250.toString,0.0, 17.089,TowardsDigitizing,(RoadAddressCP,NoCP         ),(NoCP,NoCP),List(Point(388424.0,7292123.0,0.0), Point(388437.0,7292133.0,0.0)),projectId,RoadAddressChangeType.New,AdministrativeClass.Municipality,FrozenLinkInterface, 17.089,0,0,14,reversed = false,None,1614640323000L,335718931,roadName,None,None,None,None,None),
        ProjectLink(1005,roadPart,Track.Combined, Discontinuity.EndOfRoad,         258,367,0,0,None,None,Some(createdBy),1633249.toString,0.0,108.756,TowardsDigitizing,(NoCP,         RoadAddressCP),(NoCP,NoCP),List(Point(388437.0,7292133.0,0.0), Point(388522.0,7292202.0,0.0)),projectId,RoadAddressChangeType.New,AdministrativeClass.Municipality,FrozenLinkInterface,108.756,0,0,14,reversed = false,None,1614640323000L,335718931,roadName,None,None,None,None,None)
      )
...
//      (t, toProjectLink(project, RoadAddressChangeType.Transfer)(t.copy(startAddrMValue = t.startAddrMValue - d,
  ...
  test("Test partitioner When a roadpart is combined to another with a new link having other part reversed " +
    ...
    runWithRollback {
      ...
      val transferLinks206 = addresses.sortBy(_.startAddrMValue).map(a => {
        val projectLink = toProjectLink(project, RoadAddressChangeType.Transfer)(a)
        projectLink.copy(startAddrMValue = maxAddr + lengthChange + a.startAddrMValue, endAddrMValue = maxAddr + lengthChange + a.endAddrMValue, roadwayId = 3, reversed = false)
      })

      val projectLink = toProjectLink(project, RoadAddressChangeType.New)(addresses.head)
      val newLink     = projectLink.copy(startAddrMValue = maxAddr, endAddrMValue = maxAddr + lengthChange, reversed = false)
      ...
      val roadway206 = toRoadway(Seq(transferLinks.head.copy(roadPart = RoadPart(transferLinks.head.roadPart.roadNumber, 206), startAddrMValue = 0, endAddrMValue = addresses.last.endAddrMValue))).copy(id = 3)
      roadwayDAO.create(Seq(roadway205, roadway206))
