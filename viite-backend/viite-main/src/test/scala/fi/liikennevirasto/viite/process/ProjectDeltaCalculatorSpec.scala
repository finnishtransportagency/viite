...
class ProjectDeltaCalculatorSpec extends AnyFunSuite with Matchers {
 ...
 private def createRoadAddress(start: Long, distance: Long, roadwayNumber: Long = 0L) = {
   ...
   RoadAddress(id = start, linearLocationId = 1L, roadPart = RoadPart(5, 205), administrativeClass = AdministrativeClass.State, track = Track.Combined, discontinuity = Discontinuity.Continuous, addrMRange = AddrMRange(start, start + distance), linkId = start.toString, startMValue = 0.0, endMValue = distance.toDouble, sideCode = TowardsDigitizing, adjustedTimestamp = 0L, geometry = Seq(Point(0.0, start), Point(0.0, start + distance)), linkGeomSource = NormalLinkInterface, ely = 8, roadMaintainer = ArealRoadMaintainer.getEVK(8), terminated = NoTermination, roadwayNumber = roadwayNumber)
 }
 ...
 test("Test ProjectDeltaCalculator.partition " +
   ...
   runWithRollback {
     ...
     roadwayDAO.create(Seq(
       Roadway(30701,64686,RoadPart(18385,1),AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(   0,2568),reversed = false,DateTime.parse("1933-01-01T00:00:00.000+02:00"),   None,createdBy,roadName,12,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.parse("1998-10-16T00:00:00.000+03:00"),None),
       Roadway(30920,64355,roadPart,         AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(   0,1400),reversed = false,DateTime.parse("1967-01-01T00:00:00.000+02:00"),   None,createdBy,roadName,12,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.parse("1998-10-16T00:00:00.000+03:00"),None),
       Roadway(30993,64687,RoadPart(18385,1),AdministrativeClass.State,Track.Combined,Discontinuity.EndOfRoad, AddrMRange(2568,4403),reversed = false,DateTime.parse("1901-01-01T00:00:00.000+01:39:49"),None,createdBy,roadName,12,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.parse("1998-10-16T00:00:00.000+03:00"),None),
       Roadway(31341,64356,roadPart         ,AdministrativeClass.State,Track.Combined,Discontinuity.Continuous,AddrMRange(1400,4828),reversed = false,DateTime.parse("1952-01-01T00:00:00.000+02:00"),   None,createdBy,roadName,12,ArealRoadMaintainer.getEVK(8),TerminationCode.NoTermination,DateTime.parse("1998-10-16T00:00:00.000+03:00"),None)
     ))

     val allProjectLinks = Seq(
       ProjectLink(1000,roadPart,Track.Combined,Discontinuity.Continuous,AddrMRange(   0,  18),AddrMRange(   0,  18),None,None,Some(createdBy),  243576.toString,  0.0  , 17.829,AgainstDigitizing,(JunctionPointCP,NoCP),(JunctionPointCP,NoCP),List(Point(418449.0,7069399.0,0.0), Point(418450.0,7069417.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface, 17.829,30920,258599,12,ArealRoadMaintainer.getEVK(8),false,None,1633993775000L,335718902,roadName,None,None,None,None),
       ProjectLink(1001,roadPart,Track.Combined,Discontinuity.Continuous,AddrMRange(  18,  81),AddrMRange(  18,  81),None,None,Some(createdBy),  243612.toString,  0.0  , 63.291,AgainstDigitizing,(NoCP,           NoCP),(NoCP,           NoCP),List(Point(418453.0,7069336.0,0.0), Point(418449.0,7069399.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface, 63.291,30920,258600,12,ArealRoadMaintainer.getEVK(8),false,None,1633993775000L,335718902,roadName,None,None,None,None),
       ProjectLink(1002,roadPart,Track.Combined,Discontinuity.Continuous,AddrMRange(   0, 143),AddrMRange(   0, 143),None,None,Some(createdBy),  247382.toString,  0.0  ,142.727,TowardsDigitizing,(RoadAddressCP,  NoCP),(JunctionPointCP,NoCP),List(Point(416275.0,7065372.0,0.0), Point(416398.0,7065442.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface,142.727,30701,255183,12,ArealRoadMaintainer.getEVK(8),false,None,1446398762000L,    64686,roadName,None,None,None,None),
       ProjectLink(1003,roadPart,Track.Combined,Discontinuity.Continuous,AddrMRange( 143, 193),AddrMRange( 143, 193),None,None,Some(createdBy),  247385.toString,  0.0  , 49.552,TowardsDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(416398.0,7065442.0,0.0), Point(416430.0,7065479.0,0.0)),projectId,RoadAddressChangeType.Transfer,   AdministrativeClass.State,FrozenLinkInterface, 49.552,30701,255184,12,ArealRoadMaintainer.getEVK(8),false,None,1446398762000L,    64686,roadName,None,None,None,None),
       ProjectLink(1004,roadPart,Track.Combined,Discontinuity.Continuous,AddrMRange(  81, 209),AddrMRange(  81, 209),None,None,Some(createdBy),  243607.toString,  0.0  ,127.544,AgainstDigitizing,(NoCP,NoCP           ),(NoCP,NoCP           ),List(Point(418468.0,7069209.0,0.0), Point(418453.0,7069336.0,0.0)),projectId,RoadAddressChangeType.Termination,AdministrativeClass.State,FrozenLinkInterface,127.544,30920,258601,12,ArealRoadMaintainer.getEVK(8),false,None,1446398762000L,335718902,roadName,None,None,None,None),
...
//  }
 ...
 test("Test ProjectDeltaCalculator.partition When transfering two roadparts a small roadpart number to the greater roadpart number" +
   ...
   runWithRollback {
     ...
     val rw1 = Roadway(1, 1000, RoadPart(5, startRoadPart), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0, addressMLength), ely = 8, roadMaintainer = ArealRoadMaintainer.getEVK(8), startDate = DateTime.now(), createdBy = "", roadName = None)
     val rw2 = Roadway(2, 1001, RoadPart(5, endRoadPart  ), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0, addressMLength), ely = 8, roadMaintainer = ArealRoadMaintainer.getEVK(8), startDate = DateTime.now(), createdBy = "", roadName = None)
 ...
 test("Test ProjectDeltaCalculator.partition " +
   ...
   runWithRollback {
     ...
     var links = addressLinks.map(_._2)
     val rw1 = Roadway(1, 1000, RoadPart(5, 205), AdministrativeClass.State, Track.Combined, Discontinuity.Continuous, AddrMRange(0, addressMLengthFirst),                        ely = 8, roadMaintainer = ArealRoadMaintainer.getEVK(8), startDate = DateTime.now(), createdBy = "", roadName = None)
     val rw2 = Roadway(2, 1001, RoadPart(5, 205), AdministrativeClass.State, Track.Combined, Discontinuity.EndOfRoad,  AddrMRange(0, addressMLengthFirst + addressMLengthSecond), ely = 8, roadMaintainer = ArealRoadMaintainer.getEVK(8), startDate = DateTime.now(), createdBy = "", roadName = None)
